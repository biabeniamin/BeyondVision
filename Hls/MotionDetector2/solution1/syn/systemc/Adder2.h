...
struct Adder2 : public sc_module {
    ...
    sc_signal< sc_lv<1> > tmp_reg_289_pp0_iter1_reg;
    sc_signal< sc_lv<32> > differentBytes_reg_193;
    ...
    sc_signal< sc_lv<23> > in1Count_3_fu_244_p2;
    sc_signal< sc_lv<23> > in1Count_3_reg_293;
    sc_signal< sc_lv<32> > tmp_data_V_reg_299;
    sc_signal< sc_lv<4> > tmp_keep_V_reg_304;
    sc_signal< sc_lv<4> > tmp_strb_V_reg_309;
    sc_signal< sc_lv<2> > tmp_user_V_reg_314;
    sc_signal< sc_lv<1> > tmp_last_V_reg_319;
    sc_signal< sc_lv<5> > tmp_id_V_reg_324;
    sc_signal< sc_lv<6> > tmp_dest_V_reg_329;
    sc_signal< sc_lv<32> > differentBytes_2_fu_278_p2;
    sc_signal< sc_lv<32> > differentBytes_2_reg_334;
    sc_signal< bool > ap_block_pp0_stage0_subdone;
    sc_signal< bool > ap_predicate_tran4to5_state2;
    sc_signal< sc_lv<32> > ap_phi_mux_differentBytes_phi_fu_197_p4;
    sc_signal< sc_lv<23> > ap_phi_mux_in1Count_phi_fu_209_p4;
    sc_signal< sc_lv<32> > differentBytes_1_reg_217;
    sc_signal< sc_lv<23> > in1Count_1_reg_228;
    ...
    void thread_ap_phi_mux_differentBytes_phi_fu_197_p4();
    void thread_ap_phi_mux_in1Count_phi_fu_209_p4();
    void thread_ap_predicate_tran4to5_state2();
    void thread_ap_ready();
    void thread_ap_rst_n_inv();
    void thread_differentBytes_2_fu_278_p2();
    void thread_in1Count_3_fu_244_p2();
