...
reg   [10:0] t_V_4_reg_253;
wire   [0:0] exitcond3_fu_264_p2;
wire    ap_CS_fsm_state2;
wire   [10:0] i_V_fu_270_p2;
reg   [10:0] i_V_reg_292;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((1'b1 == ap_CS_fsm_pp0_stage0) & (1'b1 == ap_condition_pp0_exit_iter0_state3) & (1'b0 == ap_block_pp0_stage0_subdone))) begin
            ap_enable_reg_pp0_iter0 <= 1'b0;
        end else if (((exitcond3_fu_264_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
...
always @ (posedge ap_clk) begin
    if (((exitcond_fu_276_p2 == 1'd0) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b0 == ap_block_pp0_stage0_11001))) begin
...
always @ (*) begin
    if ((exitcond_fu_276_p2 == 1'd1)) begin
...
always @ (*) begin
    if ((((exitcond3_fu_264_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state2)) | ((ap_start == 1'b0) & (1'b1 == ap_CS_fsm_state1)))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = 1'b0;
    end
...
always @ (*) begin
    if (((exitcond3_fu_264_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state2))) begin
        ap_ready = 1'b1;
    end else begin
        ap_ready = 1'b0;
    end
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_pp0_stage0 : begin
            if (~((exitcond_fu_276_p2 == 1'd1) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone))) begin
                ap_NS_fsm = ap_ST_fsm_pp0_stage0;
            end else if (((exitcond_fu_276_p2 == 1'd1) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone))) begin
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = ((ap_enable_reg_pp0_iter1 == 1'b1) & (((exitcond_reg_297 == 1'd0) & (src_data_stream_0_V_empty_n == 1'b0)) | ((exitcond_reg_297 == 1'd0) & (dst2_data_stream_2_V_full_n == 1'b0)) | ((exitcond_reg_297 == 1'd0) & (dst2_data_stream_1_V_full_n == 1'b0)) | ((exitcond_reg_297 == 1'd0) & (dst2_data_stream_0_V_full_n == 1'b0)) | ((exitcond_reg_297 == 1'd0) & (dst1_data_stream_2_V_full_n == 1'b0)) | ((exitcond_reg_297 == 1'd0) & (dst1_data_stream_1_V_full_n == 1'b0)) | ((exitcond_reg_297 == 1'd0) & (dst1_data_stream_0_V_full_n == 1'b0)) | ((exitcond_reg_297 == 1'd0) & (src_data_stream_2_V_empty_n == 1'b0)) | ((exitcond_reg_297 == 1'd0) & (src_data_stream_1_V_empty_n == 1'b0))));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = ((ap_enable_reg_pp0_iter1 == 1'b1) & (((exitcond_reg_297 == 1'd0) & (src_data_stream_0_V_empty_n == 1'b0)) | ((exitcond_reg_297 == 1'd0) & (dst2_data_stream_2_V_full_n == 1'b0)) | ((exitcond_reg_297 == 1'd0) & (dst2_data_stream_1_V_full_n == 1'b0)) | ((exitcond_reg_297 == 1'd0) & (dst2_data_stream_0_V_full_n == 1'b0)) | ((exitcond_reg_297 == 1'd0) & (dst1_data_stream_2_V_full_n == 1'b0)) | ((exitcond_reg_297 == 1'd0) & (dst1_data_stream_1_V_full_n == 1'b0)) | ((exitcond_reg_297 == 1'd0) & (dst1_data_stream_0_V_full_n == 1'b0)) | ((exitcond_reg_297 == 1'd0) & (src_data_stream_2_V_empty_n == 1'b0)) | ((exitcond_reg_297 == 1'd0) & (src_data_stream_1_V_empty_n == 1'b0))));
end
...
always @ (*) begin
    ap_block_state4_pp0_stage0_iter1 = (((exitcond_reg_297 == 1'd0) & (src_data_stream_0_V_empty_n == 1'b0)) | ((exitcond_reg_297 == 1'd0) & (dst2_data_stream_2_V_full_n == 1'b0)) | ((exitcond_reg_297 == 1'd0) & (dst2_data_stream_1_V_full_n == 1'b0)) | ((exitcond_reg_297 == 1'd0) & (dst2_data_stream_0_V_full_n == 1'b0)) | ((exitcond_reg_297 == 1'd0) & (dst1_data_stream_2_V_full_n == 1'b0)) | ((exitcond_reg_297 == 1'd0) & (dst1_data_stream_1_V_full_n == 1'b0)) | ((exitcond_reg_297 == 1'd0) & (dst1_data_stream_0_V_full_n == 1'b0)) | ((exitcond_reg_297 == 1'd0) & (src_data_stream_2_V_empty_n == 1'b0)) | ((exitcond_reg_297 == 1'd0) & (src_data_stream_1_V_empty_n == 1'b0)));
end
...
assign exitcond3_fu_264_p2 = ((t_V_reg_242 == 11'd1080) ? 1'b1 : 1'b0);

assign exitcond_fu_276_p2 = ((t_V_4_reg_253 == 11'd1920) ? 1'b1 : 1'b0);

assign i_V_fu_270_p2 = (t_V_reg_242 + 11'd1);

assign j_V_fu_282_p2 = (t_V_4_reg_253 + 11'd1);
