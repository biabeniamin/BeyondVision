...
#ifndef __SobelFilter_mul_mocq__HH__
#define __SobelFilter_mul_mocq__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(SobelFilter_mul_mocq) {
    ...
    SC_CTOR(SobelFilter_mul_mocq):  ACMP_smul_uu_U ("ACMP_smul_uu_U") {
