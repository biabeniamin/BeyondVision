...
#ifndef __SobelFilter_mac_mrcU__HH__
#define __SobelFilter_mac_mrcU__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(SobelFilter_mac_mrcU) {
    ...
    SC_CTOR(SobelFilter_mac_mrcU):  simcore_mac_3_U ("simcore_mac_3_U") {
