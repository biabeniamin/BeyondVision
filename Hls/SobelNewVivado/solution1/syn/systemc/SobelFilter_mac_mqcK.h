...
#ifndef __SobelFilter_mac_mqcK__HH__
#define __SobelFilter_mac_mqcK__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(SobelFilter_mac_mqcK) {
    ...
    SC_CTOR(SobelFilter_mac_mqcK):  simcore_mac_2_U ("simcore_mac_2_U") {
