...
#include "start_for_CvtColoGfk.h"
#include "start_for_GaussiaHfu.h"
#include "start_for_DuplicaIfE.h"
#include "start_for_Sobel_U0.h"
#include "start_for_Sobel_1JfO.h"
#include "start_for_AddWeigKfY.h"
#include "start_for_CvtColoLf8.h"
...
struct SobelFilter : public sc_module {
    ...
    start_for_CvtColoGfk* start_for_CvtColoGfk_U;
    ...
    start_for_Sobel_1JfO* start_for_Sobel_1JfO_U;
    start_for_AddWeigKfY* start_for_AddWeigKfY_U;
    ...
    sc_signal< sc_logic > Sobel_1_U0_p_src_data_stream_0_V_read;
    sc_signal< sc_logic > Sobel_1_U0_p_src_data_stream_1_V_read;
    sc_signal< sc_logic > Sobel_1_U0_p_src_data_stream_2_V_read;
    sc_signal< sc_lv<8> > Sobel_1_U0_p_dst_data_stream_0_V_din;
    sc_signal< sc_logic > Sobel_1_U0_p_dst_data_stream_0_V_write;
    sc_signal< sc_lv<8> > Sobel_1_U0_p_dst_data_stream_1_V_din;
    sc_signal< sc_logic > Sobel_1_U0_p_dst_data_stream_1_V_write;
    sc_signal< sc_lv<8> > Sobel_1_U0_p_dst_data_stream_2_V_din;
    sc_signal< sc_logic > Sobel_1_U0_p_dst_data_stream_2_V_write;
    ...
    sc_signal< sc_logic > AddWeighted_U0_src1_data_stream_0_V_read;
    sc_signal< sc_logic > AddWeighted_U0_src1_data_stream_1_V_read;
    sc_signal< sc_logic > AddWeighted_U0_src1_data_stream_2_V_read;
    sc_signal< sc_logic > AddWeighted_U0_src2_data_stream_0_V_read;
    sc_signal< sc_logic > AddWeighted_U0_src2_data_stream_1_V_read;
    sc_signal< sc_logic > AddWeighted_U0_src2_data_stream_2_V_read;
    sc_signal< sc_lv<8> > AddWeighted_U0_dst_data_stream_0_V_din;
    sc_signal< sc_logic > AddWeighted_U0_dst_data_stream_0_V_write;
    sc_signal< sc_lv<8> > AddWeighted_U0_dst_data_stream_1_V_din;
    sc_signal< sc_logic > AddWeighted_U0_dst_data_stream_1_V_write;
    sc_signal< sc_lv<8> > AddWeighted_U0_dst_data_stream_2_V_din;
    sc_signal< sc_logic > AddWeighted_U0_dst_data_stream_2_V_write;
