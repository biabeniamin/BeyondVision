...
#ifndef __SobelFilter_mac_mCeG__HH__
#define __SobelFilter_mac_mCeG__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(SobelFilter_mac_mCeG) {
    ...
    SC_CTOR(SobelFilter_mac_mCeG):  simcore_mac_5_U ("simcore_mac_5_U") {
