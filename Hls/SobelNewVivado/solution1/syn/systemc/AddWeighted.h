...
struct AddWeighted : public sc_module {
    ...
    sc_signal< sc_logic > grp_arithm_pro_fu_138_ap_ready;
    sc_signal< sc_logic > grp_arithm_pro_fu_138_src1_data_stream_0_V_read;
    sc_signal< sc_logic > grp_arithm_pro_fu_138_src1_data_stream_1_V_read;
    sc_signal< sc_logic > grp_arithm_pro_fu_138_src1_data_stream_2_V_read;
    sc_signal< sc_logic > grp_arithm_pro_fu_138_src2_data_stream_0_V_read;
    sc_signal< sc_logic > grp_arithm_pro_fu_138_src2_data_stream_1_V_read;
    sc_signal< sc_logic > grp_arithm_pro_fu_138_src2_data_stream_2_V_read;
    sc_signal< sc_lv<8> > grp_arithm_pro_fu_138_dst_data_stream_0_V_din;
    sc_signal< sc_logic > grp_arithm_pro_fu_138_dst_data_stream_0_V_write;
    sc_signal< sc_lv<8> > grp_arithm_pro_fu_138_dst_data_stream_1_V_din;
    sc_signal< sc_logic > grp_arithm_pro_fu_138_dst_data_stream_1_V_write;
