...
#ifndef __SobelFilter_mac_mdEe__HH__
#define __SobelFilter_mac_mdEe__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(SobelFilter_mac_mdEe) {
    ...
    SC_CTOR(SobelFilter_mac_mdEe):  simcore_mac_1_U ("simcore_mac_1_U") {
