...
#ifndef __SobelFilter_ama_apcA__HH__
#define __SobelFilter_ama_apcA__HH__
...
template<
    ...
    int din3_WIDTH,
    int dout_WIDTH>
SC_MODULE(SobelFilter_ama_apcA) {
    ...
    SC_CTOR(SobelFilter_ama_apcA):  simcore_ama_0_U ("simcore_ama_0_U") {
