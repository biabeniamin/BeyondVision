...
#ifndef __SobelFilter_mac_mBew__HH__
#define __SobelFilter_mac_mBew__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(SobelFilter_mac_mBew) {
    ...
    SC_CTOR(SobelFilter_mac_mBew):  simcore_mac_4_U ("simcore_mac_4_U") {
