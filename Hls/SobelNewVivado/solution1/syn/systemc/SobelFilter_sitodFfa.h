...
#ifndef __SobelFilter_sitodFfa__HH__
#define __SobelFilter_sitodFfa__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(SobelFilter_sitodFfa) {
    ...
    SC_CTOR(SobelFilter_sitodFfa):  ACMP_sitodp_U ("ACMP_sitodp_U") {
