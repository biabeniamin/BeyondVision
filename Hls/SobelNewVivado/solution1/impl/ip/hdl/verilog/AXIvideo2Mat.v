...
reg   [10:0] t_V_5_reg_198;
reg   [0:0] eol_reg_209;
reg   [0:0] eol_1_reg_221;
reg   [23:0] axi_data_V_1_reg_232;
reg   [0:0] axi_last_V_3_reg_279;
reg   [23:0] axi_data_V_3_reg_291;
reg   [23:0] tmp_data_V_reg_387;
reg   [0:0] tmp_last_V_reg_395;
wire   [0:0] exitcond4_fu_322_p2;
wire    ap_CS_fsm_state4;
wire   [10:0] i_V_fu_328_p2;
reg   [10:0] i_V_reg_411;
...
reg   [0:0] ap_phi_mux_eol_2_phi_fu_271_p4;
...
reg   [0:0] ap_phi_mux_axi_last_V_2_phi_fu_248_p4;
reg   [23:0] ap_phi_mux_p_Val2_s_phi_fu_260_p4;
wire   [0:0] ap_phi_reg_pp1_iter1_axi_last_V_2_reg_243;
wire   [23:0] ap_phi_reg_pp1_iter1_p_Val2_s_reg_256;
reg    ap_block_pp1_stage0_01001;
reg   [0:0] sof_1_fu_124;
wire   [0:0] tmp_user_V_fu_313_p1;
reg   [7:0] ap_NS_fsm;
reg    ap_block_state1;
reg    ap_idle_pp1;
wire    ap_enable_pp1;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if (((exitcond4_fu_322_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state4))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((exitcond_fu_334_p2 == 1'd1) & (1'b0 == ap_block_pp1_stage0_subdone) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
            ap_enable_reg_pp1_iter0 <= 1'b0;
        end else if (((exitcond4_fu_322_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state4))) begin
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((ap_phi_mux_eol_2_phi_fu_271_p4 == 1'd1) & (1'b0 == ap_block_pp2_stage0_subdone) & (1'b1 == ap_CS_fsm_pp2_stage0))) begin
            ap_enable_reg_pp2_iter0 <= 1'b0;
...
always @ (posedge ap_clk) begin
    ...
    end else if (((eol_2_reg_268 == 1'd0) & (1'b0 == ap_block_pp2_stage0_11001) & (ap_enable_reg_pp2_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp2_stage0))) begin
...
always @ (posedge ap_clk) begin
    if (((exitcond_fu_334_p2 == 1'd0) & (1'b0 == ap_block_pp1_stage0_11001) & (ap_enable_reg_pp1_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
        sof_1_fu_124 <= 1'd0;
...
always @ (posedge ap_clk) begin
    if (((exitcond_fu_334_p2 == 1'd0) & (1'b0 == ap_block_pp1_stage0_11001) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
...
always @ (*) begin
    if ((((eol_2_reg_268 == 1'd0) & (1'b0 == ap_block_pp2_stage0_11001) & (ap_enable_reg_pp2_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp2_stage0)) | ((1'b0 == ap_block_pp1_stage0_11001) & (ap_enable_reg_pp1_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0) & (ap_predicate_op56_read_state6 == 1'b1)) | ((1'b1 == AXI_video_strm_V_data_V_0_vld_out) & (1'b1 == ap_CS_fsm_state2)))) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state2) | ((eol_2_reg_268 == 1'd0) & (1'b0 == ap_block_pp2_stage0) & (ap_enable_reg_pp2_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp2_stage0)) | ((brmerge_reg_425 == 1'd0) & (exitcond_reg_416 == 1'd0) & (1'b0 == ap_block_pp1_stage0) & (ap_enable_reg_pp1_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0)))) begin
...
always @ (*) begin
    if (((exitcond4_fu_322_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state4))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
always @ (*) begin
    if ((1'b1 == ap_condition_507)) begin
        if ((brmerge_reg_425 == 1'd1)) begin
            ap_phi_mux_axi_last_V_2_phi_fu_248_p4 = eol_1_reg_221;
        end else if ((brmerge_reg_425 == 1'd0)) begin
...
always @ (*) begin
    if (((eol_2_reg_268 == 1'd0) & (1'b0 == ap_block_pp2_stage0) & (ap_enable_reg_pp2_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp2_stage0))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state2 : begin
            if (((tmp_user_V_fu_313_p1 == 1'd0) & (1'b1 == AXI_video_strm_V_data_V_0_vld_out) & (1'b1 == ap_CS_fsm_state2))) begin
                ap_NS_fsm = ap_ST_fsm_state2;
            end else if (((tmp_user_V_fu_313_p1 == 1'd1) & (1'b1 == AXI_video_strm_V_data_V_0_vld_out) & (1'b1 == ap_CS_fsm_state2))) begin
...
always @ (*) begin
    ap_block_pp1_stage0_01001 = ((ap_enable_reg_pp1_iter1 == 1'b1) & (((1'b0 == AXI_video_strm_V_data_V_0_vld_out) & (ap_predicate_op56_read_state6 == 1'b1)) | ((exitcond_reg_416 == 1'd0) & (img_data_stream_2_V_full_n == 1'b0)) | ((exitcond_reg_416 == 1'd0) & (img_data_stream_1_V_full_n == 1'b0)) | ((exitcond_reg_416 == 1'd0) & (img_data_stream_0_V_full_n == 1'b0))));
end

always @ (*) begin
    ap_block_pp1_stage0_11001 = ((ap_enable_reg_pp1_iter1 == 1'b1) & (((1'b0 == AXI_video_strm_V_data_V_0_vld_out) & (ap_predicate_op56_read_state6 == 1'b1)) | ((exitcond_reg_416 == 1'd0) & (img_data_stream_2_V_full_n == 1'b0)) | ((exitcond_reg_416 == 1'd0) & (img_data_stream_1_V_full_n == 1'b0)) | ((exitcond_reg_416 == 1'd0) & (img_data_stream_0_V_full_n == 1'b0))));
end

always @ (*) begin
    ap_block_pp1_stage0_subdone = ((ap_enable_reg_pp1_iter1 == 1'b1) & (((1'b0 == AXI_video_strm_V_data_V_0_vld_out) & (ap_predicate_op56_read_state6 == 1'b1)) | ((exitcond_reg_416 == 1'd0) & (img_data_stream_2_V_full_n == 1'b0)) | ((exitcond_reg_416 == 1'd0) & (img_data_stream_1_V_full_n == 1'b0)) | ((exitcond_reg_416 == 1'd0) & (img_data_stream_0_V_full_n == 1'b0))));
end

assign ap_block_pp2_stage0 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_pp2_stage0_11001 = ((eol_2_reg_268 == 1'd0) & (1'b0 == AXI_video_strm_V_data_V_0_vld_out) & (ap_enable_reg_pp2_iter1 == 1'b1));
end

always @ (*) begin
    ap_block_pp2_stage0_subdone = ((eol_2_reg_268 == 1'd0) & (1'b0 == AXI_video_strm_V_data_V_0_vld_out) & (ap_enable_reg_pp2_iter1 == 1'b1));
end
...
always @ (*) begin
    ap_block_state6_pp1_stage0_iter1 = (((1'b0 == AXI_video_strm_V_data_V_0_vld_out) & (ap_predicate_op56_read_state6 == 1'b1)) | ((exitcond_reg_416 == 1'd0) & (img_data_stream_2_V_full_n == 1'b0)) | ((exitcond_reg_416 == 1'd0) & (img_data_stream_1_V_full_n == 1'b0)) | ((exitcond_reg_416 == 1'd0) & (img_data_stream_0_V_full_n == 1'b0)));
end

assign ap_block_state8_pp2_stage0_iter0 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_state9_pp2_stage0_iter1 = ((eol_2_reg_268 == 1'd0) & (1'b0 == AXI_video_strm_V_data_V_0_vld_out));
end

always @ (*) begin
    ap_condition_507 = ((exitcond_reg_416 == 1'd0) & (1'b0 == ap_block_pp1_stage0) & (ap_enable_reg_pp1_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0));
end
...
assign ap_phi_reg_pp1_iter1_axi_last_V_2_reg_243 = 'bx;

assign ap_phi_reg_pp1_iter1_p_Val2_s_reg_256 = 'bx;

always @ (*) begin
    ap_predicate_op56_read_state6 = ((brmerge_reg_425 == 1'd0) & (exitcond_reg_416 == 1'd0));
end

assign ap_ready = internal_ap_ready;

assign brmerge_fu_349_p2 = (sof_1_fu_124 | ap_phi_mux_eol_phi_fu_213_p4);

assign exitcond4_fu_322_p2 = ((t_V_reg_187 == 11'd1080) ? 1'b1 : 1'b0);

assign exitcond_fu_334_p2 = ((t_V_5_reg_198 == 11'd1920) ? 1'b1 : 1'b0);

assign i_V_fu_328_p2 = (t_V_reg_187 + 11'd1);

assign img_data_stream_0_V_din = ap_phi_mux_p_Val2_s_phi_fu_260_p4[7:0];

assign img_data_stream_1_V_din = {{ap_phi_mux_p_Val2_s_phi_fu_260_p4[15:8]}};

assign img_data_stream_2_V_din = {{ap_phi_mux_p_Val2_s_phi_fu_260_p4[23:16]}};

assign j_V_fu_340_p2 = (t_V_5_reg_198 + 11'd1);

assign start_out = real_start;

assign tmp_user_V_fu_313_p1 = AXI_video_strm_V_user_V_0_data_out;
