...
wire   [32:0] r_V_fu_243_p2;
reg   [32:0] r_V_reg_322;
wire   [0:0] exitcond1_i_fu_254_p2;
...
wire   [32:0] tmp_6_cast_i_fu_276_p1;
reg   [3:0] ap_NS_fsm;
reg    ap_idle_pp0;
wire    ap_enable_pp0;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((1'b0 == ap_block_pp0_stage0_subdone) & (1'b1 == ap_condition_pp0_exit_iter0_state3) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
            ap_enable_reg_pp0_iter0 <= 1'b0;
        end else if ((~((1'b0 == AXI_video_strm_V_data_V_1_ack_in) | (1'b0 == AXI_video_strm_V_dest_V_1_ack_in) | (1'b0 == AXI_video_strm_V_id_V_1_ack_in) | (1'b0 == AXI_video_strm_V_last_V_1_ack_in) | (1'b0 == AXI_video_strm_V_user_V_1_ack_in) | (1'b0 == AXI_video_strm_V_strb_V_1_ack_in) | (1'b0 == AXI_video_strm_V_keep_V_1_ack_in)) & (exitcond1_i_fu_254_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
...
assign axi_last_V_fu_280_p2 = ((tmp_6_cast_i_fu_276_p1 == r_V_reg_322) ? 1'b1 : 1'b0);

assign cols_V_fu_235_p1 = $signed(img_cols_V_dout);

assign exitcond1_i_fu_254_p2 = ((t_V_reg_209 == rows_V_reg_312) ? 1'b1 : 1'b0);

assign exitcond_i_fu_265_p2 = ((t_V_1_reg_220 == cols_V_reg_317) ? 1'b1 : 1'b0);

assign i_V_fu_259_p2 = (t_V_reg_209 + 32'd1);

assign j_V_fu_270_p2 = (t_V_1_reg_220 + 32'd1);

assign lhs_V_cast_i_fu_239_p1 = $unsigned(cols_V_fu_235_p1);

assign r_V_fu_243_p2 = ($signed(lhs_V_cast_i_fu_239_p1) + $signed(33'd8589934591));

assign rows_V_fu_231_p1 = $signed(img_rows_V_dout);

assign tmp_6_cast_i_fu_276_p1 = t_V_1_reg_220;
