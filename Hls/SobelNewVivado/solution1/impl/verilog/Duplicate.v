...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if (((1'b1 == ap_CS_fsm_state2) & (exitcond3_fu_264_p2 == 1'd1))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state2) & (exitcond3_fu_264_p2 == 1'd1))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_pp0_stage0 : begin
            if (~((ap_enable_reg_pp0_iter0 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone) & (exitcond_fu_276_p2 == 1'd1))) begin
                ap_NS_fsm = ap_ST_fsm_pp0_stage0;
            end else if (((ap_enable_reg_pp0_iter0 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone) & (exitcond_fu_276_p2 == 1'd1))) begin
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = ((ap_enable_reg_pp0_iter1 == 1'b1) & (((exitcond_reg_297 == 1'd0) & (dst2_data_stream_2_V_full_n == 1'b0)) | ((exitcond_reg_297 == 1'd0) & (dst2_data_stream_1_V_full_n == 1'b0)) | ((exitcond_reg_297 == 1'd0) & (dst2_data_stream_0_V_full_n == 1'b0)) | ((exitcond_reg_297 == 1'd0) & (dst1_data_stream_2_V_full_n == 1'b0)) | ((exitcond_reg_297 == 1'd0) & (dst1_data_stream_1_V_full_n == 1'b0)) | ((exitcond_reg_297 == 1'd0) & (dst1_data_stream_0_V_full_n == 1'b0)) | ((exitcond_reg_297 == 1'd0) & (src_data_stream_2_V_empty_n == 1'b0)) | ((exitcond_reg_297 == 1'd0) & (src_data_stream_1_V_empty_n == 1'b0)) | ((exitcond_reg_297 == 1'd0) & (src_data_stream_0_V_empty_n == 1'b0))));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = ((ap_enable_reg_pp0_iter1 == 1'b1) & (((exitcond_reg_297 == 1'd0) & (dst2_data_stream_2_V_full_n == 1'b0)) | ((exitcond_reg_297 == 1'd0) & (dst2_data_stream_1_V_full_n == 1'b0)) | ((exitcond_reg_297 == 1'd0) & (dst2_data_stream_0_V_full_n == 1'b0)) | ((exitcond_reg_297 == 1'd0) & (dst1_data_stream_2_V_full_n == 1'b0)) | ((exitcond_reg_297 == 1'd0) & (dst1_data_stream_1_V_full_n == 1'b0)) | ((exitcond_reg_297 == 1'd0) & (dst1_data_stream_0_V_full_n == 1'b0)) | ((exitcond_reg_297 == 1'd0) & (src_data_stream_2_V_empty_n == 1'b0)) | ((exitcond_reg_297 == 1'd0) & (src_data_stream_1_V_empty_n == 1'b0)) | ((exitcond_reg_297 == 1'd0) & (src_data_stream_0_V_empty_n == 1'b0))));
end
...
always @ (*) begin
    ap_block_state4_pp0_stage0_iter1 = (((exitcond_reg_297 == 1'd0) & (dst2_data_stream_2_V_full_n == 1'b0)) | ((exitcond_reg_297 == 1'd0) & (dst2_data_stream_1_V_full_n == 1'b0)) | ((exitcond_reg_297 == 1'd0) & (dst2_data_stream_0_V_full_n == 1'b0)) | ((exitcond_reg_297 == 1'd0) & (dst1_data_stream_2_V_full_n == 1'b0)) | ((exitcond_reg_297 == 1'd0) & (dst1_data_stream_1_V_full_n == 1'b0)) | ((exitcond_reg_297 == 1'd0) & (dst1_data_stream_0_V_full_n == 1'b0)) | ((exitcond_reg_297 == 1'd0) & (src_data_stream_2_V_empty_n == 1'b0)) | ((exitcond_reg_297 == 1'd0) & (src_data_stream_1_V_empty_n == 1'b0)) | ((exitcond_reg_297 == 1'd0) & (src_data_stream_0_V_empty_n == 1'b0)));
end
