...
# FIFO definition:
set ID 230
set FifoName start_for_Block_pGfk
set InstName start_for_Block_pGfk_U
set CoreName ap_simcore_fifo
set NumOfStage 2
set RegisteredInput 0
set DualClock 0
...
# FIFO definition:
set ID 231
set FifoName start_for_Block_pHfu
set InstName start_for_Block_pHfu_U
set CoreName ap_simcore_fifo
set NumOfStage 2
set RegisteredInput 0
set DualClock 0
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 0 \
    sync_rst true \
    corename dc_Enabled_V \
    op interface \
    ports { Enabled_V { I 1 vector } } \
} "
}
