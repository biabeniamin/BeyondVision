...
set out_width 21
set exp i0*i1+i2
set arg_lists {i0 {8 0 +} i1 {11 0 +} m {19 0 +} i2 {21 0 +} p {21 0 +} c_reg {1} rnd {0} acc {0} }
set TrueReset 0
if {${::AESL::PGuard_simmodel_gen}} {
...
set out_width 25
set exp i0*i1+i2
set arg_lists {i0 {8 0 +} i1 {11 0 +} m {19 0 +} i2 {24 0 +} p {25 0 +} c_reg {1} rnd {0} acc {0} }
set TrueReset 0
if {${::AESL::PGuard_simmodel_gen}} {
if {[info proc ap_gen_simcore_mac] == "ap_gen_simcore_mac"} {
eval "ap_gen_simcore_mac { \
