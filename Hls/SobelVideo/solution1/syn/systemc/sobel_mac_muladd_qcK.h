...
#ifndef __sobel_mac_muladd_qcK__HH__
#define __sobel_mac_muladd_qcK__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(sobel_mac_muladd_qcK) {
    ...
    SC_CTOR(sobel_mac_muladd_qcK):  simcore_mac_3_U ("simcore_mac_3_U") {
