...
#ifndef __sobel_sitodp_32nsEe0__HH__
#define __sobel_sitodp_32nsEe0__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(sobel_sitodp_32nsEe0) {
    ...
    SC_CTOR(sobel_sitodp_32nsEe0):  ACMP_sitodp_U ("ACMP_sitodp_U") {
