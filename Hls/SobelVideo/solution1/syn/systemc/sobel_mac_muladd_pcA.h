...
#ifndef __sobel_mac_muladd_pcA__HH__
#define __sobel_mac_muladd_pcA__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(sobel_mac_muladd_pcA) {
    ...
    SC_CTOR(sobel_mac_muladd_pcA):  simcore_mac_2_U ("simcore_mac_2_U") {
