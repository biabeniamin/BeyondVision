...
#ifndef __sobel_ama_addmulaocq__HH__
#define __sobel_ama_addmulaocq__HH__
...
template<
    ...
    int din3_WIDTH,
    int dout_WIDTH>
SC_MODULE(sobel_ama_addmulaocq) {
    ...
    SC_CTOR(sobel_ama_addmulaocq):  simcore_ama_0_U ("simcore_ama_0_U") {
