...
#ifndef __sobel_mac_muladd_dEe__HH__
#define __sobel_mac_muladd_dEe__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(sobel_mac_muladd_dEe) {
    ...
    SC_CTOR(sobel_mac_muladd_dEe):  simcore_mac_1_U ("simcore_mac_1_U") {
