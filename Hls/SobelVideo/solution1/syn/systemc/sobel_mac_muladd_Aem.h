...
#ifndef __sobel_mac_muladd_Aem__HH__
#define __sobel_mac_muladd_Aem__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(sobel_mac_muladd_Aem) {
    ...
    SC_CTOR(sobel_mac_muladd_Aem):  simcore_mac_4_U ("simcore_mac_4_U") {
