...
#ifndef __sobel_mac_muladd_Bew__HH__
#define __sobel_mac_muladd_Bew__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(sobel_mac_muladd_Bew) {
    ...
    SC_CTOR(sobel_mac_muladd_Bew):  simcore_mac_5_U ("simcore_mac_5_U") {
