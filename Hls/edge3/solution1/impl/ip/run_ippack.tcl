...
set Interfaces {
    INPUT_STREAMINPUT_STREAM_V_data_V {
        type "axi4stream"
        mode "master"
        port_prefix "INPUT_STREAMINPUT_STREAM_V_data_V"
        has_tready "1"
        ports {
            TDATA 24
        }
    ...
    INPUT_STREAMINPUT_STREAM_V_keep_V {
        type "axi4stream"
        mode "master"
        port_prefix "INPUT_STREAMINPUT_STREAM_V_keep_V"
        has_tready "1"
        ports {
            TKEEP 3
        }
    ...
    INPUT_STREAMINPUT_STREAM_V_strb_V {
        type "axi4stream"
        mode "master"
        port_prefix "INPUT_STREAMINPUT_STREAM_V_strb_V"
        has_tready "1"
        ports {
            TSTRB 3
        }
    ...
    INPUT_STREAMINPUT_STREAM_V_user_V {
        type "axi4stream"
        mode "master"
        port_prefix "INPUT_STREAMINPUT_STREAM_V_user_V"
        has_tready "1"
        ports {
            TUSER 1
        }
    ...
    INPUT_STREAMINPUT_STREAM_V_last_V {
        type "axi4stream"
        mode "master"
        port_prefix "INPUT_STREAMINPUT_STREAM_V_last_V"
        has_tready "1"
        ports {
            TLAST 1
        }
    ...
    INPUT_STREAMINPUT_STREAM_V_id_V {
        type "axi4stream"
        mode "master"
        port_prefix "INPUT_STREAMINPUT_STREAM_V_id_V"
        has_tready "1"
        ports {
            TID 1
        }
    ...
    INPUT_STREAMINPUT_STREAM_V_dest_V {
        type "axi4stream"
        mode "master"
        port_prefix "INPUT_STREAMINPUT_STREAM_V_dest_V"
        has_tready "1"
        ports {
            TDEST 1
        }
    ...
    OUTPUT_STREAMOUTPUT_STREAM_V_data_V {
        type "axi4stream"
        mode "master"
        port_prefix "OUTPUT_STREAMOUTPUT_STREAM_V_data_V"
        has_tready "1"
        ports {
            TDATA 24
        }
    ...
    OUTPUT_STREAMOUTPUT_STREAM_V_keep_V {
        type "axi4stream"
        mode "master"
        port_prefix "OUTPUT_STREAMOUTPUT_STREAM_V_keep_V"
        has_tready "1"
        ports {
            TKEEP 3
        }
    ...
    OUTPUT_STREAMOUTPUT_STREAM_V_strb_V {
        type "axi4stream"
        mode "master"
        port_prefix "OUTPUT_STREAMOUTPUT_STREAM_V_strb_V"
        has_tready "1"
        ports {
            TSTRB 3
        }
    ...
    OUTPUT_STREAMOUTPUT_STREAM_V_user_V {
        type "axi4stream"
        mode "master"
        port_prefix "OUTPUT_STREAMOUTPUT_STREAM_V_user_V"
        has_tready "1"
        ports {
            TUSER 1
        }
    ...
    OUTPUT_STREAMOUTPUT_STREAM_V_last_V {
        type "axi4stream"
        mode "master"
        port_prefix "OUTPUT_STREAMOUTPUT_STREAM_V_last_V"
        has_tready "1"
        ports {
            TLAST 1
        }
    ...
    OUTPUT_STREAMOUTPUT_STREAM_V_id_V {
        type "axi4stream"
        mode "master"
        port_prefix "OUTPUT_STREAMOUTPUT_STREAM_V_id_V"
        has_tready "1"
        ports {
            TID 1
        }
    ...
    OUTPUT_STREAMOUTPUT_STREAM_V_dest_V {
        type "axi4stream"
        mode "master"
        port_prefix "OUTPUT_STREAMOUTPUT_STREAM_V_dest_V"
        has_tready "1"
        ports {
            TDEST 1
        }
    ...
    ap_clk {
        ...
        buses "INPUT_STREAMINPUT_STREAM_V_data_V INPUT_STREAMINPUT_STREAM_V_keep_V INPUT_STREAMINPUT_STREAM_V_strb_V INPUT_STREAMINPUT_STREAM_V_user_V INPUT_STREAMINPUT_STREAM_V_last_V INPUT_STREAMINPUT_STREAM_V_id_V INPUT_STREAMINPUT_STREAM_V_dest_V OUTPUT_STREAMOUTPUT_STREAM_V_data_V OUTPUT_STREAMOUTPUT_STREAM_V_keep_V OUTPUT_STREAMOUTPUT_STREAM_V_strb_V OUTPUT_STREAMOUTPUT_STREAM_V_user_V OUTPUT_STREAMOUTPUT_STREAM_V_last_V OUTPUT_STREAMOUTPUT_STREAM_V_id_V OUTPUT_STREAMOUTPUT_STREAM_V_dest_V"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
