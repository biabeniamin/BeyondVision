...
#include "black_mul_mul_8nsbkb.h"
#include "black_mac_muladd_cud.h"
#include "black_mac_muladd_dEe.h"
...
struct CvtColor_1 : public sc_module {
    ...
    black_mul_mul_8nsbkb<1,1,8,22,29>* black_mul_mul_8nsbkb_U17;
    black_mac_muladd_cud<1,1,8,20,29,29>* black_mac_muladd_cud_U18;
    black_mac_muladd_dEe<1,1,8,23,29,30>* black_mac_muladd_dEe_U19;
    ...
    sc_signal< sc_lv<8> > tmp_11_reg_371;
    sc_signal< sc_lv<8> > tmp_11_reg_371_pp0_iter2_reg;
    sc_signal< sc_lv<8> > tmp_12_reg_376;
    sc_signal< sc_lv<8> > tmp_12_reg_376_pp0_iter2_reg;
    sc_signal< sc_lv<8> > tmp_13_reg_381;
    ...
    sc_signal< sc_lv<8> > tmp_3_i_i_i_i_fu_275_p1;
    sc_signal< sc_lv<8> > p_Val2_4_fu_285_p2;
    sc_signal< sc_lv<1> > tmp_8_fu_278_p3;
    sc_signal< sc_lv<1> > tmp_9_fu_290_p3;
    ...
    void thread_tmp_3_i_i_i_i_fu_275_p1();
    void thread_tmp_8_fu_278_p3();
