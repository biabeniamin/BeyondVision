...
#ifndef __black_mac_muladd_cud__HH__
#define __black_mac_muladd_cud__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(black_mac_muladd_cud) {
    ...
    SC_CTOR(black_mac_muladd_cud):  simcore_mac_0_U ("simcore_mac_0_U") {
