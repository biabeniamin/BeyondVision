...
#ifndef __black_mul_mul_8nsbkb__HH__
#define __black_mul_mul_8nsbkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(black_mul_mul_8nsbkb) {
    ...
    SC_CTOR(black_mul_mul_8nsbkb):  ACMP_smul_uu_U ("ACMP_smul_uu_U") {
