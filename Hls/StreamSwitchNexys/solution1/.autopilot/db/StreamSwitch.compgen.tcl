...
set ID 34
set FifoName fifo_w12_d2_A
set InstName img_0_rows_V_c4_U
set CoreName ap_simcore_fifo
set NumOfStage 2
set RegisteredInput 0
set DualClock 0
...
set ID 35
set FifoName fifo_w12_d2_A
set InstName img_0_cols_V_c5_U
set CoreName ap_simcore_fifo
set NumOfStage 2
set RegisteredInput 0
set DualClock 0
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    reset_level 0 \
    sync_rst true \
    corename {INPUT_STREAM1} \
    metadata {  } \
    op interface \
    ports { INPUT_STREAM1_TDATA { I 24 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'INPUT_STREAM1_V_data_V'"
}
}
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { INPUT_STREAM1_TKEEP { I 3 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'INPUT_STREAM1_V_keep_V'"
}
}
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { INPUT_STREAM1_TSTRB { I 3 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'INPUT_STREAM1_V_strb_V'"
}
}
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    id 40 \
    name INPUT_STREAM1_V_user_V \
    reset_level 0 \
    sync_rst true \
    corename {INPUT_STREAM1} \
    metadata {  } \
    op interface \
    ports { INPUT_STREAM1_TUSER { I 1 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'INPUT_STREAM1_V_user_V'"
}
}
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { INPUT_STREAM1_TLAST { I 1 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'INPUT_STREAM1_V_last_V'"
}
}
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    id 42 \
    name INPUT_STREAM1_V_id_V \
    reset_level 0 \
    sync_rst true \
    corename {INPUT_STREAM1} \
    metadata {  } \
    op interface \
    ports { INPUT_STREAM1_TID { I 1 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'INPUT_STREAM1_V_id_V'"
}
}
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    id 43 \
    name INPUT_STREAM1_V_dest_V \
    reset_level 0 \
    sync_rst true \
    corename {INPUT_STREAM1} \
    metadata {  } \
    op interface \
    ports { INPUT_STREAM1_TDEST { I 1 vector } INPUT_STREAM1_TVALID { I 1 bit } INPUT_STREAM1_TREADY { O 1 bit } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'INPUT_STREAM1_V_dest_V'"
}
}
