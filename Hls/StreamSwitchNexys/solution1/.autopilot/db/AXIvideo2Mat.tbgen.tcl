...
set C_modelArgList {
	{ AXI_video_strm_V_data_V int 24 regular {axi_s 0 volatile  { INPUT_STREAM1 Data } }  }
	{ AXI_video_strm_V_keep_V int 3 regular {axi_s 0 volatile  { INPUT_STREAM1 Keep } }  }
	{ AXI_video_strm_V_strb_V int 3 regular {axi_s 0 volatile  { INPUT_STREAM1 Strb } }  }
	{ AXI_video_strm_V_user_V int 1 regular {axi_s 0 volatile  { INPUT_STREAM1 User } }  }
	{ AXI_video_strm_V_last_V int 1 regular {axi_s 0 volatile  { INPUT_STREAM1 Last } }  }
	{ AXI_video_strm_V_id_V int 1 regular {axi_s 0 volatile  { INPUT_STREAM1 ID } }  }
	{ AXI_video_strm_V_dest_V int 1 regular {axi_s 0 volatile  { INPUT_STREAM1 Dest } }  }
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "INPUT_STREAM1_TDATA", "direction": "in", "datatype": "sc_lv", "bitwidth":24, "type": "signal", "bundle":{"name": "AXI_video_strm_V_data_V", "role": "default" }} , 
 	{ "name": "INPUT_STREAM1_TVALID", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "invld", "bundle":{"name": "AXI_video_strm_V_dest_V", "role": "default" }} , 
 	{ "name": "INPUT_STREAM1_TREADY", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "inacc", "bundle":{"name": "AXI_video_strm_V_dest_V", "role": "default" }} , 
 	{ "name": "INPUT_STREAM1_TKEEP", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "AXI_video_strm_V_keep_V", "role": "default" }} , 
 	{ "name": "INPUT_STREAM1_TSTRB", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "AXI_video_strm_V_strb_V", "role": "default" }} , 
 	{ "name": "INPUT_STREAM1_TUSER", "direction": "in", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "AXI_video_strm_V_user_V", "role": "default" }} , 
 	{ "name": "INPUT_STREAM1_TLAST", "direction": "in", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "AXI_video_strm_V_last_V", "role": "default" }} , 
 	{ "name": "INPUT_STREAM1_TID", "direction": "in", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "AXI_video_strm_V_id_V", "role": "default" }} , 
 	{ "name": "INPUT_STREAM1_TDEST", "direction": "in", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "AXI_video_strm_V_dest_V", "role": "default" }} , 
...
set Spec2ImplPortList { 
	AXI_video_strm_V_data_V { axis {  { INPUT_STREAM1_TDATA in_data 0 24 } } }
	AXI_video_strm_V_keep_V { axis {  { INPUT_STREAM1_TKEEP in_data 0 3 } } }
	AXI_video_strm_V_strb_V { axis {  { INPUT_STREAM1_TSTRB in_data 0 3 } } }
	AXI_video_strm_V_user_V { axis {  { INPUT_STREAM1_TUSER in_data 0 1 } } }
	AXI_video_strm_V_last_V { axis {  { INPUT_STREAM1_TLAST in_data 0 1 } } }
	AXI_video_strm_V_id_V { axis {  { INPUT_STREAM1_TID in_data 0 1 } } }
	AXI_video_strm_V_dest_V { axis {  { INPUT_STREAM1_TVALID in_vld 0 1 }  { INPUT_STREAM1_TREADY in_acc 1 1 }  { INPUT_STREAM1_TDEST in_data 0 1 } } }
