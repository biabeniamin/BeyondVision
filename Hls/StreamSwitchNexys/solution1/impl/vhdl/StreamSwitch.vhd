...
port (
    ...
    INPUT_STREAM2_TDATA : IN STD_LOGIC_VECTOR (23 downto 0);
    INPUT_STREAM2_TKEEP : IN STD_LOGIC_VECTOR (2 downto 0);
    INPUT_STREAM2_TSTRB : IN STD_LOGIC_VECTOR (2 downto 0);
    ...
    Selection_V : IN STD_LOGIC_VECTOR (0 downto 0);
    ap_clk : IN STD_LOGIC;
...
architecture behav of StreamSwitch is 
    attribute CORE_GENERATION_INFO : STRING;
    attribute CORE_GENERATION_INFO of behav : architecture is
    "StreamSwitch,hls_ip_2018_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=1,HLS_INPUT_PART=xc7a200tsbg484-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=7.816000,HLS_SYN_LAT=-1,HLS_SYN_TPT=-1,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=663,HLS_SYN_LUT=1207,HLS_VERSION=2018_2}";
    ...
    signal AXIvideo2Mat_U0_INPUT_STREAM1_TREADY : STD_LOGIC;
    ...
    signal img_0_rows_V_c4_dout : STD_LOGIC_VECTOR (11 downto 0);
...
begin
    ...
    port map (
        ...
        INPUT_STREAM1_TREADY => AXIvideo2Mat_U0_INPUT_STREAM1_TREADY,
    ...
    img_0_rows_V_c4_U : component fifo_w12_d2_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    img_0_cols_V_c5_U : component fifo_w12_d2_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
