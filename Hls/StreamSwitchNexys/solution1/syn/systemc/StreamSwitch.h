...
#ifndef _StreamSwitch_HH_
#define _StreamSwitch_HH_
...
struct StreamSwitch : public sc_module {
    ...
    sc_in< sc_lv<24> > INPUT_STREAM2_TDATA;
    sc_in< sc_lv<3> > INPUT_STREAM2_TKEEP;
    sc_in< sc_lv<3> > INPUT_STREAM2_TSTRB;
    sc_in< sc_lv<1> > INPUT_STREAM2_TUSER;
    sc_in< sc_lv<1> > INPUT_STREAM2_TLAST;
    sc_in< sc_lv<1> > INPUT_STREAM2_TID;
    sc_in< sc_lv<1> > INPUT_STREAM2_TDEST;
    ...
    // Module declarations
    StreamSwitch(sc_module_name name);
    SC_HAS_PROCESS(StreamSwitch);
    ...
    sc_signal< sc_logic > AXIvideo2Mat_U0_INPUT_STREAM1_TREADY;
