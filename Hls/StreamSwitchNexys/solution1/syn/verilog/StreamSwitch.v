...
(* CORE_GENERATION_INFO="StreamSwitch,hls_ip_2018_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=1,HLS_INPUT_PART=xc7a200tsbg484-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=7.816000,HLS_SYN_LAT=-1,HLS_SYN_TPT=-1,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=663,HLS_SYN_LUT=1207,HLS_VERSION=2018_2}" *)
...
input  [23:0] INPUT_STREAM2_TDATA;
input  [2:0] INPUT_STREAM2_TKEEP;
input  [2:0] INPUT_STREAM2_TSTRB;
...
wire    AXIvideo2Mat_U0_INPUT_STREAM1_TREADY;
...
assign INPUT_STREAM1_TREADY = AXIvideo2Mat_U0_INPUT_STREAM1_TREADY;
