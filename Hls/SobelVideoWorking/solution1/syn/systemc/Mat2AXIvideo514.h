...
#ifndef _Mat2AXIvideo514_HH_
#define _Mat2AXIvideo514_HH_
...
struct Mat2AXIvideo514 : public sc_module {
    ...
    // Module declarations
    Mat2AXIvideo514(sc_module_name name);
    SC_HAS_PROCESS(Mat2AXIvideo514);
