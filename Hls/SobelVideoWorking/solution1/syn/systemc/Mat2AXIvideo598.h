...
#ifndef _Mat2AXIvideo598_HH_
#define _Mat2AXIvideo598_HH_
...
struct Mat2AXIvideo598 : public sc_module {
    ...
    // Module declarations
    Mat2AXIvideo598(sc_module_name name);
    SC_HAS_PROCESS(Mat2AXIvideo598);
