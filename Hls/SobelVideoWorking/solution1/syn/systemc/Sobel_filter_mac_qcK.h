...
#ifndef __Sobel_filter_mac_qcK__HH__
#define __Sobel_filter_mac_qcK__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(Sobel_filter_mac_qcK) {
    ...
    SC_CTOR(Sobel_filter_mac_qcK):  simcore_mac_5_U ("simcore_mac_5_U") {
