...
struct Filter2D_1 : public sc_module {
    ...
    Sobel_filter_mux_hbi<1,1,8,8,8,2,8>* Sobel_filter_mux_hbi_U35;
    Sobel_filter_mux_hbi<1,1,8,8,8,2,8>* Sobel_filter_mux_hbi_U36;
    Sobel_filter_mux_hbi<1,1,8,8,8,2,8>* Sobel_filter_mux_hbi_U37;
    Sobel_filter_mux_hbi<1,1,8,8,8,2,8>* Sobel_filter_mux_hbi_U38;
    Sobel_filter_mul_ibs<1,1,8,14,21>* Sobel_filter_mul_ibs_U39;
    Sobel_filter_ama_jbC<1,1,8,8,11,24,25>* Sobel_filter_ama_jbC_U40;
    Sobel_filter_mac_kbM<1,1,8,11,21,21>* Sobel_filter_mac_kbM_U41;
    Sobel_filter_mac_lbW<1,1,8,11,24,25>* Sobel_filter_mac_lbW_U42;
