...
#ifndef __Sobel_filter_sitotde__HH__
#define __Sobel_filter_sitotde__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(Sobel_filter_sitotde) {
    ...
    SC_CTOR(Sobel_filter_sitotde):  ACMP_sitodp_U ("ACMP_sitodp_U") {
