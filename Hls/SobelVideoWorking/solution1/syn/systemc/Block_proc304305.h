...
#ifndef _Block_proc304305_HH_
#define _Block_proc304305_HH_
...
struct Block_proc304305 : public sc_module {
    // Port declarations 40
    sc_in< sc_lv<1> > enable_V_dout;
    sc_in< sc_logic > enable_V_empty_n;
    sc_out< sc_logic > enable_V_read;
    ...
    // Module declarations
    Block_proc304305(sc_module_name name);
    SC_HAS_PROCESS(Block_proc304305);
