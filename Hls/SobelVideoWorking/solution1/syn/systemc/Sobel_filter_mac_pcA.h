...
#ifndef __Sobel_filter_mac_pcA__HH__
#define __Sobel_filter_mac_pcA__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(Sobel_filter_mac_pcA) {
    ...
    SC_CTOR(Sobel_filter_mac_pcA):  simcore_mac_4_U ("simcore_mac_4_U") {
