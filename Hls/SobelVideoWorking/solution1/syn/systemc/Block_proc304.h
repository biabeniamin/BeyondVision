...
struct Block_proc304 : public sc_module {
    ...
    sc_signal< sc_lv<11> > p_C_Xilinx_Vivado_2_1_U0_img_0a_rows_V3_out_din;
    sc_signal< sc_logic > p_C_Xilinx_Vivado_2_1_U0_img_0a_rows_V3_out_write;
    ...
    sc_signal< sc_lv<12> > p_C_Xilinx_Vivado_2_U0_img_0a_cols_V4_out_din;
    sc_signal< sc_logic > p_C_Xilinx_Vivado_2_U0_img_0a_cols_V4_out_write;
    ...
    sc_signal< sc_logic > Mat2AXIvideo554_U0_ap_start;
    sc_signal< sc_logic > Mat2AXIvideo554_U0_ap_done;
    sc_signal< sc_logic > Mat2AXIvideo554_U0_ap_continue;
    sc_signal< sc_logic > Mat2AXIvideo554_U0_ap_idle;
    sc_signal< sc_logic > Mat2AXIvideo554_U0_ap_ready;
    sc_signal< sc_logic > Mat2AXIvideo554_U0_img_rows_V_read;
    sc_signal< sc_logic > Mat2AXIvideo554_U0_img_cols_V_read;
    sc_signal< sc_logic > Mat2AXIvideo554_U0_img_data_stream_0_V_read;
    sc_signal< sc_logic > Mat2AXIvideo554_U0_img_data_stream_1_V_read;
    sc_signal< sc_logic > Mat2AXIvideo554_U0_img_data_stream_2_V_read;
    sc_signal< sc_lv<24> > Mat2AXIvideo554_U0_OUTPUT_STREAM_TDATA;
    sc_signal< sc_logic > Mat2AXIvideo554_U0_OUTPUT_STREAM_TVALID;
    sc_signal< sc_lv<3> > Mat2AXIvideo554_U0_OUTPUT_STREAM_TKEEP;
    sc_signal< sc_lv<3> > Mat2AXIvideo554_U0_OUTPUT_STREAM_TSTRB;
    sc_signal< sc_lv<1> > Mat2AXIvideo554_U0_OUTPUT_STREAM_TUSER;
    sc_signal< sc_lv<1> > Mat2AXIvideo554_U0_OUTPUT_STREAM_TLAST;
    sc_signal< sc_lv<1> > Mat2AXIvideo554_U0_OUTPUT_STREAM_TID;
    sc_signal< sc_lv<1> > Mat2AXIvideo554_U0_OUTPUT_STREAM_TDEST;
    ...
    sc_signal< sc_logic > img_0a_rows_V3_c_full_n;
    sc_signal< sc_lv<11> > img_0a_rows_V3_c_dout;
    sc_signal< sc_logic > img_0a_rows_V3_c_empty_n;
    sc_signal< sc_logic > img_0a_cols_V4_c_full_n;
    sc_signal< sc_lv<12> > img_0a_cols_V4_c_dout;
    sc_signal< sc_logic > img_0a_cols_V4_c_empty_n;
    ...
    sc_signal< sc_logic > img_0a_rows_V3_c1_full_n;
    sc_signal< sc_lv<11> > img_0a_rows_V3_c1_dout;
    sc_signal< sc_logic > img_0a_rows_V3_c1_empty_n;
    sc_signal< sc_logic > img_0a_cols_V4_c2_full_n;
    sc_signal< sc_lv<12> > img_0a_cols_V4_c2_dout;
    sc_signal< sc_logic > img_0a_cols_V4_c2_empty_n;
    ...
    sc_signal< sc_logic > p_C_Xilinx_Vivado_2_1_U0_start_full_n;
    sc_signal< sc_logic > p_C_Xilinx_Vivado_2_1_U0_start_write;
    sc_signal< sc_logic > p_C_Xilinx_Vivado_2_U0_start_full_n;
    sc_signal< sc_logic > p_C_Xilinx_Vivado_2_U0_start_write;
    sc_signal< sc_lv<1> > start_for_Mat2AXIvideo554_U0_din;
    sc_signal< sc_logic > start_for_Mat2AXIvideo554_U0_full_n;
    sc_signal< sc_lv<1> > start_for_Mat2AXIvideo554_U0_dout;
    sc_signal< sc_logic > start_for_Mat2AXIvideo554_U0_empty_n;
    sc_signal< sc_logic > Mat2AXIvideo554_U0_start_full_n;
    sc_signal< sc_logic > Mat2AXIvideo554_U0_start_write;
    ...
    void thread_Mat2AXIvideo554_U0_ap_continue();
    void thread_Mat2AXIvideo554_U0_ap_start();
    void thread_Mat2AXIvideo554_U0_start_full_n();
    void thread_Mat2AXIvideo554_U0_start_write();
    ...
    void thread_p_C_Xilinx_Vivado_2_1_U0_start_full_n();
    void thread_p_C_Xilinx_Vivado_2_1_U0_start_write();
    void thread_p_C_Xilinx_Vivado_2_U0_ap_continue();
    void thread_p_C_Xilinx_Vivado_2_U0_ap_start();
    void thread_p_C_Xilinx_Vivado_2_U0_start_full_n();
    void thread_p_C_Xilinx_Vivado_2_U0_start_write();
    void thread_start_for_Mat2AXIvideo554_U0_din();
};
