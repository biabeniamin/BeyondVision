...
#ifndef __Sobel_filter_mac_kbM__HH__
#define __Sobel_filter_mac_kbM__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(Sobel_filter_mac_kbM) {
    ...
    SC_CTOR(Sobel_filter_mac_kbM):  simcore_mac_2_U ("simcore_mac_2_U") {
