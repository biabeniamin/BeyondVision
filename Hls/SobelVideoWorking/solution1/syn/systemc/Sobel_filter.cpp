...
Sobel_filter::Sobel_filter(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    img_0_cols_V_c21_U = new fifo_w12_d2_A("img_0_cols_V_c21_U");
...
void Sobel_filter::thread_AddWeighted_U0_ap_continue() {
    AddWeighted_U0_ap_continue = ap_const_logic_1;
}

void Sobel_filter::thread_AddWeighted_U0_ap_start() {
...
void Sobel_filter::thread_CvtColor_1_U0_ap_continue() {
    CvtColor_1_U0_ap_continue = ap_const_logic_1;
}

void Sobel_filter::thread_CvtColor_1_U0_ap_start() {
    CvtColor_1_U0_ap_start = start_for_CvtColor_1_U0_empty_n.read();
}

void Sobel_filter::thread_CvtColor_U0_ap_continue() {
    CvtColor_U0_ap_continue = ap_const_logic_1;
}

void Sobel_filter::thread_CvtColor_U0_ap_start() {
    CvtColor_U0_ap_start = start_for_CvtColor_U0_empty_n.read();
}

void Sobel_filter::thread_Duplicate_U0_ap_continue() {
    Duplicate_U0_ap_continue = ap_const_logic_1;
}

void Sobel_filter::thread_Duplicate_U0_ap_start() {
    Duplicate_U0_ap_start = start_for_Duplicate_U0_empty_n.read();
}

void Sobel_filter::thread_Duplicate_U0_start_full_n() {
    Duplicate_U0_start_full_n = (start_for_Sobel_U0_full_n.read() & start_for_Sobel_1_U0_full_n.read());
}

void Sobel_filter::thread_GaussianBlur_U0_ap_continue() {
    GaussianBlur_U0_ap_continue = ap_const_logic_1;
}

void Sobel_filter::thread_GaussianBlur_U0_ap_start() {
...
void Sobel_filter::thread_Sobel_1_U0_ap_continue() {
    Sobel_1_U0_ap_continue = ap_const_logic_1;
}

void Sobel_filter::thread_Sobel_1_U0_ap_start() {
    Sobel_1_U0_ap_start = start_for_Sobel_1_U0_empty_n.read();
}

void Sobel_filter::thread_Sobel_1_U0_start_full_n() {
    Sobel_1_U0_start_full_n = ap_const_logic_1;
}

void Sobel_filter::thread_Sobel_1_U0_start_write() {
    Sobel_1_U0_start_write = ap_const_logic_0;
}

void Sobel_filter::thread_Sobel_U0_ap_continue() {
    Sobel_U0_ap_continue = ap_const_logic_1;
}

void Sobel_filter::thread_Sobel_U0_ap_start() {
...
void Sobel_filter::thread_start_for_AddWeighted_U0_din() {
    start_for_AddWeighted_U0_din =  (sc_lv<1>) (ap_const_logic_1);
}

void Sobel_filter::thread_start_for_CvtColor_1_U0_din() {
    start_for_CvtColor_1_U0_din =  (sc_lv<1>) (ap_const_logic_1);
}

void Sobel_filter::thread_start_for_CvtColor_U0_din() {
    start_for_CvtColor_U0_din =  (sc_lv<1>) (ap_const_logic_1);
}

void Sobel_filter::thread_start_for_Duplicate_U0_din() {
    start_for_Duplicate_U0_din =  (sc_lv<1>) (ap_const_logic_1);
}

void Sobel_filter::thread_start_for_GaussianBlur_U0_din() {
...
void Sobel_filter::thread_start_for_Sobel_1_U0_din() {
    start_for_Sobel_1_U0_din =  (sc_lv<1>) (ap_const_logic_1);
}

void Sobel_filter::thread_start_for_Sobel_U0_din() {
