...
#ifndef __Sobel_filter_mac_lbW__HH__
#define __Sobel_filter_mac_lbW__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(Sobel_filter_mac_lbW) {
    ...
    SC_CTOR(Sobel_filter_mac_lbW):  simcore_mac_3_U ("simcore_mac_3_U") {
