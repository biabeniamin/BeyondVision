...
#ifndef __Sobel_filter_mul_ibs__HH__
#define __Sobel_filter_mul_ibs__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(Sobel_filter_mul_ibs) {
    ...
    SC_CTOR(Sobel_filter_mul_ibs):  ACMP_smul_uu_U ("ACMP_smul_uu_U") {
