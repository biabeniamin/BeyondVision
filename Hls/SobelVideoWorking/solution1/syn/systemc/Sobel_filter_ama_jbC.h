...
#ifndef __Sobel_filter_ama_jbC__HH__
#define __Sobel_filter_ama_jbC__HH__
...
template<
    ...
    int din3_WIDTH,
    int dout_WIDTH>
SC_MODULE(Sobel_filter_ama_jbC) {
    ...
    SC_CTOR(Sobel_filter_ama_jbC):  simcore_ama_0_U ("simcore_ama_0_U") {
