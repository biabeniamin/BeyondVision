...
#ifndef __Sobel_filter_mac_cud__HH__
#define __Sobel_filter_mac_cud__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(Sobel_filter_mac_cud) {
    ...
    SC_CTOR(Sobel_filter_mac_cud):  simcore_mac_0_U ("simcore_mac_0_U") {
