...
#ifndef _Block_proc306_HH_
#define _Block_proc306_HH_

#include "systemc.h"
#include "AESL_pkg.h"

#include "p_C_Xilinx_Vivado_2_1.h"
#include "p_C_Xilinx_Vivado_2.h"
...
#include "start_for_Mat2AXIvdy.h"
#include "start_for_Mat2AXIwdI.h"
#include "start_for_CvtColoxdS.h"
#include "start_for_Gaussiayd2.h"
#include "start_for_Duplicazec.h"
#include "start_for_Sobel_1Aem.h"

namespace ap_rtl {

struct Block_proc306 : public sc_module {
    ...
    // Module declarations
    Block_proc306(sc_module_name name);
    SC_HAS_PROCESS(Block_proc306);
    ...
    sc_signal< sc_logic > p_C_Xilinx_Vivado_2_1_U0_ap_start;
    sc_signal< sc_logic > p_C_Xilinx_Vivado_2_1_U0_ap_done;
    sc_signal< sc_logic > p_C_Xilinx_Vivado_2_1_U0_ap_continue;
    sc_signal< sc_logic > p_C_Xilinx_Vivado_2_1_U0_ap_idle;
    sc_signal< sc_logic > p_C_Xilinx_Vivado_2_1_U0_ap_ready;
    sc_signal< sc_logic > p_C_Xilinx_Vivado_2_1_U0_start_out;
    sc_signal< sc_logic > p_C_Xilinx_Vivado_2_1_U0_start_write;
    sc_signal< sc_lv<11> > p_C_Xilinx_Vivado_2_1_U0_img_0a_rows_V5_out_din;
    sc_signal< sc_logic > p_C_Xilinx_Vivado_2_1_U0_img_0a_rows_V5_out_write;
    sc_signal< sc_logic > p_C_Xilinx_Vivado_2_U0_ap_start;
    sc_signal< sc_logic > p_C_Xilinx_Vivado_2_U0_ap_done;
    sc_signal< sc_logic > p_C_Xilinx_Vivado_2_U0_ap_continue;
    sc_signal< sc_logic > p_C_Xilinx_Vivado_2_U0_ap_idle;
    sc_signal< sc_logic > p_C_Xilinx_Vivado_2_U0_ap_ready;
    sc_signal< sc_logic > p_C_Xilinx_Vivado_2_U0_start_out;
    sc_signal< sc_logic > p_C_Xilinx_Vivado_2_U0_start_write;
    sc_signal< sc_lv<12> > p_C_Xilinx_Vivado_2_U0_img_0a_cols_V6_out_din;
    sc_signal< sc_logic > p_C_Xilinx_Vivado_2_U0_img_0a_cols_V6_out_write;
    sc_signal< sc_logic > AXIvideo2Mat559_U0_ap_start;
    sc_signal< sc_logic > AXIvideo2Mat559_U0_ap_done;
    sc_signal< sc_logic > AXIvideo2Mat559_U0_ap_continue;
    sc_signal< sc_logic > AXIvideo2Mat559_U0_ap_idle;
    sc_signal< sc_logic > AXIvideo2Mat559_U0_ap_ready;
    sc_signal< sc_logic > AXIvideo2Mat559_U0_start_out;
    sc_signal< sc_logic > AXIvideo2Mat559_U0_start_write;
    sc_signal< sc_logic > AXIvideo2Mat559_U0_INPUT_STREAM_TREADY;
    sc_signal< sc_logic > AXIvideo2Mat559_U0_img_rows_V_read;
    sc_signal< sc_logic > AXIvideo2Mat559_U0_img_cols_V_read;
    sc_signal< sc_lv<8> > AXIvideo2Mat559_U0_img_data_stream_0_V_din;
    sc_signal< sc_logic > AXIvideo2Mat559_U0_img_data_stream_0_V_write;
    sc_signal< sc_lv<8> > AXIvideo2Mat559_U0_img_data_stream_1_V_din;
    sc_signal< sc_logic > AXIvideo2Mat559_U0_img_data_stream_1_V_write;
    sc_signal< sc_lv<8> > AXIvideo2Mat559_U0_img_data_stream_2_V_din;
    sc_signal< sc_logic > AXIvideo2Mat559_U0_img_data_stream_2_V_write;
    sc_signal< sc_lv<11> > AXIvideo2Mat559_U0_img_rows_V_out_din;
    sc_signal< sc_logic > AXIvideo2Mat559_U0_img_rows_V_out_write;
    sc_signal< sc_lv<12> > AXIvideo2Mat559_U0_img_cols_V_out_din;
    sc_signal< sc_logic > AXIvideo2Mat559_U0_img_cols_V_out_write;
    sc_signal< sc_logic > Mat2AXIvideo598_U0_ap_start;
    sc_signal< sc_logic > Mat2AXIvideo598_U0_ap_done;
    sc_signal< sc_logic > Mat2AXIvideo598_U0_ap_continue;
    sc_signal< sc_logic > Mat2AXIvideo598_U0_ap_idle;
    sc_signal< sc_logic > Mat2AXIvideo598_U0_ap_ready;
    sc_signal< sc_logic > Mat2AXIvideo598_U0_img_rows_V_read;
    sc_signal< sc_logic > Mat2AXIvideo598_U0_img_cols_V_read;
    sc_signal< sc_logic > Mat2AXIvideo598_U0_img_data_stream_0_V_read;
    sc_signal< sc_logic > Mat2AXIvideo598_U0_img_data_stream_1_V_read;
    sc_signal< sc_logic > Mat2AXIvideo598_U0_img_data_stream_2_V_read;
    sc_signal< sc_lv<24> > Mat2AXIvideo598_U0_OUTPUT_STREAM_TDATA;
    sc_signal< sc_logic > Mat2AXIvideo598_U0_OUTPUT_STREAM_TVALID;
    sc_signal< sc_lv<3> > Mat2AXIvideo598_U0_OUTPUT_STREAM_TKEEP;
    sc_signal< sc_lv<3> > Mat2AXIvideo598_U0_OUTPUT_STREAM_TSTRB;
    sc_signal< sc_lv<1> > Mat2AXIvideo598_U0_OUTPUT_STREAM_TUSER;
    sc_signal< sc_lv<1> > Mat2AXIvideo598_U0_OUTPUT_STREAM_TLAST;
    sc_signal< sc_lv<1> > Mat2AXIvideo598_U0_OUTPUT_STREAM_TID;
    sc_signal< sc_lv<1> > Mat2AXIvideo598_U0_OUTPUT_STREAM_TDEST;
    ...
    sc_signal< sc_logic > img_0a_rows_V5_c_full_n;
    sc_signal< sc_lv<11> > img_0a_rows_V5_c_dout;
    sc_signal< sc_logic > img_0a_rows_V5_c_empty_n;
    sc_signal< sc_logic > img_0a_cols_V6_c_full_n;
    sc_signal< sc_lv<12> > img_0a_cols_V6_c_dout;
    sc_signal< sc_logic > img_0a_cols_V6_c_empty_n;
    sc_signal< sc_logic > img_0a_data_stream_0_full_n;
    sc_signal< sc_lv<8> > img_0a_data_stream_0_dout;
    sc_signal< sc_logic > img_0a_data_stream_0_empty_n;
    sc_signal< sc_logic > img_0a_data_stream_1_full_n;
    sc_signal< sc_lv<8> > img_0a_data_stream_1_dout;
    sc_signal< sc_logic > img_0a_data_stream_1_empty_n;
    sc_signal< sc_logic > img_0a_data_stream_2_full_n;
    sc_signal< sc_lv<8> > img_0a_data_stream_2_dout;
    sc_signal< sc_logic > img_0a_data_stream_2_empty_n;
    sc_signal< sc_logic > img_0a_rows_V5_c1_full_n;
    sc_signal< sc_lv<11> > img_0a_rows_V5_c1_dout;
    sc_signal< sc_logic > img_0a_rows_V5_c1_empty_n;
    sc_signal< sc_logic > img_0a_cols_V6_c2_full_n;
    sc_signal< sc_lv<12> > img_0a_cols_V6_c2_dout;
    sc_signal< sc_logic > img_0a_cols_V6_c2_empty_n;
    ...
    sc_signal< sc_logic > ap_sync_reg_AXIvideo2Mat559_U0_ap_ready;
    sc_signal< sc_logic > ap_sync_AXIvideo2Mat559_U0_ap_ready;
    sc_signal< sc_lv<2> > AXIvideo2Mat559_U0_ap_ready_count;
    ...
    sc_signal< sc_lv<1> > start_for_Mat2AXIvideo598_U0_din;
    sc_signal< sc_logic > start_for_Mat2AXIvideo598_U0_full_n;
    sc_signal< sc_lv<1> > start_for_Mat2AXIvideo598_U0_dout;
    sc_signal< sc_logic > start_for_Mat2AXIvideo598_U0_empty_n;
    sc_signal< sc_logic > Mat2AXIvideo598_U0_start_full_n;
    sc_signal< sc_logic > Mat2AXIvideo598_U0_start_write;
    ...
    sc_signal< sc_logic > start_for_Sobel_U0_read;
    ...
    sc_signal< sc_logic > start_for_CvtColor_U0_read;
    ...
    void thread_AXIvideo2Mat559_U0_ap_continue();
    void thread_AXIvideo2Mat559_U0_ap_start();
    ...
    void thread_Mat2AXIvideo598_U0_ap_continue();
    void thread_Mat2AXIvideo598_U0_ap_start();
    void thread_Mat2AXIvideo598_U0_start_full_n();
    void thread_Mat2AXIvideo598_U0_start_write();
    ...
    void thread_ap_sync_AXIvideo2Mat559_U0_ap_ready();
    void thread_ap_sync_AXIvideo2Mat_U0_ap_ready();
    void thread_ap_sync_continue();
    void thread_ap_sync_done();
    void thread_ap_sync_ready();
    void thread_p_C_Xilinx_Vivado_2_1_U0_ap_continue();
    void thread_p_C_Xilinx_Vivado_2_1_U0_ap_start();
    void thread_p_C_Xilinx_Vivado_2_U0_ap_continue();
    void thread_p_C_Xilinx_Vivado_2_U0_ap_start();
    void thread_start_for_AddWeighted_U0_din();
    void thread_start_for_CvtColor_1_U0_din();
    void thread_start_for_CvtColor_U0_empty_n();
    void thread_start_for_CvtColor_U0_read();
    void thread_start_for_Duplicate_U0_din();
    void thread_start_for_GaussianBlur_U0_din();
    void thread_start_for_Mat2AXIvideo598_U0_din();
    void thread_start_for_Mat2AXIvideo_U0_din();
    void thread_start_for_Sobel_1_U0_din();
    void thread_start_for_Sobel_U0_empty_n();
    void thread_start_for_Sobel_U0_read();
};
