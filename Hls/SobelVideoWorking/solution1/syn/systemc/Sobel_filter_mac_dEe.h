...
#ifndef __Sobel_filter_mac_dEe__HH__
#define __Sobel_filter_mac_dEe__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(Sobel_filter_mac_dEe) {
    ...
    SC_CTOR(Sobel_filter_mac_dEe):  simcore_mac_1_U ("simcore_mac_1_U") {
