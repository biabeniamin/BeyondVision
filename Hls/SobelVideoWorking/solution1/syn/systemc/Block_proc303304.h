...
#ifndef _Block_proc303304_HH_
#define _Block_proc303304_HH_
...
#include "start_for_Duplicaudo.h"
...
struct Block_proc303304 : public sc_module {
    // Port declarations 40
    sc_in< sc_lv<8> > enable_dout;
    sc_in< sc_logic > enable_empty_n;
    sc_out< sc_logic > enable_read;
    sc_in< sc_lv<11> > img_0_rows_V_dout;
    sc_in< sc_logic > img_0_rows_V_empty_n;
    sc_out< sc_logic > img_0_rows_V_read;
    sc_in< sc_lv<12> > img_0_cols_V_dout;
    sc_in< sc_logic > img_0_cols_V_empty_n;
    sc_out< sc_logic > img_0_cols_V_read;
    ...
    sc_in< sc_lv<11> > img_6_rows_V_dout;
    sc_in< sc_logic > img_6_rows_V_empty_n;
    sc_out< sc_logic > img_6_rows_V_read;
    sc_in< sc_lv<12> > img_6_cols_V_dout;
    sc_in< sc_logic > img_6_cols_V_empty_n;
    sc_out< sc_logic > img_6_cols_V_read;
    sc_in_clk ap_clk;
    ...
    // Module declarations
    Block_proc303304(sc_module_name name);
    SC_HAS_PROCESS(Block_proc303304);
    ...
    sc_signal< sc_logic > Mat2AXIvideo_U0_start_out;
    ...
    sc_signal< sc_logic > Mat2AXIvideo_U1_1_ap_start;
    sc_signal< sc_logic > Mat2AXIvideo_U1_1_ap_done;
    sc_signal< sc_logic > Mat2AXIvideo_U1_1_ap_continue;
    sc_signal< sc_logic > Mat2AXIvideo_U1_1_ap_idle;
    sc_signal< sc_logic > Mat2AXIvideo_U1_1_ap_ready;
    sc_signal< sc_logic > Mat2AXIvideo_U1_1_start_out;
    sc_signal< sc_logic > Mat2AXIvideo_U1_1_start_write;
    sc_signal< sc_logic > Mat2AXIvideo_U1_1_img_rows_V_read;
    sc_signal< sc_logic > Mat2AXIvideo_U1_1_img_cols_V_read;
    sc_signal< sc_logic > Mat2AXIvideo_U1_1_img_data_stream_0_V_read;
    sc_signal< sc_logic > Mat2AXIvideo_U1_1_img_data_stream_1_V_read;
    sc_signal< sc_logic > Mat2AXIvideo_U1_1_img_data_stream_2_V_read;
    sc_signal< sc_lv<24> > Mat2AXIvideo_U1_1_OUTPUT_STREAM_TDATA;
    sc_signal< sc_logic > Mat2AXIvideo_U1_1_OUTPUT_STREAM_TVALID;
    sc_signal< sc_lv<3> > Mat2AXIvideo_U1_1_OUTPUT_STREAM_TKEEP;
    sc_signal< sc_lv<3> > Mat2AXIvideo_U1_1_OUTPUT_STREAM_TSTRB;
    sc_signal< sc_lv<1> > Mat2AXIvideo_U1_1_OUTPUT_STREAM_TUSER;
    sc_signal< sc_lv<1> > Mat2AXIvideo_U1_1_OUTPUT_STREAM_TLAST;
    sc_signal< sc_lv<1> > Mat2AXIvideo_U1_1_OUTPUT_STREAM_TID;
    sc_signal< sc_lv<1> > Mat2AXIvideo_U1_1_OUTPUT_STREAM_TDEST;
    ...
    sc_signal< sc_logic > ap_sync_reg_CvtColor_1_U0_ap_ready;
    sc_signal< sc_logic > ap_sync_CvtColor_1_U0_ap_ready;
    sc_signal< sc_lv<2> > CvtColor_1_U0_ap_ready_count;
    sc_signal< sc_logic > ap_sync_reg_Mat2AXIvideo_U1_1_ap_ready;
    sc_signal< sc_logic > ap_sync_Mat2AXIvideo_U1_1_ap_ready;
    sc_signal< sc_lv<2> > Mat2AXIvideo_U1_1_ap_ready_count;
    ...
    void thread_Mat2AXIvideo_U1_1_ap_continue();
    void thread_Mat2AXIvideo_U1_1_ap_start();
    ...
    void thread_ap_sync_CvtColor_1_U0_ap_ready();
    void thread_ap_sync_Mat2AXIvideo_U0_ap_ready();
    void thread_ap_sync_Mat2AXIvideo_U1_1_ap_ready();
    void thread_ap_sync_continue();
    void thread_ap_sync_done();
    void thread_ap_sync_ready();
    void thread_enable_read();
    ...
    void thread_img_6_cols_V_read();
    void thread_img_6_rows_V_read();
