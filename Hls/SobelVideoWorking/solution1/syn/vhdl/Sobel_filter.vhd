...
architecture behav of Sobel_filter is 
    ...
    "Sobel_filter,hls_ip_2018_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=1,HLS_INPUT_PART=xc7a200tsbg484-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=11.000000,HLS_SYN_LAT=-1,HLS_SYN_TPT=-1,HLS_SYN_MEM=9,HLS_SYN_DSP=39,HLS_SYN_FF=6308,HLS_SYN_LUT=10745,HLS_VERSION=2018_2}";
    ...
    signal Block_proc467_U0_ap_start : STD_LOGIC;
    signal Block_proc467_U0_ap_done : STD_LOGIC;
    signal Block_proc467_U0_ap_continue : STD_LOGIC;
    signal Block_proc467_U0_ap_idle : STD_LOGIC;
    signal Block_proc467_U0_ap_ready : STD_LOGIC;
    signal Block_proc467_U0_start_out : STD_LOGIC;
    signal Block_proc467_U0_start_write : STD_LOGIC;
    signal Block_proc467_U0_img_0_rows_V_out_din : STD_LOGIC_VECTOR (10 downto 0);
    signal Block_proc467_U0_img_0_rows_V_out_write : STD_LOGIC;
    signal Block_proc467_U0_img_0_cols_V_out_din : STD_LOGIC_VECTOR (11 downto 0);
    signal Block_proc467_U0_img_0_cols_V_out_write : STD_LOGIC;
    signal Block_proc467_U0_img_6_rows_V_out_din : STD_LOGIC_VECTOR (10 downto 0);
    signal Block_proc467_U0_img_6_rows_V_out_write : STD_LOGIC;
    signal Block_proc467_U0_img_6_cols_V_out_din : STD_LOGIC_VECTOR (11 downto 0);
    signal Block_proc467_U0_img_6_cols_V_out_write : STD_LOGIC;
    signal Block_proc467_U0_enable_V_out_din : STD_LOGIC_VECTOR (0 downto 0);
    signal Block_proc467_U0_enable_V_out_write : STD_LOGIC;
    ...
    signal Block_proc304305_U0_enable_V_read : STD_LOGIC;
    signal Block_proc304305_U0_img_0_rows_V_read : STD_LOGIC;
    signal Block_proc304305_U0_img_0_cols_V_read : STD_LOGIC;
    signal Block_proc304305_U0_img_0_data_stream_0_V_read : STD_LOGIC;
    signal Block_proc304305_U0_img_0_data_stream_1_V_read : STD_LOGIC;
    signal Block_proc304305_U0_img_0_data_stream_2_V_read : STD_LOGIC;
    signal Block_proc304305_U0_OUTPUT_STREAM_TDATA : STD_LOGIC_VECTOR (23 downto 0);
    signal Block_proc304305_U0_OUTPUT_STREAM_TKEEP : STD_LOGIC_VECTOR (2 downto 0);
    signal Block_proc304305_U0_OUTPUT_STREAM_TSTRB : STD_LOGIC_VECTOR (2 downto 0);
    signal Block_proc304305_U0_OUTPUT_STREAM_TUSER : STD_LOGIC_VECTOR (0 downto 0);
    signal Block_proc304305_U0_OUTPUT_STREAM_TLAST : STD_LOGIC_VECTOR (0 downto 0);
    signal Block_proc304305_U0_OUTPUT_STREAM_TID : STD_LOGIC_VECTOR (0 downto 0);
    signal Block_proc304305_U0_OUTPUT_STREAM_TDEST : STD_LOGIC_VECTOR (0 downto 0);
    signal Block_proc304305_U0_img_6_rows_V_read : STD_LOGIC;
    signal Block_proc304305_U0_img_6_cols_V_read : STD_LOGIC;
    signal Block_proc304305_U0_OUTPUT_STREAM_TVALID : STD_LOGIC;
    signal Block_proc304305_U0_ap_done : STD_LOGIC;
    signal Block_proc304305_U0_ap_start : STD_LOGIC;
    signal Block_proc304305_U0_ap_ready : STD_LOGIC;
    signal Block_proc304305_U0_ap_idle : STD_LOGIC;
    signal Block_proc304305_U0_ap_continue : STD_LOGIC;
    ...
    signal enable_V_c_full_n : STD_LOGIC;
    signal enable_V_c_dout : STD_LOGIC_VECTOR (0 downto 0);
    signal enable_V_c_empty_n : STD_LOGIC;
    ...
    signal ap_sync_reg_Block_proc467_U0_ap_ready : STD_LOGIC := '0';
    signal ap_sync_Block_proc467_U0_ap_ready : STD_LOGIC;
    signal Block_proc467_U0_ap_ready_count : STD_LOGIC_VECTOR (1 downto 0) := "00";
    signal start_for_Block_proc304305_U0_din : STD_LOGIC_VECTOR (0 downto 0);
    signal start_for_Block_proc304305_U0_full_n : STD_LOGIC;
    signal start_for_Block_proc304305_U0_dout : STD_LOGIC_VECTOR (0 downto 0);
    signal start_for_Block_proc304305_U0_empty_n : STD_LOGIC;
    signal AXIvideo2Mat_U0_start_full_n : STD_LOGIC;
    signal AXIvideo2Mat_U0_start_write : STD_LOGIC;
    signal Block_proc304305_U0_start_full_n : STD_LOGIC;
    signal Block_proc304305_U0_start_write : STD_LOGIC;

    component Block_proc467 IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
        ...
        enable_V_out_din : OUT STD_LOGIC_VECTOR (0 downto 0);
        enable_V_out_full_n : IN STD_LOGIC;
        enable_V_out_write : OUT STD_LOGIC );
    end component;
...
begin
    Block_proc467_U0 : component Block_proc467
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
    ...
    Block_proc304305_U0 : component Block_proc304305
    port map (
    ...
    enable_V_c_U : component fifo_w1_d3_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    ap_sync_reg_Block_proc467_U0_ap_ready_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst_n_inv = '1') then
    ...
    Block_proc467_U0_ap_ready_count_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_sync_ready = ap_const_logic_1) and (ap_const_logic_0 = Block_proc467_U0_ap_ready))) then 
                Block_proc467_U0_ap_ready_count <= std_logic_vector(unsigned(Block_proc467_U0_ap_ready_count) - unsigned(ap_const_lv2_1));
            elsif (((ap_const_logic_1 = Block_proc467_U0_ap_ready) and (ap_sync_ready = ap_const_logic_0))) then 
                Block_proc467_U0_ap_ready_count <= std_logic_vector(unsigned(Block_proc467_U0_ap_ready_count) + unsigned(ap_const_lv2_1));
            end if; 
        end if;
    end process;
    ...
    Block_proc304305_U0_ap_start <= start_for_Block_proc304305_U0_empty_n;
    ...
    Block_proc467_U0_ap_start <= ((ap_sync_reg_Block_proc467_U0_ap_ready xor ap_const_logic_1) and ap_start);
    INPUT_STREAM_TREADY <= AXIvideo2Mat_U0_INPUT_STREAM_TREADY;
    OUTPUT_STREAM_TDATA <= Block_proc304305_U0_OUTPUT_STREAM_TDATA;
    OUTPUT_STREAM_TDEST <= Block_proc304305_U0_OUTPUT_STREAM_TDEST;
    OUTPUT_STREAM_TID <= Block_proc304305_U0_OUTPUT_STREAM_TID;
    ...
    OUTPUT_STREAM_TVALID <= Block_proc304305_U0_OUTPUT_STREAM_TVALID;
    ap_done <= Block_proc304305_U0_ap_done;
    ap_idle <= (Block_proc467_U0_ap_idle and Block_proc304305_U0_ap_idle and AXIvideo2Mat_U0_ap_idle);
    ...
    ap_sync_Block_proc467_U0_ap_ready <= (ap_sync_reg_Block_proc467_U0_ap_ready or Block_proc467_U0_ap_ready);
    ap_sync_continue <= ap_const_logic_1;
    ap_sync_done <= Block_proc304305_U0_ap_done;
    ap_sync_ready <= (ap_sync_Block_proc467_U0_ap_ready and ap_sync_AXIvideo2Mat_U0_ap_ready);
    start_for_Block_proc304305_U0_din <= (0=>ap_const_logic_1, others=>'-');
end behav;
