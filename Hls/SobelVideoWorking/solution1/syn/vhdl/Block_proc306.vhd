...
architecture behav of Block_proc306 is 
    ...
    signal p_C_Xilinx_Vivado_2_1_U0_ap_start : STD_LOGIC;
    signal p_C_Xilinx_Vivado_2_1_U0_ap_done : STD_LOGIC;
    signal p_C_Xilinx_Vivado_2_1_U0_ap_continue : STD_LOGIC;
    signal p_C_Xilinx_Vivado_2_1_U0_ap_idle : STD_LOGIC;
    signal p_C_Xilinx_Vivado_2_1_U0_ap_ready : STD_LOGIC;
    signal p_C_Xilinx_Vivado_2_1_U0_start_out : STD_LOGIC;
    signal p_C_Xilinx_Vivado_2_1_U0_start_write : STD_LOGIC;
    signal p_C_Xilinx_Vivado_2_1_U0_img_0a_rows_V5_out_din : STD_LOGIC_VECTOR (10 downto 0);
    signal p_C_Xilinx_Vivado_2_1_U0_img_0a_rows_V5_out_write : STD_LOGIC;
    signal p_C_Xilinx_Vivado_2_U0_ap_start : STD_LOGIC;
    signal p_C_Xilinx_Vivado_2_U0_ap_done : STD_LOGIC;
    signal p_C_Xilinx_Vivado_2_U0_ap_continue : STD_LOGIC;
    signal p_C_Xilinx_Vivado_2_U0_ap_idle : STD_LOGIC;
    signal p_C_Xilinx_Vivado_2_U0_ap_ready : STD_LOGIC;
    signal p_C_Xilinx_Vivado_2_U0_start_out : STD_LOGIC;
    signal p_C_Xilinx_Vivado_2_U0_start_write : STD_LOGIC;
    signal p_C_Xilinx_Vivado_2_U0_img_0a_cols_V6_out_din : STD_LOGIC_VECTOR (11 downto 0);
    signal p_C_Xilinx_Vivado_2_U0_img_0a_cols_V6_out_write : STD_LOGIC;
    signal AXIvideo2Mat559_U0_ap_start : STD_LOGIC;
    signal AXIvideo2Mat559_U0_ap_done : STD_LOGIC;
    signal AXIvideo2Mat559_U0_ap_continue : STD_LOGIC;
    signal AXIvideo2Mat559_U0_ap_idle : STD_LOGIC;
    signal AXIvideo2Mat559_U0_ap_ready : STD_LOGIC;
    signal AXIvideo2Mat559_U0_start_out : STD_LOGIC;
    signal AXIvideo2Mat559_U0_start_write : STD_LOGIC;
    signal AXIvideo2Mat559_U0_INPUT_STREAM_TREADY : STD_LOGIC;
    signal AXIvideo2Mat559_U0_img_rows_V_read : STD_LOGIC;
    signal AXIvideo2Mat559_U0_img_cols_V_read : STD_LOGIC;
    signal AXIvideo2Mat559_U0_img_data_stream_0_V_din : STD_LOGIC_VECTOR (7 downto 0);
    signal AXIvideo2Mat559_U0_img_data_stream_0_V_write : STD_LOGIC;
    signal AXIvideo2Mat559_U0_img_data_stream_1_V_din : STD_LOGIC_VECTOR (7 downto 0);
    signal AXIvideo2Mat559_U0_img_data_stream_1_V_write : STD_LOGIC;
    signal AXIvideo2Mat559_U0_img_data_stream_2_V_din : STD_LOGIC_VECTOR (7 downto 0);
    signal AXIvideo2Mat559_U0_img_data_stream_2_V_write : STD_LOGIC;
    signal AXIvideo2Mat559_U0_img_rows_V_out_din : STD_LOGIC_VECTOR (10 downto 0);
    signal AXIvideo2Mat559_U0_img_rows_V_out_write : STD_LOGIC;
    signal AXIvideo2Mat559_U0_img_cols_V_out_din : STD_LOGIC_VECTOR (11 downto 0);
    signal AXIvideo2Mat559_U0_img_cols_V_out_write : STD_LOGIC;
    signal Mat2AXIvideo598_U0_ap_start : STD_LOGIC;
    signal Mat2AXIvideo598_U0_ap_done : STD_LOGIC;
    signal Mat2AXIvideo598_U0_ap_continue : STD_LOGIC;
    signal Mat2AXIvideo598_U0_ap_idle : STD_LOGIC;
    signal Mat2AXIvideo598_U0_ap_ready : STD_LOGIC;
    signal Mat2AXIvideo598_U0_img_rows_V_read : STD_LOGIC;
    signal Mat2AXIvideo598_U0_img_cols_V_read : STD_LOGIC;
    signal Mat2AXIvideo598_U0_img_data_stream_0_V_read : STD_LOGIC;
    signal Mat2AXIvideo598_U0_img_data_stream_1_V_read : STD_LOGIC;
    signal Mat2AXIvideo598_U0_img_data_stream_2_V_read : STD_LOGIC;
    signal Mat2AXIvideo598_U0_OUTPUT_STREAM_TDATA : STD_LOGIC_VECTOR (23 downto 0);
    signal Mat2AXIvideo598_U0_OUTPUT_STREAM_TVALID : STD_LOGIC;
    signal Mat2AXIvideo598_U0_OUTPUT_STREAM_TKEEP : STD_LOGIC_VECTOR (2 downto 0);
    signal Mat2AXIvideo598_U0_OUTPUT_STREAM_TSTRB : STD_LOGIC_VECTOR (2 downto 0);
    signal Mat2AXIvideo598_U0_OUTPUT_STREAM_TUSER : STD_LOGIC_VECTOR (0 downto 0);
    signal Mat2AXIvideo598_U0_OUTPUT_STREAM_TLAST : STD_LOGIC_VECTOR (0 downto 0);
    signal Mat2AXIvideo598_U0_OUTPUT_STREAM_TID : STD_LOGIC_VECTOR (0 downto 0);
    signal Mat2AXIvideo598_U0_OUTPUT_STREAM_TDEST : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal img_0a_rows_V5_c_full_n : STD_LOGIC;
    signal img_0a_rows_V5_c_dout : STD_LOGIC_VECTOR (10 downto 0);
    signal img_0a_rows_V5_c_empty_n : STD_LOGIC;
    signal img_0a_cols_V6_c_full_n : STD_LOGIC;
    signal img_0a_cols_V6_c_dout : STD_LOGIC_VECTOR (11 downto 0);
    signal img_0a_cols_V6_c_empty_n : STD_LOGIC;
    signal img_0a_data_stream_0_full_n : STD_LOGIC;
    signal img_0a_data_stream_0_dout : STD_LOGIC_VECTOR (7 downto 0);
    signal img_0a_data_stream_0_empty_n : STD_LOGIC;
    signal img_0a_data_stream_1_full_n : STD_LOGIC;
    signal img_0a_data_stream_1_dout : STD_LOGIC_VECTOR (7 downto 0);
    signal img_0a_data_stream_1_empty_n : STD_LOGIC;
    signal img_0a_data_stream_2_full_n : STD_LOGIC;
    signal img_0a_data_stream_2_dout : STD_LOGIC_VECTOR (7 downto 0);
    signal img_0a_data_stream_2_empty_n : STD_LOGIC;
    signal img_0a_rows_V5_c1_full_n : STD_LOGIC;
    signal img_0a_rows_V5_c1_dout : STD_LOGIC_VECTOR (10 downto 0);
    signal img_0a_rows_V5_c1_empty_n : STD_LOGIC;
    signal img_0a_cols_V6_c2_full_n : STD_LOGIC;
    signal img_0a_cols_V6_c2_dout : STD_LOGIC_VECTOR (11 downto 0);
    signal img_0a_cols_V6_c2_empty_n : STD_LOGIC;
    ...
    signal ap_sync_reg_AXIvideo2Mat559_U0_ap_ready : STD_LOGIC := '0';
    signal ap_sync_AXIvideo2Mat559_U0_ap_ready : STD_LOGIC;
    signal AXIvideo2Mat559_U0_ap_ready_count : STD_LOGIC_VECTOR (1 downto 0) := "00";
    ...
    signal start_for_Mat2AXIvideo598_U0_din : STD_LOGIC_VECTOR (0 downto 0);
    signal start_for_Mat2AXIvideo598_U0_full_n : STD_LOGIC;
    signal start_for_Mat2AXIvideo598_U0_dout : STD_LOGIC_VECTOR (0 downto 0);
    signal start_for_Mat2AXIvideo598_U0_empty_n : STD_LOGIC;
    signal Mat2AXIvideo598_U0_start_full_n : STD_LOGIC;
    signal Mat2AXIvideo598_U0_start_write : STD_LOGIC;
    ...
    signal start_for_Sobel_U0_read : STD_LOGIC;
    ...
    port (
        ...
        img_0a_rows_V5_out_din : OUT STD_LOGIC_VECTOR (10 downto 0);
        img_0a_rows_V5_out_full_n : IN STD_LOGIC;
        img_0a_rows_V5_out_write : OUT STD_LOGIC );
    end component;


    component p_C_Xilinx_Vivado_2 IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
        ...
        start_out : OUT STD_LOGIC;
        start_write : OUT STD_LOGIC;
        img_0a_cols_V6_out_din : OUT STD_LOGIC_VECTOR (11 downto 0);
        img_0a_cols_V6_out_full_n : IN STD_LOGIC;
        img_0a_cols_V6_out_write : OUT STD_LOGIC );
    end component;


    component AXIvideo2Mat559 IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component start_for_Gaussiayd2 IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component start_for_Duplicazec IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component start_for_Sobel_1Aem IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
...
begin
    p_C_Xilinx_Vivado_2_1_U0 : component p_C_Xilinx_Vivado_2_1
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
        ap_start => p_C_Xilinx_Vivado_2_1_U0_ap_start,
        start_full_n => start_for_AddWeighted_U0_full_n,
        ap_done => p_C_Xilinx_Vivado_2_1_U0_ap_done,
        ap_continue => p_C_Xilinx_Vivado_2_1_U0_ap_continue,
        ap_idle => p_C_Xilinx_Vivado_2_1_U0_ap_idle,
        ap_ready => p_C_Xilinx_Vivado_2_1_U0_ap_ready,
        start_out => p_C_Xilinx_Vivado_2_1_U0_start_out,
        start_write => p_C_Xilinx_Vivado_2_1_U0_start_write,
        img_0a_rows_V5_out_din => p_C_Xilinx_Vivado_2_1_U0_img_0a_rows_V5_out_din,
        img_0a_rows_V5_out_full_n => img_0a_rows_V5_c_full_n,
        img_0a_rows_V5_out_write => p_C_Xilinx_Vivado_2_1_U0_img_0a_rows_V5_out_write);

    p_C_Xilinx_Vivado_2_U0 : component p_C_Xilinx_Vivado_2
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
        ap_start => p_C_Xilinx_Vivado_2_U0_ap_start,
        start_full_n => start_for_Mat2AXIvideo_U0_full_n,
        ap_done => p_C_Xilinx_Vivado_2_U0_ap_done,
        ap_continue => p_C_Xilinx_Vivado_2_U0_ap_continue,
        ap_idle => p_C_Xilinx_Vivado_2_U0_ap_idle,
        ap_ready => p_C_Xilinx_Vivado_2_U0_ap_ready,
        start_out => p_C_Xilinx_Vivado_2_U0_start_out,
        start_write => p_C_Xilinx_Vivado_2_U0_start_write,
        img_0a_cols_V6_out_din => p_C_Xilinx_Vivado_2_U0_img_0a_cols_V6_out_din,
        img_0a_cols_V6_out_full_n => img_0a_cols_V6_c_full_n,
        img_0a_cols_V6_out_write => p_C_Xilinx_Vivado_2_U0_img_0a_cols_V6_out_write);

    AXIvideo2Mat559_U0 : component AXIvideo2Mat559
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
        ap_start => AXIvideo2Mat559_U0_ap_start,
        start_full_n => start_for_Mat2AXIvideo598_U0_full_n,
        ap_done => AXIvideo2Mat559_U0_ap_done,
        ap_continue => AXIvideo2Mat559_U0_ap_continue,
        ap_idle => AXIvideo2Mat559_U0_ap_idle,
        ap_ready => AXIvideo2Mat559_U0_ap_ready,
        start_out => AXIvideo2Mat559_U0_start_out,
        start_write => AXIvideo2Mat559_U0_start_write,
        INPUT_STREAM_TDATA => INPUT_STREAM_TDATA,
        INPUT_STREAM_TVALID => INPUT_STREAM_TVALID,
        INPUT_STREAM_TREADY => AXIvideo2Mat559_U0_INPUT_STREAM_TREADY,
        ...
        img_rows_V_dout => img_0a_rows_V5_c_dout,
        img_rows_V_empty_n => img_0a_rows_V5_c_empty_n,
        img_rows_V_read => AXIvideo2Mat559_U0_img_rows_V_read,
        img_cols_V_dout => img_0a_cols_V6_c_dout,
        img_cols_V_empty_n => img_0a_cols_V6_c_empty_n,
        img_cols_V_read => AXIvideo2Mat559_U0_img_cols_V_read,
        img_data_stream_0_V_din => AXIvideo2Mat559_U0_img_data_stream_0_V_din,
        img_data_stream_0_V_full_n => img_0a_data_stream_0_full_n,
        img_data_stream_0_V_write => AXIvideo2Mat559_U0_img_data_stream_0_V_write,
        img_data_stream_1_V_din => AXIvideo2Mat559_U0_img_data_stream_1_V_din,
        img_data_stream_1_V_full_n => img_0a_data_stream_1_full_n,
        img_data_stream_1_V_write => AXIvideo2Mat559_U0_img_data_stream_1_V_write,
        img_data_stream_2_V_din => AXIvideo2Mat559_U0_img_data_stream_2_V_din,
        img_data_stream_2_V_full_n => img_0a_data_stream_2_full_n,
        img_data_stream_2_V_write => AXIvideo2Mat559_U0_img_data_stream_2_V_write,
        img_rows_V_out_din => AXIvideo2Mat559_U0_img_rows_V_out_din,
        img_rows_V_out_full_n => img_0a_rows_V5_c1_full_n,
        img_rows_V_out_write => AXIvideo2Mat559_U0_img_rows_V_out_write,
        img_cols_V_out_din => AXIvideo2Mat559_U0_img_cols_V_out_din,
        img_cols_V_out_full_n => img_0a_cols_V6_c2_full_n,
        img_cols_V_out_write => AXIvideo2Mat559_U0_img_cols_V_out_write);

    Mat2AXIvideo598_U0 : component Mat2AXIvideo598
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
        ap_start => Mat2AXIvideo598_U0_ap_start,
        ap_done => Mat2AXIvideo598_U0_ap_done,
        ap_continue => Mat2AXIvideo598_U0_ap_continue,
        ap_idle => Mat2AXIvideo598_U0_ap_idle,
        ap_ready => Mat2AXIvideo598_U0_ap_ready,
        img_rows_V_dout => img_0a_rows_V5_c1_dout,
        img_rows_V_empty_n => img_0a_rows_V5_c1_empty_n,
        img_rows_V_read => Mat2AXIvideo598_U0_img_rows_V_read,
        img_cols_V_dout => img_0a_cols_V6_c2_dout,
        img_cols_V_empty_n => img_0a_cols_V6_c2_empty_n,
        img_cols_V_read => Mat2AXIvideo598_U0_img_cols_V_read,
        img_data_stream_0_V_dout => img_0a_data_stream_0_dout,
        img_data_stream_0_V_empty_n => img_0a_data_stream_0_empty_n,
        img_data_stream_0_V_read => Mat2AXIvideo598_U0_img_data_stream_0_V_read,
        img_data_stream_1_V_dout => img_0a_data_stream_1_dout,
        img_data_stream_1_V_empty_n => img_0a_data_stream_1_empty_n,
        img_data_stream_1_V_read => Mat2AXIvideo598_U0_img_data_stream_1_V_read,
        img_data_stream_2_V_dout => img_0a_data_stream_2_dout,
        img_data_stream_2_V_empty_n => img_0a_data_stream_2_empty_n,
        img_data_stream_2_V_read => Mat2AXIvideo598_U0_img_data_stream_2_V_read,
        OUTPUT_STREAM_TDATA => Mat2AXIvideo598_U0_OUTPUT_STREAM_TDATA,
        OUTPUT_STREAM_TVALID => Mat2AXIvideo598_U0_OUTPUT_STREAM_TVALID,
        OUTPUT_STREAM_TREADY => OUTPUT_STREAM_TREADY,
        OUTPUT_STREAM_TKEEP => Mat2AXIvideo598_U0_OUTPUT_STREAM_TKEEP,
        OUTPUT_STREAM_TSTRB => Mat2AXIvideo598_U0_OUTPUT_STREAM_TSTRB,
        OUTPUT_STREAM_TUSER => Mat2AXIvideo598_U0_OUTPUT_STREAM_TUSER,
        OUTPUT_STREAM_TLAST => Mat2AXIvideo598_U0_OUTPUT_STREAM_TLAST,
        OUTPUT_STREAM_TID => Mat2AXIvideo598_U0_OUTPUT_STREAM_TID,
        OUTPUT_STREAM_TDEST => Mat2AXIvideo598_U0_OUTPUT_STREAM_TDEST);
    ...
    img_0a_rows_V5_c_U : component fifo_w11_d2_A
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
        if_write_ce => ap_const_logic_1,
        if_din => p_C_Xilinx_Vivado_2_1_U0_img_0a_rows_V5_out_din,
        if_full_n => img_0a_rows_V5_c_full_n,
        if_write => p_C_Xilinx_Vivado_2_1_U0_img_0a_rows_V5_out_write,
        if_dout => img_0a_rows_V5_c_dout,
        if_empty_n => img_0a_rows_V5_c_empty_n,
        if_read => AXIvideo2Mat559_U0_img_rows_V_read);

    img_0a_cols_V6_c_U : component fifo_w12_d2_A
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
        if_write_ce => ap_const_logic_1,
        if_din => p_C_Xilinx_Vivado_2_U0_img_0a_cols_V6_out_din,
        if_full_n => img_0a_cols_V6_c_full_n,
        if_write => p_C_Xilinx_Vivado_2_U0_img_0a_cols_V6_out_write,
        if_dout => img_0a_cols_V6_c_dout,
        if_empty_n => img_0a_cols_V6_c_empty_n,
        if_read => AXIvideo2Mat559_U0_img_cols_V_read);

    img_0a_data_stream_0_U : component fifo_w8_d2_A
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
        if_write_ce => ap_const_logic_1,
        if_din => AXIvideo2Mat559_U0_img_data_stream_0_V_din,
        if_full_n => img_0a_data_stream_0_full_n,
        if_write => AXIvideo2Mat559_U0_img_data_stream_0_V_write,
        if_dout => img_0a_data_stream_0_dout,
        if_empty_n => img_0a_data_stream_0_empty_n,
        if_read => Mat2AXIvideo598_U0_img_data_stream_0_V_read);

    img_0a_data_stream_1_U : component fifo_w8_d2_A
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
        if_write_ce => ap_const_logic_1,
        if_din => AXIvideo2Mat559_U0_img_data_stream_1_V_din,
        if_full_n => img_0a_data_stream_1_full_n,
        if_write => AXIvideo2Mat559_U0_img_data_stream_1_V_write,
        if_dout => img_0a_data_stream_1_dout,
        if_empty_n => img_0a_data_stream_1_empty_n,
        if_read => Mat2AXIvideo598_U0_img_data_stream_1_V_read);

    img_0a_data_stream_2_U : component fifo_w8_d2_A
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
        if_write_ce => ap_const_logic_1,
        if_din => AXIvideo2Mat559_U0_img_data_stream_2_V_din,
        if_full_n => img_0a_data_stream_2_full_n,
        if_write => AXIvideo2Mat559_U0_img_data_stream_2_V_write,
        if_dout => img_0a_data_stream_2_dout,
        if_empty_n => img_0a_data_stream_2_empty_n,
        if_read => Mat2AXIvideo598_U0_img_data_stream_2_V_read);

    img_0a_rows_V5_c1_U : component fifo_w11_d2_A
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
        if_write_ce => ap_const_logic_1,
        if_din => AXIvideo2Mat559_U0_img_rows_V_out_din,
        if_full_n => img_0a_rows_V5_c1_full_n,
        if_write => AXIvideo2Mat559_U0_img_rows_V_out_write,
        if_dout => img_0a_rows_V5_c1_dout,
        if_empty_n => img_0a_rows_V5_c1_empty_n,
        if_read => Mat2AXIvideo598_U0_img_rows_V_read);

    img_0a_cols_V6_c2_U : component fifo_w12_d2_A
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
        if_write_ce => ap_const_logic_1,
        if_din => AXIvideo2Mat559_U0_img_cols_V_out_din,
        if_full_n => img_0a_cols_V6_c2_full_n,
        if_write => AXIvideo2Mat559_U0_img_cols_V_out_write,
        if_dout => img_0a_cols_V6_c2_dout,
        if_empty_n => img_0a_cols_V6_c2_empty_n,
        if_read => Mat2AXIvideo598_U0_img_cols_V_read);
    ...
    port map (
        ...
        if_write => p_C_Xilinx_Vivado_2_1_U0_start_write,
    ...
    port map (
        ...
        if_write => p_C_Xilinx_Vivado_2_U0_start_write,
    ...
    port map (
        ...
        if_read_ce => ap_const_logic_1,
        if_write_ce => ap_const_logic_1,
        if_din => start_for_Mat2AXIvideo598_U0_din,
        if_full_n => start_for_Mat2AXIvideo598_U0_full_n,
        if_write => AXIvideo2Mat559_U0_start_write,
        if_dout => start_for_Mat2AXIvideo598_U0_dout,
        if_empty_n => start_for_Mat2AXIvideo598_U0_empty_n,
        if_read => Mat2AXIvideo598_U0_ap_ready);
    ...
    start_for_Gaussiayd2_U : component start_for_Gaussiayd2
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    start_for_Duplicazec_U : component start_for_Duplicazec
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    start_for_Sobel_1Aem_U : component start_for_Sobel_1Aem
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    ap_sync_reg_AXIvideo2Mat559_U0_ap_ready_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if (((ap_sync_ready and ap_start) = ap_const_logic_1)) then 
                    ...
                    ap_sync_reg_AXIvideo2Mat559_U0_ap_ready <= ap_sync_AXIvideo2Mat559_U0_ap_ready;
                end if; 
            end if;
        end if;
    end process;
    ...
    AXIvideo2Mat559_U0_ap_ready_count_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_0 = AXIvideo2Mat559_U0_ap_ready) and (ap_sync_ready = ap_const_logic_1))) then 
                AXIvideo2Mat559_U0_ap_ready_count <= std_logic_vector(unsigned(AXIvideo2Mat559_U0_ap_ready_count) - unsigned(ap_const_lv2_1));
            elsif (((ap_sync_ready = ap_const_logic_0) and (ap_const_logic_1 = AXIvideo2Mat559_U0_ap_ready))) then 
                AXIvideo2Mat559_U0_ap_ready_count <= std_logic_vector(unsigned(AXIvideo2Mat559_U0_ap_ready_count) + unsigned(ap_const_lv2_1));
            end if; 
        end if;
    end process;
    ...
    AXIvideo2Mat559_U0_ap_start <= ((ap_sync_reg_AXIvideo2Mat559_U0_ap_ready xor ap_const_logic_1) and ap_start);
    ...
    INPUT_STREAM_TREADY <= AXIvideo2Mat_U0_INPUT_STREAM_TREADY;
    Mat2AXIvideo598_U0_ap_continue <= ap_sync_continue;
    Mat2AXIvideo598_U0_ap_start <= start_for_Mat2AXIvideo598_U0_empty_n;
    Mat2AXIvideo598_U0_start_full_n <= ap_const_logic_1;
    Mat2AXIvideo598_U0_start_write <= ap_const_logic_0;
    Mat2AXIvideo_U0_ap_continue <= ap_sync_continue;
    ...
    ap_idle <= (p_C_Xilinx_Vivado_2_U0_ap_idle and p_C_Xilinx_Vivado_2_1_U0_ap_idle and Sobel_U0_ap_idle and Sobel_1_U0_ap_idle and Mat2AXIvideo_U0_ap_idle and Mat2AXIvideo598_U0_ap_idle and GaussianBlur_U0_ap_idle and Duplicate_U0_ap_idle and CvtColor_U0_ap_idle and CvtColor_1_U0_ap_idle and AddWeighted_U0_ap_idle and AXIvideo2Mat_U0_ap_idle and AXIvideo2Mat559_U0_ap_idle);
    ap_ready <= ap_sync_ready;
    ap_sync_AXIvideo2Mat559_U0_ap_ready <= (ap_sync_reg_AXIvideo2Mat559_U0_ap_ready or AXIvideo2Mat559_U0_ap_ready);
    ap_sync_AXIvideo2Mat_U0_ap_ready <= (ap_sync_reg_AXIvideo2Mat_U0_ap_ready or AXIvideo2Mat_U0_ap_ready);
    ap_sync_continue <= (ap_sync_done and ap_continue);
    ap_sync_done <= (Mat2AXIvideo_U0_ap_done and Mat2AXIvideo598_U0_ap_done);
    ap_sync_ready <= (ap_sync_AXIvideo2Mat_U0_ap_ready and ap_sync_AXIvideo2Mat559_U0_ap_ready);
    p_C_Xilinx_Vivado_2_1_U0_ap_continue <= ap_const_logic_1;
    p_C_Xilinx_Vivado_2_1_U0_ap_start <= ap_start;
    p_C_Xilinx_Vivado_2_U0_ap_continue <= ap_const_logic_1;
    p_C_Xilinx_Vivado_2_U0_ap_start <= ap_start;
    ...
    start_for_Sobel_U0_read <= Sobel_U0_ap_ready;
end behav;
