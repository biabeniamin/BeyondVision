...
# FIFO definition:
set ID 116
set FifoName start_for_Duplicaudo
set InstName start_for_Duplicaudo_U
set CoreName ap_simcore_fifo
set NumOfStage 2
set RegisteredInput 0
set DualClock 0
...
# FIFO definition:
set ID 117
set FifoName start_for_Gaussiavdy
set InstName start_for_Gaussiavdy_U
set CoreName ap_simcore_fifo
set NumOfStage 2
set RegisteredInput 0
set DualClock 0
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_enable \
    op interface \
    ports { enable_dout { I 8 vector } enable_empty_n { I 1 bit } enable_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_img_0_rows_V \
    op interface \
    ports { img_0_rows_V_dout { I 11 vector } img_0_rows_V_empty_n { I 1 bit } img_0_rows_V_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_img_0_cols_V \
    op interface \
    ports { img_0_cols_V_dout { I 12 vector } img_0_cols_V_empty_n { I 1 bit } img_0_cols_V_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_img_6_rows_V \
    op interface \
    ports { img_6_rows_V_dout { I 11 vector } img_6_rows_V_empty_n { I 1 bit } img_6_rows_V_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_img_6_cols_V \
    op interface \
    ports { img_6_cols_V_dout { I 12 vector } img_6_cols_V_empty_n { I 1 bit } img_6_cols_V_read { O 1 bit } } \
} "
}
