...
set C_modelArgList {
	{ p_src_data_stream_0_V int 8 regular {pointer 0 volatile }  }
	{ p_src_data_stream_1_V int 8 regular {pointer 0 volatile }  }
	{ p_src_data_stream_2_V int 8 regular {pointer 0 volatile }  }
	{ p_dst_data_stream_V int 8 regular {fifo 1 volatile }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "p_src_data_stream_0_V", "interface" : "wire", "bitwidth" : 8, "direction" : "READONLY"} , 
 	{ "Name" : "p_src_data_stream_1_V", "interface" : "wire", "bitwidth" : 8, "direction" : "READONLY"} , 
 	{ "Name" : "p_src_data_stream_2_V", "interface" : "wire", "bitwidth" : 8, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ p_src_data_stream_0_V sc_in sc_lv 8 signal 0 } 
	{ p_src_data_stream_1_V sc_in sc_lv 8 signal 1 } 
	{ p_src_data_stream_2_V sc_in sc_lv 8 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "p_src_data_stream_0_V", "direction": "in", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "p_src_data_stream_0_V", "role": "default" }} , 
 	{ "name": "p_src_data_stream_1_V", "direction": "in", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "p_src_data_stream_1_V", "role": "default" }} , 
 	{ "name": "p_src_data_stream_2_V", "direction": "in", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "p_src_data_stream_2_V", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.Sobel_filter_mul_bkb_U29", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.Sobel_filter_mac_cud_U30", "Parent" : "0"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.Sobel_filter_mac_dEe_U31", "Parent" : "0"}]}
...
set Spec2ImplPortList { 
	p_src_data_stream_0_V { ap_none {  { p_src_data_stream_0_V in_data 0 8 } } }
	p_src_data_stream_1_V { ap_none {  { p_src_data_stream_1_V in_data 0 8 } } }
	p_src_data_stream_2_V { ap_none {  { p_src_data_stream_2_V in_data 0 8 } } }
