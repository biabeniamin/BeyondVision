...
architecture behav of Block_proc304 is 
    ...
    signal p_C_Xilinx_Vivado_2_1_U0_img_0a_rows_V3_out_din : STD_LOGIC_VECTOR (10 downto 0);
    signal p_C_Xilinx_Vivado_2_1_U0_img_0a_rows_V3_out_write : STD_LOGIC;
    ...
    signal p_C_Xilinx_Vivado_2_U0_img_0a_cols_V4_out_din : STD_LOGIC_VECTOR (11 downto 0);
    signal p_C_Xilinx_Vivado_2_U0_img_0a_cols_V4_out_write : STD_LOGIC;
    ...
    signal Mat2AXIvideo554_U0_ap_start : STD_LOGIC;
    signal Mat2AXIvideo554_U0_ap_done : STD_LOGIC;
    signal Mat2AXIvideo554_U0_ap_continue : STD_LOGIC;
    signal Mat2AXIvideo554_U0_ap_idle : STD_LOGIC;
    signal Mat2AXIvideo554_U0_ap_ready : STD_LOGIC;
    signal Mat2AXIvideo554_U0_img_rows_V_read : STD_LOGIC;
    signal Mat2AXIvideo554_U0_img_cols_V_read : STD_LOGIC;
    signal Mat2AXIvideo554_U0_img_data_stream_0_V_read : STD_LOGIC;
    signal Mat2AXIvideo554_U0_img_data_stream_1_V_read : STD_LOGIC;
    signal Mat2AXIvideo554_U0_img_data_stream_2_V_read : STD_LOGIC;
    signal Mat2AXIvideo554_U0_OUTPUT_STREAM_TDATA : STD_LOGIC_VECTOR (23 downto 0);
    signal Mat2AXIvideo554_U0_OUTPUT_STREAM_TVALID : STD_LOGIC;
    signal Mat2AXIvideo554_U0_OUTPUT_STREAM_TKEEP : STD_LOGIC_VECTOR (2 downto 0);
    signal Mat2AXIvideo554_U0_OUTPUT_STREAM_TSTRB : STD_LOGIC_VECTOR (2 downto 0);
    signal Mat2AXIvideo554_U0_OUTPUT_STREAM_TUSER : STD_LOGIC_VECTOR (0 downto 0);
    signal Mat2AXIvideo554_U0_OUTPUT_STREAM_TLAST : STD_LOGIC_VECTOR (0 downto 0);
    signal Mat2AXIvideo554_U0_OUTPUT_STREAM_TID : STD_LOGIC_VECTOR (0 downto 0);
    signal Mat2AXIvideo554_U0_OUTPUT_STREAM_TDEST : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal CvtColor_U0_ap_start : STD_LOGIC := '0';
    ...
    signal img_0a_rows_V3_c_full_n : STD_LOGIC;
    signal img_0a_rows_V3_c_dout : STD_LOGIC_VECTOR (10 downto 0);
    signal img_0a_rows_V3_c_empty_n : STD_LOGIC;
    signal img_0a_cols_V4_c_full_n : STD_LOGIC;
    signal img_0a_cols_V4_c_dout : STD_LOGIC_VECTOR (11 downto 0);
    signal img_0a_cols_V4_c_empty_n : STD_LOGIC;
    ...
    signal img_0a_rows_V3_c1_full_n : STD_LOGIC;
    signal img_0a_rows_V3_c1_dout : STD_LOGIC_VECTOR (10 downto 0);
    signal img_0a_rows_V3_c1_empty_n : STD_LOGIC;
    signal img_0a_cols_V4_c2_full_n : STD_LOGIC;
    signal img_0a_cols_V4_c2_dout : STD_LOGIC_VECTOR (11 downto 0);
    signal img_0a_cols_V4_c2_empty_n : STD_LOGIC;
    ...
    signal p_C_Xilinx_Vivado_2_1_U0_start_full_n : STD_LOGIC;
    signal p_C_Xilinx_Vivado_2_1_U0_start_write : STD_LOGIC;
    signal p_C_Xilinx_Vivado_2_U0_start_full_n : STD_LOGIC;
    signal p_C_Xilinx_Vivado_2_U0_start_write : STD_LOGIC;
    signal start_for_Mat2AXIvideo554_U0_din : STD_LOGIC_VECTOR (0 downto 0);
    signal start_for_Mat2AXIvideo554_U0_full_n : STD_LOGIC;
    signal start_for_Mat2AXIvideo554_U0_dout : STD_LOGIC_VECTOR (0 downto 0);
    signal start_for_Mat2AXIvideo554_U0_empty_n : STD_LOGIC;
    signal Mat2AXIvideo554_U0_start_full_n : STD_LOGIC;
    signal Mat2AXIvideo554_U0_start_write : STD_LOGIC;
    ...
    port (
        ...
        ap_idle : OUT STD_LOGIC;
        ap_ready : OUT STD_LOGIC;
        img_0a_rows_V3_out_din : OUT STD_LOGIC_VECTOR (10 downto 0);
        img_0a_rows_V3_out_full_n : IN STD_LOGIC;
        img_0a_rows_V3_out_write : OUT STD_LOGIC );
    end component;
    ...
    port (
        ...
        ap_idle : OUT STD_LOGIC;
        ap_ready : OUT STD_LOGIC;
        img_0a_cols_V4_out_din : OUT STD_LOGIC_VECTOR (11 downto 0);
        img_0a_cols_V4_out_full_n : IN STD_LOGIC;
        img_0a_cols_V4_out_write : OUT STD_LOGIC );
    end component;
...
begin
    ...
    port map (
        ...
        img_0a_rows_V3_out_din => p_C_Xilinx_Vivado_2_1_U0_img_0a_rows_V3_out_din,
        img_0a_rows_V3_out_full_n => img_0a_rows_V3_c_full_n,
        img_0a_rows_V3_out_write => p_C_Xilinx_Vivado_2_1_U0_img_0a_rows_V3_out_write);
    ...
    port map (
        ...
        img_0a_cols_V4_out_din => p_C_Xilinx_Vivado_2_U0_img_0a_cols_V4_out_din,
        img_0a_cols_V4_out_full_n => img_0a_cols_V4_c_full_n,
        img_0a_cols_V4_out_write => p_C_Xilinx_Vivado_2_U0_img_0a_cols_V4_out_write);
    ...
    port map (
        ...
        start_full_n => start_for_Mat2AXIvideo554_U0_full_n,
        ...
        img_rows_V_dout => img_0a_rows_V3_c_dout,
        img_rows_V_empty_n => img_0a_rows_V3_c_empty_n,
        img_rows_V_read => AXIvideo2Mat_U0_img_rows_V_read,
        img_cols_V_dout => img_0a_cols_V4_c_dout,
        img_cols_V_empty_n => img_0a_cols_V4_c_empty_n,
        ...
        img_rows_V_out_full_n => img_0a_rows_V3_c1_full_n,
        img_rows_V_out_write => AXIvideo2Mat_U0_img_rows_V_out_write,
        img_cols_V_out_din => AXIvideo2Mat_U0_img_cols_V_out_din,
        img_cols_V_out_full_n => img_0a_cols_V4_c2_full_n,
        img_cols_V_out_write => AXIvideo2Mat_U0_img_cols_V_out_write);

    Mat2AXIvideo554_U0 : component Mat2AXIvideo554
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
        ap_start => Mat2AXIvideo554_U0_ap_start,
        ap_done => Mat2AXIvideo554_U0_ap_done,
        ap_continue => Mat2AXIvideo554_U0_ap_continue,
        ap_idle => Mat2AXIvideo554_U0_ap_idle,
        ap_ready => Mat2AXIvideo554_U0_ap_ready,
        img_rows_V_dout => img_0a_rows_V3_c1_dout,
        img_rows_V_empty_n => img_0a_rows_V3_c1_empty_n,
        img_rows_V_read => Mat2AXIvideo554_U0_img_rows_V_read,
        img_cols_V_dout => img_0a_cols_V4_c2_dout,
        img_cols_V_empty_n => img_0a_cols_V4_c2_empty_n,
        img_cols_V_read => Mat2AXIvideo554_U0_img_cols_V_read,
        img_data_stream_0_V_dout => img_0a_data_stream_0_dout,
        img_data_stream_0_V_empty_n => img_0a_data_stream_0_empty_n,
        img_data_stream_0_V_read => Mat2AXIvideo554_U0_img_data_stream_0_V_read,
        img_data_stream_1_V_dout => img_0a_data_stream_1_dout,
        img_data_stream_1_V_empty_n => img_0a_data_stream_1_empty_n,
        img_data_stream_1_V_read => Mat2AXIvideo554_U0_img_data_stream_1_V_read,
        img_data_stream_2_V_dout => img_0a_data_stream_2_dout,
        img_data_stream_2_V_empty_n => img_0a_data_stream_2_empty_n,
        img_data_stream_2_V_read => Mat2AXIvideo554_U0_img_data_stream_2_V_read,
        OUTPUT_STREAM_TDATA => Mat2AXIvideo554_U0_OUTPUT_STREAM_TDATA,
        OUTPUT_STREAM_TVALID => Mat2AXIvideo554_U0_OUTPUT_STREAM_TVALID,
        OUTPUT_STREAM_TREADY => OUTPUT_STREAM_TREADY,
        OUTPUT_STREAM_TKEEP => Mat2AXIvideo554_U0_OUTPUT_STREAM_TKEEP,
        OUTPUT_STREAM_TSTRB => Mat2AXIvideo554_U0_OUTPUT_STREAM_TSTRB,
        OUTPUT_STREAM_TUSER => Mat2AXIvideo554_U0_OUTPUT_STREAM_TUSER,
        OUTPUT_STREAM_TLAST => Mat2AXIvideo554_U0_OUTPUT_STREAM_TLAST,
        OUTPUT_STREAM_TID => Mat2AXIvideo554_U0_OUTPUT_STREAM_TID,
        OUTPUT_STREAM_TDEST => Mat2AXIvideo554_U0_OUTPUT_STREAM_TDEST);
    ...
    port map (
        ...
        p_src_data_stream_0_V => ap_const_lv8_0,
        p_src_data_stream_1_V => ap_const_lv8_0,
        p_src_data_stream_2_V => ap_const_lv8_0,
    ...
    img_0a_rows_V3_c_U : component fifo_w11_d2_A
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
        if_write_ce => ap_const_logic_1,
        if_din => p_C_Xilinx_Vivado_2_1_U0_img_0a_rows_V3_out_din,
        if_full_n => img_0a_rows_V3_c_full_n,
        if_write => p_C_Xilinx_Vivado_2_1_U0_img_0a_rows_V3_out_write,
        if_dout => img_0a_rows_V3_c_dout,
        if_empty_n => img_0a_rows_V3_c_empty_n,
        if_read => AXIvideo2Mat_U0_img_rows_V_read);

    img_0a_cols_V4_c_U : component fifo_w12_d2_A
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
        if_write_ce => ap_const_logic_1,
        if_din => p_C_Xilinx_Vivado_2_U0_img_0a_cols_V4_out_din,
        if_full_n => img_0a_cols_V4_c_full_n,
        if_write => p_C_Xilinx_Vivado_2_U0_img_0a_cols_V4_out_write,
        if_dout => img_0a_cols_V4_c_dout,
        if_empty_n => img_0a_cols_V4_c_empty_n,
    ...
    port map (
        ...
        if_read => Mat2AXIvideo554_U0_img_data_stream_0_V_read);
    ...
    port map (
        ...
        if_read => Mat2AXIvideo554_U0_img_data_stream_1_V_read);
    ...
    port map (
        ...
        if_read => Mat2AXIvideo554_U0_img_data_stream_2_V_read);

    img_0a_rows_V3_c1_U : component fifo_w11_d2_A
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
        ...
        if_full_n => img_0a_rows_V3_c1_full_n,
        if_write => AXIvideo2Mat_U0_img_rows_V_out_write,
        if_dout => img_0a_rows_V3_c1_dout,
        if_empty_n => img_0a_rows_V3_c1_empty_n,
        if_read => Mat2AXIvideo554_U0_img_rows_V_read);

    img_0a_cols_V4_c2_U : component fifo_w12_d2_A
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
        ...
        if_full_n => img_0a_cols_V4_c2_full_n,
        if_write => AXIvideo2Mat_U0_img_cols_V_out_write,
        if_dout => img_0a_cols_V4_c2_dout,
        if_empty_n => img_0a_cols_V4_c2_empty_n,
        if_read => Mat2AXIvideo554_U0_img_cols_V_read);
    ...
    port map (
        ...
        if_read_ce => ap_const_logic_1,
        if_write_ce => ap_const_logic_1,
        if_din => start_for_Mat2AXIvideo554_U0_din,
        if_full_n => start_for_Mat2AXIvideo554_U0_full_n,
        if_write => AXIvideo2Mat_U0_start_write,
        if_dout => start_for_Mat2AXIvideo554_U0_dout,
        if_empty_n => start_for_Mat2AXIvideo554_U0_empty_n,
        if_read => Mat2AXIvideo554_U0_ap_ready);
    ...
    CvtColor_U0_ap_start_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
    ...
    INPUT_STREAM_TREADY <= AXIvideo2Mat_U0_INPUT_STREAM_TREADY;
    Mat2AXIvideo554_U0_ap_continue <= ap_sync_continue;
    Mat2AXIvideo554_U0_ap_start <= start_for_Mat2AXIvideo554_U0_empty_n;
    ...
    ap_idle <= (p_C_Xilinx_Vivado_2_U0_ap_idle and p_C_Xilinx_Vivado_2_1_U0_ap_idle and Sobel_U0_ap_idle and Sobel_1_U0_ap_idle and Mat2AXIvideo_U0_ap_idle and Mat2AXIvideo554_U0_ap_idle and GaussianBlur_U0_ap_idle and Duplicate_U0_ap_idle and CvtColor_U0_ap_idle and CvtColor_1_U0_ap_idle and AddWeighted_U0_ap_idle and AXIvideo2Mat_U0_ap_idle);
    ap_ready <= AXIvideo2Mat_U0_ap_ready;
    ap_sync_continue <= (ap_sync_done and ap_continue);
    ap_sync_done <= (Mat2AXIvideo_U0_ap_done and Mat2AXIvideo554_U0_ap_done);
    ...
    start_for_Mat2AXIvideo554_U0_din <= (0=>ap_const_logic_1, others=>'-');
end behav;
