...
entity Block_proc304305 is
port (
    enable_V_dout : IN STD_LOGIC_VECTOR (0 downto 0);
    enable_V_empty_n : IN STD_LOGIC;
    enable_V_read : OUT STD_LOGIC;
...
architecture behav of Block_proc304305 is 
    ...
    signal Mat2AXIvideo_U0_start_out : STD_LOGIC;
    ...
    signal Mat2AXIvideo_U1_1_ap_start : STD_LOGIC;
    signal Mat2AXIvideo_U1_1_ap_done : STD_LOGIC;
    signal Mat2AXIvideo_U1_1_ap_continue : STD_LOGIC;
    signal Mat2AXIvideo_U1_1_ap_idle : STD_LOGIC;
    signal Mat2AXIvideo_U1_1_ap_ready : STD_LOGIC;
    signal Mat2AXIvideo_U1_1_start_out : STD_LOGIC;
    signal Mat2AXIvideo_U1_1_start_write : STD_LOGIC;
    signal Mat2AXIvideo_U1_1_img_rows_V_read : STD_LOGIC;
    signal Mat2AXIvideo_U1_1_img_cols_V_read : STD_LOGIC;
    signal Mat2AXIvideo_U1_1_img_data_stream_0_V_read : STD_LOGIC;
    signal Mat2AXIvideo_U1_1_img_data_stream_1_V_read : STD_LOGIC;
    signal Mat2AXIvideo_U1_1_img_data_stream_2_V_read : STD_LOGIC;
    signal Mat2AXIvideo_U1_1_OUTPUT_STREAM_TDATA : STD_LOGIC_VECTOR (23 downto 0);
    signal Mat2AXIvideo_U1_1_OUTPUT_STREAM_TVALID : STD_LOGIC;
    signal Mat2AXIvideo_U1_1_OUTPUT_STREAM_TKEEP : STD_LOGIC_VECTOR (2 downto 0);
    signal Mat2AXIvideo_U1_1_OUTPUT_STREAM_TSTRB : STD_LOGIC_VECTOR (2 downto 0);
    signal Mat2AXIvideo_U1_1_OUTPUT_STREAM_TUSER : STD_LOGIC_VECTOR (0 downto 0);
    signal Mat2AXIvideo_U1_1_OUTPUT_STREAM_TLAST : STD_LOGIC_VECTOR (0 downto 0);
    signal Mat2AXIvideo_U1_1_OUTPUT_STREAM_TID : STD_LOGIC_VECTOR (0 downto 0);
    signal Mat2AXIvideo_U1_1_OUTPUT_STREAM_TDEST : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal ap_sync_reg_CvtColor_1_U0_ap_ready : STD_LOGIC := '0';
    signal ap_sync_CvtColor_1_U0_ap_ready : STD_LOGIC;
    signal CvtColor_1_U0_ap_ready_count : STD_LOGIC_VECTOR (1 downto 0) := "00";
    signal ap_sync_reg_Mat2AXIvideo_U1_1_ap_ready : STD_LOGIC := '0';
    signal ap_sync_Mat2AXIvideo_U1_1_ap_ready : STD_LOGIC;
    signal Mat2AXIvideo_U1_1_ap_ready_count : STD_LOGIC_VECTOR (1 downto 0) := "00";
...
begin
    ...
    port map (
        ...
        start_full_n => Mat2AXIvideo_U0_start_full_n,
    ...
    Mat2AXIvideo_U1_1 : component Mat2AXIvideo
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    port map (
        ...
        if_read => Mat2AXIvideo_U1_1_img_data_stream_0_V_read);
    ...
    port map (
        ...
        if_read => Mat2AXIvideo_U1_1_img_data_stream_1_V_read);
    ...
    port map (
        ...
        if_read => Mat2AXIvideo_U1_1_img_data_stream_2_V_read);
    ...
    port map (
        ...
        if_write => Mat2AXIvideo_U0_start_write,
        if_dout => start_for_Mat2AXIvideo_U0_dout,
        if_empty_n => start_for_Mat2AXIvideo_U0_empty_n,
        if_read => ap_const_logic_0);
    ...
    ap_sync_reg_CvtColor_1_U0_ap_ready_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
    ...
    ap_sync_reg_Mat2AXIvideo_U1_1_ap_ready_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
    ...
    CvtColor_1_U0_ap_ready_count_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_sync_ready = ap_const_logic_1) and (ap_const_logic_0 = CvtColor_1_U0_ap_ready))) then 
                CvtColor_1_U0_ap_ready_count <= std_logic_vector(unsigned(CvtColor_1_U0_ap_ready_count) - unsigned(ap_const_lv2_1));
            elsif (((ap_const_logic_1 = CvtColor_1_U0_ap_ready) and (ap_sync_ready = ap_const_logic_0))) then 
                CvtColor_1_U0_ap_ready_count <= std_logic_vector(unsigned(CvtColor_1_U0_ap_ready_count) + unsigned(ap_const_lv2_1));
            end if; 
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_sync_ready = ap_const_logic_1) and (ap_const_logic_0 = Mat2AXIvideo_U0_ap_ready))) then 
                Mat2AXIvideo_U0_ap_ready_count <= std_logic_vector(unsigned(Mat2AXIvideo_U0_ap_ready_count) - unsigned(ap_const_lv2_1));
            elsif (((ap_const_logic_1 = Mat2AXIvideo_U0_ap_ready) and (ap_sync_ready = ap_const_logic_0))) then 
                Mat2AXIvideo_U0_ap_ready_count <= std_logic_vector(unsigned(Mat2AXIvideo_U0_ap_ready_count) + unsigned(ap_const_lv2_1));
            end if; 
        end if;
    end process;

    Mat2AXIvideo_U1_1_ap_ready_count_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_sync_ready = ap_const_logic_1) and (ap_const_logic_0 = Mat2AXIvideo_U1_1_ap_ready))) then 
                Mat2AXIvideo_U1_1_ap_ready_count <= std_logic_vector(unsigned(Mat2AXIvideo_U1_1_ap_ready_count) - unsigned(ap_const_lv2_1));
            elsif (((ap_const_logic_1 = Mat2AXIvideo_U1_1_ap_ready) and (ap_sync_ready = ap_const_logic_0))) then 
                Mat2AXIvideo_U1_1_ap_ready_count <= std_logic_vector(unsigned(Mat2AXIvideo_U1_1_ap_ready_count) + unsigned(ap_const_lv2_1));
            end if; 
        end if;
    end process;
    ...
    CvtColor_1_U0_ap_start <= ((ap_sync_reg_CvtColor_1_U0_ap_ready xor ap_const_logic_1) and ap_start);
    ...
    Mat2AXIvideo_U0_ap_start <= ((ap_sync_reg_Mat2AXIvideo_U0_ap_ready xor ap_const_logic_1) and ap_start);
    Mat2AXIvideo_U0_start_full_n <= (start_for_Mat2AXIvideo_U0_full_n and start_for_Duplicate_U0_full_n);
    Mat2AXIvideo_U1_1_ap_continue <= ap_sync_continue;
    Mat2AXIvideo_U1_1_ap_start <= ((ap_sync_reg_Mat2AXIvideo_U1_1_ap_ready xor ap_const_logic_1) and ap_start);
    OUTPUT_STREAM_TDATA <= Mat2AXIvideo_U1_1_OUTPUT_STREAM_TDATA;
    OUTPUT_STREAM_TDEST <= Mat2AXIvideo_U1_1_OUTPUT_STREAM_TDEST;
    OUTPUT_STREAM_TID <= Mat2AXIvideo_U1_1_OUTPUT_STREAM_TID;
    OUTPUT_STREAM_TKEEP <= Mat2AXIvideo_U1_1_OUTPUT_STREAM_TKEEP;
    ...
    ap_idle <= (Sobel_U0_ap_idle and Sobel_1_U0_ap_idle and Mat2AXIvideo_U1_1_ap_idle and Mat2AXIvideo_U0_ap_idle and GaussianBlur_U0_ap_idle and Duplicate_U0_ap_idle and CvtColor_U0_ap_idle and CvtColor_1_U0_ap_idle and AddWeighted_U0_ap_idle);
    ap_ready <= ap_sync_ready;
    ap_sync_CvtColor_1_U0_ap_ready <= (ap_sync_reg_CvtColor_1_U0_ap_ready or CvtColor_1_U0_ap_ready);
    ap_sync_Mat2AXIvideo_U0_ap_ready <= (ap_sync_reg_Mat2AXIvideo_U0_ap_ready or Mat2AXIvideo_U0_ap_ready);
    ap_sync_Mat2AXIvideo_U1_1_ap_ready <= (ap_sync_reg_Mat2AXIvideo_U1_1_ap_ready or Mat2AXIvideo_U1_1_ap_ready);
    ap_sync_continue <= (ap_sync_done and ap_continue);
    ap_sync_done <= (Mat2AXIvideo_U1_1_ap_done and Mat2AXIvideo_U0_ap_done);
    ap_sync_ready <= (ap_sync_Mat2AXIvideo_U1_1_ap_ready and ap_sync_Mat2AXIvideo_U0_ap_ready and ap_sync_CvtColor_1_U0_ap_ready);
    enable_V_read <= ap_const_logic_0;
    img_0_cols_V_read <= CvtColor_1_U0_p_src_cols_V_read;
    img_0_data_stream_0_V_read <= CvtColor_1_U0_p_src_data_stream_0_V_read;
    img_0_data_stream_1_V_read <= CvtColor_1_U0_p_src_data_stream_1_V_read;
    img_0_data_stream_2_V_read <= CvtColor_1_U0_p_src_data_stream_2_V_read;
    img_0_rows_V_read <= CvtColor_1_U0_p_src_rows_V_read;
    img_6_cols_V_read <= Mat2AXIvideo_U1_1_img_cols_V_read;
    img_6_rows_V_read <= Mat2AXIvideo_U1_1_img_rows_V_read;
