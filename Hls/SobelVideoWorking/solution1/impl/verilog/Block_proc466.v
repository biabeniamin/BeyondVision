...
output  [7:0] enable_out_din;
input   enable_out_full_n;
output   enable_out_write;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if ((~((real_start == 1'b0) | (enable_out_full_n == 1'b0) | (img_6_cols_V_out_full_n == 1'b0) | (img_6_rows_V_out_full_n == 1'b0) | (img_0_cols_V_out_full_n == 1'b0) | (img_0_rows_V_out_full_n == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (*) begin
    if ((~((real_start == 1'b0) | (enable_out_full_n == 1'b0) | (img_6_cols_V_out_full_n == 1'b0) | (img_6_rows_V_out_full_n == 1'b0) | (img_0_cols_V_out_full_n == 1'b0) | (img_0_rows_V_out_full_n == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state1)) begin
        ...
        enable_out_blk_n = 1'b1;
    end
end

always @ (*) begin
    if ((~((real_start == 1'b0) | (enable_out_full_n == 1'b0) | (img_6_cols_V_out_full_n == 1'b0) | (img_6_rows_V_out_full_n == 1'b0) | (img_0_cols_V_out_full_n == 1'b0) | (img_0_rows_V_out_full_n == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
        enable_out_write = 1'b1;
    end else begin
        enable_out_write = 1'b0;
    end
end
...
always @ (*) begin
    ap_block_state1 = ((real_start == 1'b0) | (enable_out_full_n == 1'b0) | (img_6_cols_V_out_full_n == 1'b0) | (img_6_rows_V_out_full_n == 1'b0) | (img_0_cols_V_out_full_n == 1'b0) | (img_0_rows_V_out_full_n == 1'b0) | (ap_done_reg == 1'b1));
end

assign ap_ready = internal_ap_ready;

assign enable_out_din = enable;
