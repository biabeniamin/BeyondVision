...
reg   [0:0] exitcond_i_reg_472;
reg   [0:0] brmerge_i_reg_481;
wire    ap_CS_fsm_pp2_stage0;
reg    ap_enable_reg_pp2_iter1;
wire    ap_block_pp2_stage0;
reg   [0:0] eol_2_i_reg_324;
...
reg   [10:0] t_V_6_reg_254;
reg   [0:0] eol_i_reg_265;
reg   [0:0] eol_reg_277;
reg   [23:0] axi_data_V_1_i_reg_288;
reg   [0:0] axi_last_V_3_i_reg_335;
reg   [23:0] axi_data_V_3_i_reg_347;
reg   [23:0] tmp_data_V_reg_443;
reg   [0:0] tmp_last_V_reg_451;
wire   [0:0] exitcond4_i_fu_378_p2;
wire    ap_CS_fsm_state4;
wire   [9:0] i_V_fu_384_p2;
reg   [9:0] i_V_reg_467;
...
reg   [0:0] ap_phi_mux_eol_2_i_phi_fu_327_p4;
reg   [0:0] axi_last_V1_i_reg_223;
wire    ap_CS_fsm_state10;
wire    ap_CS_fsm_state3;
reg   [23:0] axi_data_V1_i_reg_233;
reg   [9:0] t_V_reg_243;
reg   [0:0] ap_phi_mux_eol_i_phi_fu_269_p4;
reg   [0:0] ap_phi_mux_axi_last_V_2_i_phi_fu_304_p4;
reg   [23:0] ap_phi_mux_p_Val2_s_phi_fu_316_p4;
wire   [0:0] ap_phi_reg_pp1_iter1_axi_last_V_2_i_reg_299;
wire   [23:0] ap_phi_reg_pp1_iter1_p_Val2_s_reg_312;
reg    ap_block_state1;
reg    ap_block_pp1_stage0_01001;
reg   [0:0] sof_1_i_fu_164;
wire   [0:0] tmp_user_V_fu_369_p1;
reg   [7:0] ap_NS_fsm;
reg    ap_idle_pp1;
wire    ap_enable_pp1;
reg    ap_idle_pp2;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if (((exitcond4_i_fu_378_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state4))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((exitcond_i_fu_390_p2 == 1'd1) & (1'b0 == ap_block_pp1_stage0_subdone) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
            ap_enable_reg_pp1_iter0 <= 1'b0;
        end else if (((exitcond4_i_fu_378_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state4))) begin
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((ap_phi_mux_eol_2_i_phi_fu_327_p4 == 1'd1) & (1'b0 == ap_block_pp2_stage0_subdone) & (1'b1 == ap_CS_fsm_pp2_stage0))) begin
            ap_enable_reg_pp2_iter0 <= 1'b0;
...
always @ (posedge ap_clk) begin
    if (((exitcond_i_reg_472 == 1'd0) & (1'b0 == ap_block_pp1_stage0_11001) & (ap_enable_reg_pp1_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
...
always @ (posedge ap_clk) begin
    ...
    end else if (((eol_2_i_reg_324 == 1'd0) & (1'b0 == ap_block_pp2_stage0_11001) & (ap_enable_reg_pp2_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp2_stage0))) begin
...
always @ (*) begin
    if ((((eol_2_i_reg_324 == 1'd0) & (1'b0 == ap_block_pp2_stage0_11001) & (ap_enable_reg_pp2_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp2_stage0)) | ((1'b0 == ap_block_pp1_stage0_11001) & (ap_enable_reg_pp1_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0) & (ap_predicate_op67_read_state6 == 1'b1)) | ((1'b1 == AXI_video_strm_V_data_V_0_vld_out) & (1'b1 == ap_CS_fsm_state2)))) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state2) | ((eol_2_i_reg_324 == 1'd0) & (1'b0 == ap_block_pp2_stage0) & (ap_enable_reg_pp2_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp2_stage0)) | ((brmerge_i_reg_481 == 1'd0) & (exitcond_i_reg_472 == 1'd0) & (1'b0 == ap_block_pp1_stage0) & (ap_enable_reg_pp1_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0)))) begin
...
always @ (*) begin
    if (((exitcond4_i_fu_378_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state4))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
always @ (*) begin
    if ((1'b1 == ap_condition_515)) begin
        if ((brmerge_i_reg_481 == 1'd1)) begin
            ap_phi_mux_axi_last_V_2_i_phi_fu_304_p4 = eol_reg_277;
        end else if ((brmerge_i_reg_481 == 1'd0)) begin
...
always @ (*) begin
    if (((eol_2_i_reg_324 == 1'd0) & (1'b0 == ap_block_pp2_stage0) & (ap_enable_reg_pp2_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp2_stage0))) begin
...
always @ (*) begin
    if (((exitcond_i_reg_472 == 1'd0) & (1'b0 == ap_block_pp1_stage0) & (ap_enable_reg_pp1_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
...
always @ (*) begin
    if ((~((img_cols_V_out_full_n == 1'b0) | (img_rows_V_out_full_n == 1'b0) | (real_start == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state2 : begin
            if (((tmp_user_V_fu_369_p1 == 1'd0) & (1'b1 == AXI_video_strm_V_data_V_0_vld_out) & (1'b1 == ap_CS_fsm_state2))) begin
                ap_NS_fsm = ap_ST_fsm_state2;
            end else if (((tmp_user_V_fu_369_p1 == 1'd1) & (1'b1 == AXI_video_strm_V_data_V_0_vld_out) & (1'b1 == ap_CS_fsm_state2))) begin
...
always @ (*) begin
    ap_block_pp1_stage0_01001 = ((ap_enable_reg_pp1_iter1 == 1'b1) & (((1'b0 == AXI_video_strm_V_data_V_0_vld_out) & (ap_predicate_op67_read_state6 == 1'b1)) | ((exitcond_i_reg_472 == 1'd0) & (img_data_stream_2_V_full_n == 1'b0)) | ((exitcond_i_reg_472 == 1'd0) & (img_data_stream_1_V_full_n == 1'b0)) | ((exitcond_i_reg_472 == 1'd0) & (img_data_stream_0_V_full_n == 1'b0))));
end

always @ (*) begin
    ap_block_pp1_stage0_11001 = ((ap_enable_reg_pp1_iter1 == 1'b1) & (((1'b0 == AXI_video_strm_V_data_V_0_vld_out) & (ap_predicate_op67_read_state6 == 1'b1)) | ((exitcond_i_reg_472 == 1'd0) & (img_data_stream_2_V_full_n == 1'b0)) | ((exitcond_i_reg_472 == 1'd0) & (img_data_stream_1_V_full_n == 1'b0)) | ((exitcond_i_reg_472 == 1'd0) & (img_data_stream_0_V_full_n == 1'b0))));
end

always @ (*) begin
    ap_block_pp1_stage0_subdone = ((ap_enable_reg_pp1_iter1 == 1'b1) & (((1'b0 == AXI_video_strm_V_data_V_0_vld_out) & (ap_predicate_op67_read_state6 == 1'b1)) | ((exitcond_i_reg_472 == 1'd0) & (img_data_stream_2_V_full_n == 1'b0)) | ((exitcond_i_reg_472 == 1'd0) & (img_data_stream_1_V_full_n == 1'b0)) | ((exitcond_i_reg_472 == 1'd0) & (img_data_stream_0_V_full_n == 1'b0))));
end

assign ap_block_pp2_stage0 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_pp2_stage0_11001 = ((eol_2_i_reg_324 == 1'd0) & (1'b0 == AXI_video_strm_V_data_V_0_vld_out) & (ap_enable_reg_pp2_iter1 == 1'b1));
end

always @ (*) begin
    ap_block_pp2_stage0_subdone = ((eol_2_i_reg_324 == 1'd0) & (1'b0 == AXI_video_strm_V_data_V_0_vld_out) & (ap_enable_reg_pp2_iter1 == 1'b1));
end

always @ (*) begin
    ap_block_state1 = ((img_cols_V_out_full_n == 1'b0) | (img_rows_V_out_full_n == 1'b0) | (real_start == 1'b0) | (ap_done_reg == 1'b1));
end

assign ap_block_state5_pp1_stage0_iter0 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_state6_pp1_stage0_iter1 = (((1'b0 == AXI_video_strm_V_data_V_0_vld_out) & (ap_predicate_op67_read_state6 == 1'b1)) | ((exitcond_i_reg_472 == 1'd0) & (img_data_stream_2_V_full_n == 1'b0)) | ((exitcond_i_reg_472 == 1'd0) & (img_data_stream_1_V_full_n == 1'b0)) | ((exitcond_i_reg_472 == 1'd0) & (img_data_stream_0_V_full_n == 1'b0)));
end

assign ap_block_state8_pp2_stage0_iter0 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_state9_pp2_stage0_iter1 = ((eol_2_i_reg_324 == 1'd0) & (1'b0 == AXI_video_strm_V_data_V_0_vld_out));
end

always @ (*) begin
    ap_condition_515 = ((exitcond_i_reg_472 == 1'd0) & (1'b0 == ap_block_pp1_stage0) & (ap_enable_reg_pp1_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0));
end
...
assign ap_phi_reg_pp1_iter1_axi_last_V_2_i_reg_299 = 'bx;

assign ap_phi_reg_pp1_iter1_p_Val2_s_reg_312 = 'bx;

always @ (*) begin
    ap_predicate_op67_read_state6 = ((brmerge_i_reg_481 == 1'd0) & (exitcond_i_reg_472 == 1'd0));
end

assign ap_ready = internal_ap_ready;

assign brmerge_i_fu_405_p2 = (sof_1_i_fu_164 | ap_phi_mux_eol_i_phi_fu_269_p4);

assign exitcond4_i_fu_378_p2 = ((t_V_reg_243 == 10'd720) ? 1'b1 : 1'b0);

assign exitcond_i_fu_390_p2 = ((t_V_6_reg_254 == 11'd1280) ? 1'b1 : 1'b0);

assign i_V_fu_384_p2 = (t_V_reg_243 + 10'd1);

assign img_cols_V_out_din = 12'd1280;

assign img_data_stream_0_V_din = ap_phi_mux_p_Val2_s_phi_fu_316_p4[7:0];

assign img_data_stream_1_V_din = {{ap_phi_mux_p_Val2_s_phi_fu_316_p4[15:8]}};

assign img_data_stream_2_V_din = {{ap_phi_mux_p_Val2_s_phi_fu_316_p4[23:16]}};

assign img_rows_V_out_din = 11'd720;

assign j_V_fu_396_p2 = (t_V_6_reg_254 + 11'd1);

assign start_out = real_start;

assign tmp_user_V_fu_369_p1 = AXI_video_strm_V_user_V_0_data_out;

endmodule //AXIvideo2Mat487
