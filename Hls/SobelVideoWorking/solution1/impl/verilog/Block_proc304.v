...
wire   [10:0] p_C_Xilinx_Vivado_2_1_U0_img_0a_rows_V3_out_din;
wire    p_C_Xilinx_Vivado_2_1_U0_img_0a_rows_V3_out_write;
...
wire   [11:0] p_C_Xilinx_Vivado_2_U0_img_0a_cols_V4_out_din;
wire    p_C_Xilinx_Vivado_2_U0_img_0a_cols_V4_out_write;
...
wire    Mat2AXIvideo554_U0_ap_start;
wire    Mat2AXIvideo554_U0_ap_done;
wire    Mat2AXIvideo554_U0_ap_continue;
wire    Mat2AXIvideo554_U0_ap_idle;
wire    Mat2AXIvideo554_U0_ap_ready;
wire    Mat2AXIvideo554_U0_img_rows_V_read;
wire    Mat2AXIvideo554_U0_img_cols_V_read;
wire    Mat2AXIvideo554_U0_img_data_stream_0_V_read;
wire    Mat2AXIvideo554_U0_img_data_stream_1_V_read;
wire    Mat2AXIvideo554_U0_img_data_stream_2_V_read;
wire   [23:0] Mat2AXIvideo554_U0_OUTPUT_STREAM_TDATA;
wire    Mat2AXIvideo554_U0_OUTPUT_STREAM_TVALID;
wire   [2:0] Mat2AXIvideo554_U0_OUTPUT_STREAM_TKEEP;
wire   [2:0] Mat2AXIvideo554_U0_OUTPUT_STREAM_TSTRB;
wire   [0:0] Mat2AXIvideo554_U0_OUTPUT_STREAM_TUSER;
wire   [0:0] Mat2AXIvideo554_U0_OUTPUT_STREAM_TLAST;
wire   [0:0] Mat2AXIvideo554_U0_OUTPUT_STREAM_TID;
wire   [0:0] Mat2AXIvideo554_U0_OUTPUT_STREAM_TDEST;
...
wire    img_0a_rows_V3_c_full_n;
wire   [10:0] img_0a_rows_V3_c_dout;
wire    img_0a_rows_V3_c_empty_n;
wire    img_0a_cols_V4_c_full_n;
wire   [11:0] img_0a_cols_V4_c_dout;
wire    img_0a_cols_V4_c_empty_n;
...
wire    img_0a_rows_V3_c1_full_n;
wire   [10:0] img_0a_rows_V3_c1_dout;
wire    img_0a_rows_V3_c1_empty_n;
wire    img_0a_cols_V4_c2_full_n;
wire   [11:0] img_0a_cols_V4_c2_dout;
wire    img_0a_cols_V4_c2_empty_n;
...
wire    ap_sync_done;
wire    ap_sync_ready;
wire    p_C_Xilinx_Vivado_2_1_U0_start_full_n;
wire    p_C_Xilinx_Vivado_2_1_U0_start_write;
wire    p_C_Xilinx_Vivado_2_U0_start_full_n;
wire    p_C_Xilinx_Vivado_2_U0_start_write;
wire   [0:0] start_for_Mat2AXIvideo554_U0_din;
wire    start_for_Mat2AXIvideo554_U0_full_n;
wire   [0:0] start_for_Mat2AXIvideo554_U0_dout;
wire    start_for_Mat2AXIvideo554_U0_empty_n;
wire    Mat2AXIvideo554_U0_start_full_n;
wire    Mat2AXIvideo554_U0_start_write;
...
Mat2AXIvideo554 Mat2AXIvideo554_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
CvtColor_1 CvtColor_1_U0(
    ...
    .p_src_data_stream_0_V(8'd0),
    .p_src_data_stream_1_V(8'd0),
    .p_src_data_stream_2_V(8'd0),
...
fifo_w11_d2_A img_0a_rows_V3_c_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
fifo_w12_d2_A img_0a_cols_V4_c_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
fifo_w11_d2_A img_0a_rows_V3_c1_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
fifo_w12_d2_A img_0a_cols_V4_c2_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        CvtColor_U0_ap_start <= 1'b0;
    end else begin
        CvtColor_U0_ap_start <= 1'b1;
    end
end
...
assign CvtColor_1_U0_ap_start = 1'b1;
...
assign Mat2AXIvideo554_U0_ap_continue = ap_sync_continue;

assign Mat2AXIvideo554_U0_ap_start = start_for_Mat2AXIvideo554_U0_empty_n;

assign Mat2AXIvideo554_U0_start_full_n = 1'b1;

assign Mat2AXIvideo554_U0_start_write = 1'b0;
...
assign ap_idle = (p_C_Xilinx_Vivado_2_U0_ap_idle & p_C_Xilinx_Vivado_2_1_U0_ap_idle & Sobel_U0_ap_idle & Sobel_1_U0_ap_idle & Mat2AXIvideo_U0_ap_idle & Mat2AXIvideo554_U0_ap_idle & GaussianBlur_U0_ap_idle & Duplicate_U0_ap_idle & CvtColor_U0_ap_idle & CvtColor_1_U0_ap_idle & AddWeighted_U0_ap_idle & AXIvideo2Mat_U0_ap_idle);

assign ap_ready = AXIvideo2Mat_U0_ap_ready;

assign ap_sync_continue = (ap_sync_done & ap_continue);

assign ap_sync_done = (Mat2AXIvideo_U0_ap_done & Mat2AXIvideo554_U0_ap_done);
...
assign p_C_Xilinx_Vivado_2_1_U0_start_full_n = 1'b1;

assign p_C_Xilinx_Vivado_2_1_U0_start_write = 1'b0;

assign p_C_Xilinx_Vivado_2_U0_ap_continue = 1'b1;

assign p_C_Xilinx_Vivado_2_U0_ap_start = ap_start;

assign p_C_Xilinx_Vivado_2_U0_start_full_n = 1'b1;

assign p_C_Xilinx_Vivado_2_U0_start_write = 1'b0;

assign start_for_Mat2AXIvideo554_U0_din = 1'b1;
