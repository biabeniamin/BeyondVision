...
architecture behav of Encode is 
    ...
    "Encode,hls_ip_2018_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020clg400-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=8.510000,HLS_SYN_LAT=-1,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=3,HLS_SYN_FF=9745,HLS_SYN_LUT=8176,HLS_VERSION=2018_2}";
    ...
    component Encode_urem_64ns_bkb IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
    ...
    component Encode_CONTROL_BUS_s_axi IS
    generic (
...
begin
    Encode_CONTROL_BUS_s_axi_U : component Encode_CONTROL_BUS_s_axi
    generic map (
    ...
    Encode_urem_64ns_bkb_U1 : component Encode_urem_64ns_bkb
    generic map (
        ID => 1,
        NUM_STAGE => 68,
        din0_WIDTH => 64,
