...
set Library     "hls"
set IPName      "StreamGenerator"
set Version     "1.0"
set DisplayName "Streamgenerator"
set Revision    "1812221601"
...
set Interfaces {
    s_axi_CONTROL_BUS {
        ...
        registers {{0x00 CTRL       RW   0x0 "Control signals" {{ 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." } { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." } { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." } { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." } { 4 3 RESERVED_1 R 0 "Reserved.  0s on read." } { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." } { 8 24 RESERVED_2 R 0 "Reserved.  0s on read." }}} {0x04 GIER       RW   0x0 "Global Interrupt Enable Register" {{ 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" } { 1 31 RESERVED R 0 "Reserved.  0s on read." }} } {0x08 IP_IER     RW   0x0 "IP Interrupt Enable Register" {{ 0 1 CHAN0_INT_EN RW 0 "Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled." } { 1 1 CHAN1_INT_EN RW 0 "Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled." } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x0c IP_ISR     RW   0x0 "IP Interrupt Status Register" {{ 0 1 CHAN0_INT_ST RTOW 0 "Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 input interrupt, 1 = Channel 0 input interrup" } { 1 1 CHAN1_INT_ST RTOW 0 "Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 input interrupt, 1 = Channel 1 input interrup" } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x10 agg_result_a R 0x0 "Data signal of agg_result_a" {{0 32 agg_result_a R 0 "Bit 31 to 0 Data signal of agg_result_a"}}} {0x14 agg_result_a_ctrl R 0x0 "Control signal of agg_result_a" {{0 1 agg_result_a_ap_vld R 0 "Control signal agg_result_a_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x18 agg_result_b R 0x0 "Data signal of agg_result_b" {{0 32 agg_result_b R 0 "Bit 31 to 0 Data signal of agg_result_b"}}} {0x1c agg_result_b_ctrl R 0x0 "Control signal of agg_result_b" {{0 1 agg_result_b_ap_vld R 0 "Control signal agg_result_b_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x20 agg_result_c R 0x0 "Data signal of agg_result_c" {{0 32 agg_result_c R 0 "Bit 31 to 0 Data signal of agg_result_c"}}} {0x24 agg_result_c_ctrl R 0x0 "Control signal of agg_result_c" {{0 1 agg_result_c_ap_vld R 0 "Control signal agg_result_c_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x28 agg_result_d R 0x0 "Data signal of agg_result_d" {{0 32 agg_result_d R 0 "Bit 31 to 0 Data signal of agg_result_d"}}} {0x2c agg_result_d_ctrl R 0x0 "Control signal of agg_result_d" {{0 1 agg_result_d_ap_vld R 0 "Control signal agg_result_d_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x30 agg_result_e R 0x0 "Data signal of agg_result_e" {{0 32 agg_result_e R 0 "Bit 31 to 0 Data signal of agg_result_e"}}} {0x34 agg_result_e_ctrl R 0x0 "Control signal of agg_result_e" {{0 1 agg_result_e_ap_vld R 0 "Control signal agg_result_e_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x38 agg_result_f R 0x0 "Data signal of agg_result_f" {{0 32 agg_result_f R 0 "Bit 31 to 0 Data signal of agg_result_f"}}} {0x3c agg_result_f_ctrl R 0x0 "Control signal of agg_result_f" {{0 1 agg_result_f_ap_vld R 0 "Control signal agg_result_f_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x40 searched W 0x0 "Data signal of searched" {{0 32 searched W 0 "Bit 31 to 0 Data signal of searched"}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
    ...
    ap_clk {
        ...
        buses "s_axi_CONTROL_BUS OUTPUT_STREAM"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
...
## System Info
set user_parameters_list {clk_period 10 machine 64 combinational 0 latency 203 II x}
