...
#ifndef _StreamGenerator_HH_
#define _StreamGenerator_HH_

#include "systemc.h"
#include "AESL_pkg.h"

#include "StreamGenerator_CONTROL_BUS_s_axi.h"

namespace ap_rtl {

template<unsigned int C_S_AXI_CONTROL_BUS_ADDR_WIDTH = 7,
         unsigned int C_S_AXI_CONTROL_BUS_DATA_WIDTH = 32>
struct StreamGenerator : public sc_module {
    ...
    // Module declarations
    StreamGenerator(sc_module_name name);
    SC_HAS_PROCESS(StreamGenerator);
    ...
    StreamGenerator_CONTROL_BUS_s_axi<C_S_AXI_CONTROL_BUS_ADDR_WIDTH,C_S_AXI_CONTROL_BUS_DATA_WIDTH>* StreamGenerator_CONTROL_BUS_s_axi_U;
    ...
    sc_signal< sc_lv<8> > tmp_data_V_reg_170;
    ...
    sc_signal< sc_lv<8> > i_fu_188_p2;
    sc_signal< sc_lv<8> > i_reg_210;
    sc_signal< sc_logic > ap_enable_reg_pp0_iter0;
    sc_signal< sc_lv<32> > tmp_data_V_1_fu_194_p1;
    sc_signal< sc_lv<1> > tmp_last_V_fu_199_p2;
    sc_signal< bool > ap_block_pp0_stage0_subdone;
    sc_signal< sc_logic > ap_condition_pp0_exit_iter0_state2;
    sc_signal< sc_lv<8> > ap_phi_mux_tmp_data_V_phi_fu_174_p4;
    ...
    void thread_ap_phi_mux_tmp_data_V_phi_fu_174_p4();
    void thread_ap_ready();
    void thread_ap_rst_n_inv();
    void thread_exitcond_fu_182_p2();
    void thread_i_fu_188_p2();
    void thread_tmp_data_V_1_fu_194_p1();
    void thread_tmp_last_V_fu_199_p2();
