...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("output_V_i", 64, hls_in, 14, "ap_ovld", "in_data", 1),
	Port_Property("output_V_o", 64, hls_out, 14, "ap_ovld", "out_data", 1),
	Port_Property("output_V_o_ap_vld", 1, hls_out, 14, "ap_ovld", "out_vld", 1),
