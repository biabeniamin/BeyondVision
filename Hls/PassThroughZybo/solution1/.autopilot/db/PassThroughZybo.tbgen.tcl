set C_TypeInfoList {{ 
"PassThroughZybo" : [[], { "return": [[], "void"]} , [{"ExternC" : 0}], [ {"INPUT_STREAM": [[], {"reference": "0"}] }, {"OUTPUT_STREAM": [[], {"reference": "0"}] }],[],""], 
...
set moduleName PassThroughZybo
...
set C_modelName {PassThroughZybo}
