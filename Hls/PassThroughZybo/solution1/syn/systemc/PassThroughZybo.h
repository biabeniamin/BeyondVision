...
#ifndef _PassThroughZybo_HH_
#define _PassThroughZybo_HH_
...
struct PassThroughZybo : public sc_module {
    ...
    // Module declarations
    PassThroughZybo(sc_module_name name);
    SC_HAS_PROCESS(PassThroughZybo);
