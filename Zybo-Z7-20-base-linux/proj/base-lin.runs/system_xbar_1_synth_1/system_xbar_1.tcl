...
set cached_ip [config_ip_cache -export -no_bom -use_project_ipc -dir C:/Digilent19/Zybo-Z7-20-base-linux/proj/base-lin.runs/system_xbar_1_synth_1 -new_name system_xbar_1 -ip [get_ips system_xbar_1]]
