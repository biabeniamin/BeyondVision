...
architecture behav of AddWeighted is 
    ...
    signal grp_arithm_pro_fu_138_ap_start : STD_LOGIC;
    signal grp_arithm_pro_fu_138_ap_done : STD_LOGIC;
    signal grp_arithm_pro_fu_138_ap_idle : STD_LOGIC;
    signal grp_arithm_pro_fu_138_ap_ready : STD_LOGIC;
    signal grp_arithm_pro_fu_138_src1_data_stream_0_V_read : STD_LOGIC;
    signal grp_arithm_pro_fu_138_src1_data_stream_1_V_read : STD_LOGIC;
    signal grp_arithm_pro_fu_138_src1_data_stream_2_V_read : STD_LOGIC;
    signal grp_arithm_pro_fu_138_src2_data_stream_0_V_read : STD_LOGIC;
    signal grp_arithm_pro_fu_138_src2_data_stream_1_V_read : STD_LOGIC;
    signal grp_arithm_pro_fu_138_src2_data_stream_2_V_read : STD_LOGIC;
    signal grp_arithm_pro_fu_138_dst_data_stream_0_V_din : STD_LOGIC_VECTOR (7 downto 0);
    signal grp_arithm_pro_fu_138_dst_data_stream_0_V_write : STD_LOGIC;
    signal grp_arithm_pro_fu_138_dst_data_stream_1_V_din : STD_LOGIC_VECTOR (7 downto 0);
    signal grp_arithm_pro_fu_138_dst_data_stream_1_V_write : STD_LOGIC;
    signal grp_arithm_pro_fu_138_dst_data_stream_2_V_din : STD_LOGIC_VECTOR (7 downto 0);
    signal grp_arithm_pro_fu_138_dst_data_stream_2_V_write : STD_LOGIC;
    signal grp_arithm_pro_fu_138_ap_start_reg : STD_LOGIC := '0';
...
begin
    grp_arithm_pro_fu_138 : component arithm_pro
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    grp_arithm_pro_fu_138_ap_start_reg_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                grp_arithm_pro_fu_138_ap_start_reg <= ap_const_logic_0;
            else
                if (((ap_start = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
                    grp_arithm_pro_fu_138_ap_start_reg <= ap_const_logic_1;
                elsif ((grp_arithm_pro_fu_138_ap_ready = ap_const_logic_1)) then 
                    grp_arithm_pro_fu_138_ap_start_reg <= ap_const_logic_0;
                end if; 
            end if;
        end if;
    ...
    ap_NS_fsm_assign_proc : process (ap_start, ap_CS_fsm, ap_CS_fsm_state1, grp_arithm_pro_fu_138_ap_done, ap_CS_fsm_state2)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_state2 => 
                if (((grp_arithm_pro_fu_138_ap_done = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state2))) then
                    ap_NS_fsm <= ap_ST_fsm_state1;
                else
                    ap_NS_fsm <= ap_ST_fsm_state2;
                end if;
    ...
    ap_done_assign_proc : process(ap_start, ap_CS_fsm_state1, grp_arithm_pro_fu_138_ap_done, ap_CS_fsm_state2)
    begin
        if ((((ap_start = ap_const_logic_0) and (ap_const_logic_1 = ap_CS_fsm_state1)) or ((grp_arithm_pro_fu_138_ap_done = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state2)))) then 
    ...
    ap_ready_assign_proc : process(grp_arithm_pro_fu_138_ap_done, ap_CS_fsm_state2)
    begin
        if (((grp_arithm_pro_fu_138_ap_done = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
    ...
    dst_data_stream_0_V_write_assign_proc : process(grp_arithm_pro_fu_138_dst_data_stream_0_V_write, ap_CS_fsm_state2)
    begin
    ...
    dst_data_stream_1_V_write_assign_proc : process(grp_arithm_pro_fu_138_dst_data_stream_1_V_write, ap_CS_fsm_state2)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state2)) then 
            dst_data_stream_1_V_write <= grp_arithm_pro_fu_138_dst_data_stream_1_V_write;
        else 
    ...
    dst_data_stream_2_V_write_assign_proc : process(grp_arithm_pro_fu_138_dst_data_stream_2_V_write, ap_CS_fsm_state2)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state2)) then 
            dst_data_stream_2_V_write <= grp_arithm_pro_fu_138_dst_data_stream_2_V_write;
        else 
    ...
    grp_arithm_pro_fu_138_ap_start <= grp_arithm_pro_fu_138_ap_start_reg;

    src1_data_stream_0_V_read_assign_proc : process(grp_arithm_pro_fu_138_src1_data_stream_0_V_read, ap_CS_fsm_state2)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state2)) then 
            src1_data_stream_0_V_read <= grp_arithm_pro_fu_138_src1_data_stream_0_V_read;
        else 
    ...
    src1_data_stream_1_V_read_assign_proc : process(grp_arithm_pro_fu_138_src1_data_stream_1_V_read, ap_CS_fsm_state2)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state2)) then 
            src1_data_stream_1_V_read <= grp_arithm_pro_fu_138_src1_data_stream_1_V_read;
        else 
    ...
    src1_data_stream_2_V_read_assign_proc : process(grp_arithm_pro_fu_138_src1_data_stream_2_V_read, ap_CS_fsm_state2)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state2)) then 
            src1_data_stream_2_V_read <= grp_arithm_pro_fu_138_src1_data_stream_2_V_read;
        else 
    ...
    src2_data_stream_0_V_read_assign_proc : process(grp_arithm_pro_fu_138_src2_data_stream_0_V_read, ap_CS_fsm_state2)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state2)) then 
            src2_data_stream_0_V_read <= grp_arithm_pro_fu_138_src2_data_stream_0_V_read;
        else 
    ...
    src2_data_stream_1_V_read_assign_proc : process(grp_arithm_pro_fu_138_src2_data_stream_1_V_read, ap_CS_fsm_state2)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state2)) then 
            src2_data_stream_1_V_read <= grp_arithm_pro_fu_138_src2_data_stream_1_V_read;
        else 
    ...
    src2_data_stream_2_V_read_assign_proc : process(grp_arithm_pro_fu_138_src2_data_stream_2_V_read, ap_CS_fsm_state2)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state2)) then 
            src2_data_stream_2_V_read <= grp_arithm_pro_fu_138_src2_data_stream_2_V_read;
        else 
