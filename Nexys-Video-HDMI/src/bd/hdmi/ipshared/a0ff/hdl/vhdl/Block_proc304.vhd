...
architecture behav of Block_proc304 is 
    ...
    signal AXIvideo2Mat487_U0_ap_start : STD_LOGIC;
    signal AXIvideo2Mat487_U0_ap_done : STD_LOGIC;
    signal AXIvideo2Mat487_U0_ap_continue : STD_LOGIC;
    signal AXIvideo2Mat487_U0_ap_idle : STD_LOGIC;
    signal AXIvideo2Mat487_U0_ap_ready : STD_LOGIC;
    signal AXIvideo2Mat487_U0_start_out : STD_LOGIC;
    signal AXIvideo2Mat487_U0_start_write : STD_LOGIC;
    signal AXIvideo2Mat487_U0_INPUT_STREAM_TREADY : STD_LOGIC;
    signal AXIvideo2Mat487_U0_img_data_stream_0_V_din : STD_LOGIC_VECTOR (7 downto 0);
    signal AXIvideo2Mat487_U0_img_data_stream_0_V_write : STD_LOGIC;
    signal AXIvideo2Mat487_U0_img_data_stream_1_V_din : STD_LOGIC_VECTOR (7 downto 0);
    signal AXIvideo2Mat487_U0_img_data_stream_1_V_write : STD_LOGIC;
    signal AXIvideo2Mat487_U0_img_data_stream_2_V_din : STD_LOGIC_VECTOR (7 downto 0);
    signal AXIvideo2Mat487_U0_img_data_stream_2_V_write : STD_LOGIC;
    signal AXIvideo2Mat487_U0_img_rows_V_out_din : STD_LOGIC_VECTOR (10 downto 0);
    signal AXIvideo2Mat487_U0_img_rows_V_out_write : STD_LOGIC;
    signal AXIvideo2Mat487_U0_img_cols_V_out_din : STD_LOGIC_VECTOR (11 downto 0);
    signal AXIvideo2Mat487_U0_img_cols_V_out_write : STD_LOGIC;
    signal Mat2AXIvideo514_U0_ap_start : STD_LOGIC;
    signal Mat2AXIvideo514_U0_ap_done : STD_LOGIC;
    signal Mat2AXIvideo514_U0_ap_continue : STD_LOGIC;
    signal Mat2AXIvideo514_U0_ap_idle : STD_LOGIC;
    signal Mat2AXIvideo514_U0_ap_ready : STD_LOGIC;
    signal Mat2AXIvideo514_U0_start_out : STD_LOGIC;
    signal Mat2AXIvideo514_U0_start_write : STD_LOGIC;
    signal Mat2AXIvideo514_U0_img_rows_V_read : STD_LOGIC;
    signal Mat2AXIvideo514_U0_img_cols_V_read : STD_LOGIC;
    signal Mat2AXIvideo514_U0_img_data_stream_0_V_read : STD_LOGIC;
    signal Mat2AXIvideo514_U0_img_data_stream_1_V_read : STD_LOGIC;
    signal Mat2AXIvideo514_U0_img_data_stream_2_V_read : STD_LOGIC;
    signal Mat2AXIvideo514_U0_OUTPUT_STREAM_TDATA : STD_LOGIC_VECTOR (23 downto 0);
    signal Mat2AXIvideo514_U0_OUTPUT_STREAM_TVALID : STD_LOGIC;
    signal Mat2AXIvideo514_U0_OUTPUT_STREAM_TKEEP : STD_LOGIC_VECTOR (2 downto 0);
    signal Mat2AXIvideo514_U0_OUTPUT_STREAM_TSTRB : STD_LOGIC_VECTOR (2 downto 0);
    signal Mat2AXIvideo514_U0_OUTPUT_STREAM_TUSER : STD_LOGIC_VECTOR (0 downto 0);
    signal Mat2AXIvideo514_U0_OUTPUT_STREAM_TLAST : STD_LOGIC_VECTOR (0 downto 0);
    signal Mat2AXIvideo514_U0_OUTPUT_STREAM_TID : STD_LOGIC_VECTOR (0 downto 0);
    signal Mat2AXIvideo514_U0_OUTPUT_STREAM_TDEST : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal CvtColor_1_U0_ap_start : STD_LOGIC := '0';
    ...
    signal GaussianBlur_U0_ap_start : STD_LOGIC := '0';
    ...
    signal Duplicate_U0_ap_start : STD_LOGIC := '0';
    ...
    signal Sobel_U0_ap_start : STD_LOGIC := '0';
    ...
    signal Sobel_1_U0_ap_start : STD_LOGIC := '0';
    ...
    signal AddWeighted_U0_ap_start : STD_LOGIC := '0';
    ...
    signal AXIvideo2Mat487_U0_img_data_stream_0_V_empty_n : STD_LOGIC;
    signal AXIvideo2Mat487_U0_img_data_stream_0_V_read : STD_LOGIC;
    signal AXIvideo2Mat487_U0_img_data_stream_0_V_dout : STD_LOGIC_VECTOR (7 downto 0);
    ...
    signal AXIvideo2Mat487_U0_img_data_stream_1_V_empty_n : STD_LOGIC;
    signal AXIvideo2Mat487_U0_img_data_stream_1_V_read : STD_LOGIC;
    signal AXIvideo2Mat487_U0_img_data_stream_1_V_dout : STD_LOGIC_VECTOR (7 downto 0);
    ...
    signal AXIvideo2Mat487_U0_img_data_stream_2_V_empty_n : STD_LOGIC;
    signal AXIvideo2Mat487_U0_img_data_stream_2_V_read : STD_LOGIC;
    signal AXIvideo2Mat487_U0_img_data_stream_2_V_dout : STD_LOGIC_VECTOR (7 downto 0);
    signal img_0_rows_V1_c_full_n : STD_LOGIC;
    signal img_0_rows_V1_c_dout : STD_LOGIC_VECTOR (10 downto 0);
    signal img_0_rows_V1_c_empty_n : STD_LOGIC;
    signal img_0_cols_V2_c_full_n : STD_LOGIC;
    signal img_0_cols_V2_c_dout : STD_LOGIC_VECTOR (11 downto 0);
    signal img_0_cols_V2_c_empty_n : STD_LOGIC;
    ...
    signal ap_sync_reg_AXIvideo2Mat487_U0_ap_ready : STD_LOGIC := '0';
    signal ap_sync_AXIvideo2Mat487_U0_ap_ready : STD_LOGIC;
    signal AXIvideo2Mat487_U0_ap_ready_count : STD_LOGIC_VECTOR (1 downto 0) := "00";
    ...
    signal start_for_Mat2AXIvideo514_U0_din : STD_LOGIC_VECTOR (0 downto 0);
    signal start_for_Mat2AXIvideo514_U0_full_n : STD_LOGIC;
    signal start_for_Mat2AXIvideo514_U0_dout : STD_LOGIC_VECTOR (0 downto 0);
    signal start_for_Mat2AXIvideo514_U0_empty_n : STD_LOGIC;
...
begin
    AXIvideo2Mat487_U0 : component AXIvideo2Mat487
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    Mat2AXIvideo514_U0 : component Mat2AXIvideo514
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
        ...
        img_data_stream_0_V_dout => ap_const_lv8_0,
        img_data_stream_0_V_empty_n => ap_const_logic_1,
        img_data_stream_0_V_read => Mat2AXIvideo514_U0_img_data_stream_0_V_read,
        img_data_stream_1_V_dout => ap_const_lv8_0,
        img_data_stream_1_V_empty_n => ap_const_logic_1,
        img_data_stream_1_V_read => Mat2AXIvideo514_U0_img_data_stream_1_V_read,
        img_data_stream_2_V_dout => ap_const_lv8_0,
        img_data_stream_2_V_empty_n => ap_const_logic_1,
    ...
    port map (
        ...
        img_data_stream_0_V_full_n => ap_const_logic_1,
        img_data_stream_0_V_write => AXIvideo2Mat_U0_img_data_stream_0_V_write,
        img_data_stream_1_V_din => AXIvideo2Mat_U0_img_data_stream_1_V_din,
        img_data_stream_1_V_full_n => ap_const_logic_1,
        img_data_stream_1_V_write => AXIvideo2Mat_U0_img_data_stream_1_V_write,
        img_data_stream_2_V_din => AXIvideo2Mat_U0_img_data_stream_2_V_din,
        img_data_stream_2_V_full_n => ap_const_logic_1,
    ...
    port map (
        ...
        p_src_data_stream_0_V_dout => ap_const_lv8_0,
        p_src_data_stream_0_V_empty_n => ap_const_logic_1,
        p_src_data_stream_0_V_read => CvtColor_1_U0_p_src_data_stream_0_V_read,
        p_src_data_stream_1_V_dout => ap_const_lv8_0,
        p_src_data_stream_1_V_empty_n => ap_const_logic_1,
        p_src_data_stream_1_V_read => CvtColor_1_U0_p_src_data_stream_1_V_read,
        p_src_data_stream_2_V_dout => ap_const_lv8_0,
        p_src_data_stream_2_V_empty_n => ap_const_logic_1,
    ...
    img_0_rows_V1_c_U : component fifo_w11_d2_A
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    img_0_cols_V2_c_U : component fifo_w12_d2_A
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    AddWeighted_U0_ap_start_assign_proc : process(ap_clk)
    begin
    ...
    CvtColor_1_U0_ap_start_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
    ...
    Duplicate_U0_ap_start_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
    ...
    GaussianBlur_U0_ap_start_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
    ...
    Sobel_1_U0_ap_start_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
    ...
    Sobel_U0_ap_start_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
    ...
    ap_sync_reg_AXIvideo2Mat487_U0_ap_ready_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
    ...
    AXIvideo2Mat487_U0_ap_ready_count_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_sync_ready = ap_const_logic_1) and (ap_const_logic_0 = AXIvideo2Mat487_U0_ap_ready))) then 
                AXIvideo2Mat487_U0_ap_ready_count <= std_logic_vector(unsigned(AXIvideo2Mat487_U0_ap_ready_count) - unsigned(ap_const_lv2_1));
            elsif (((ap_const_logic_1 = AXIvideo2Mat487_U0_ap_ready) and (ap_sync_ready = ap_const_logic_0))) then 
                AXIvideo2Mat487_U0_ap_ready_count <= std_logic_vector(unsigned(AXIvideo2Mat487_U0_ap_ready_count) + unsigned(ap_const_lv2_1));
            end if; 
        end if;
    end process;
    ...
    AXIvideo2Mat487_U0_ap_start <= ((ap_sync_reg_AXIvideo2Mat487_U0_ap_ready xor ap_const_logic_1) and ap_start);
    AXIvideo2Mat487_U0_img_data_stream_0_V_dout <= img_0_data_stream_0_dout;
    AXIvideo2Mat487_U0_img_data_stream_0_V_empty_n <= img_0_data_stream_0_empty_n;
    AXIvideo2Mat487_U0_img_data_stream_0_V_read <= ap_const_logic_0;
    AXIvideo2Mat487_U0_img_data_stream_1_V_dout <= img_0_data_stream_1_dout;
    AXIvideo2Mat487_U0_img_data_stream_1_V_empty_n <= img_0_data_stream_1_empty_n;
    AXIvideo2Mat487_U0_img_data_stream_1_V_read <= ap_const_logic_0;
    AXIvideo2Mat487_U0_img_data_stream_2_V_dout <= img_0_data_stream_2_dout;
    AXIvideo2Mat487_U0_img_data_stream_2_V_empty_n <= img_0_data_stream_2_empty_n;
    ...
    INPUT_STREAM_TREADY <= AXIvideo2Mat_U0_INPUT_STREAM_TREADY;
    Mat2AXIvideo514_U0_ap_continue <= ap_sync_continue;
    Mat2AXIvideo514_U0_ap_start <= start_for_Mat2AXIvideo514_U0_empty_n;
    ...
    ap_idle <= (Sobel_U0_ap_idle and Sobel_1_U0_ap_idle and Mat2AXIvideo_U0_ap_idle and Mat2AXIvideo514_U0_ap_idle and GaussianBlur_U0_ap_idle and Duplicate_U0_ap_idle and CvtColor_U0_ap_idle and CvtColor_1_U0_ap_idle and AddWeighted_U0_ap_idle and AXIvideo2Mat_U0_ap_idle and AXIvideo2Mat487_U0_ap_idle);
    ap_ready <= ap_sync_ready;
    ap_sync_AXIvideo2Mat487_U0_ap_ready <= (ap_sync_reg_AXIvideo2Mat487_U0_ap_ready or AXIvideo2Mat487_U0_ap_ready);
    ap_sync_AXIvideo2Mat_U0_ap_ready <= (ap_sync_reg_AXIvideo2Mat_U0_ap_ready or AXIvideo2Mat_U0_ap_ready);
    ap_sync_continue <= (ap_sync_done and ap_continue);
    ap_sync_done <= (Mat2AXIvideo_U0_ap_done and Mat2AXIvideo514_U0_ap_done);
    ap_sync_ready <= (ap_sync_AXIvideo2Mat_U0_ap_ready and ap_sync_AXIvideo2Mat487_U0_ap_ready);
    start_for_CvtColor_U0_empty_n <= ap_const_logic_0;
    start_for_CvtColor_U0_read <= CvtColor_U0_ap_ready;
    start_for_Mat2AXIvideo514_U0_din <= (0=>ap_const_logic_1, others=>'-');
