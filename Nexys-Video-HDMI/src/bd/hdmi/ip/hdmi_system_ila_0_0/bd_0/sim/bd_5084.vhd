...
architecture STRUCTURE of bd_5084 is
  ...
  attribute X_INTERFACE_PARAMETER of clk : signal is "XIL_INTERFACENAME CLK.CLK, ASSOCIATED_BUSIF SLOT_1_AXIS:SLOT_2_AXIS, ASSOCIATED_RESET resetn, CLK_DOMAIN hdmi_mig_7series_0_0_ui_clk, FREQ_HZ 160000000, PHASE 0";
...
begin
  Conn1_TDATA(23 downto 0) <= SLOT_2_AXIS_tdata(23 downto 0);
  Conn1_TDEST(0) <= SLOT_2_AXIS_tdest(0);
  Conn1_TID(0) <= SLOT_2_AXIS_tid(0);
  Conn1_TKEEP(2 downto 0) <= SLOT_2_AXIS_tkeep(2 downto 0);
  Conn1_TLAST <= SLOT_2_AXIS_tlast;
  Conn1_TREADY <= SLOT_2_AXIS_tready;
  Conn1_TSTRB(2 downto 0) <= SLOT_2_AXIS_tstrb(2 downto 0);
  Conn1_TUSER(0) <= SLOT_2_AXIS_tuser(0);
  Conn1_TVALID <= SLOT_2_AXIS_tvalid;
...
g_inst: component bd_5084_g_inst_0
     port map (
      ...
      m_slot_1_axis_tdata(23 downto 0) => net_slot_2_axis_tdata(23 downto 0),
      m_slot_1_axis_tdest(0) => net_slot_2_axis_tdest(0),
      m_slot_1_axis_tid(0) => net_slot_2_axis_tid(0),
      m_slot_1_axis_tkeep(2 downto 0) => net_slot_2_axis_tkeep(2 downto 0),
      m_slot_1_axis_tlast => net_slot_2_axis_tlast,
      m_slot_1_axis_tready => net_slot_2_axis_tready,
      m_slot_1_axis_tstrb(2 downto 0) => net_slot_2_axis_tstrb(2 downto 0),
      m_slot_1_axis_tuser(0) => net_slot_2_axis_tuser(0),
...
ila_lib: component bd_5084_ila_lib_0
     port map (
      ...
      probe12(23 downto 0) => net_slot_2_axis_tdata(23 downto 0),
      probe13(0) => net_slot_2_axis_tdest(0),
      probe14(0) => net_slot_2_axis_tid(0),
      probe15(2 downto 0) => net_slot_2_axis_tkeep(2 downto 0),
      probe16(2 downto 0) => net_slot_2_axis_tstrb(2 downto 0),
      probe17(0) => net_slot_2_axis_tuser(0),
      probe18(0) => net_slot_2_axis_tvalid,
      probe19(0) => net_slot_2_axis_tready,
      probe2(0) => probe2_1(0),
      probe20(0) => net_slot_2_axis_tlast,
      probe3(0) => SLOT_0_ACC_HANDSHAKE_start_1,
      probe4(0) => SLOT_0_ACC_HANDSHAKE_done_1,
      probe5(0) => SLOT_0_ACC_HANDSHAKE_ready_1,
      probe6(0) => SLOT_0_ACC_HANDSHAKE_idle_1,
      probe7(23 downto 0) => net_slot_1_axis_tdata(23 downto 0),
      probe8(0) => net_slot_1_axis_tuser(0),
