...
ila_lib: component bd_5084_ila_lib_0
     port map (
      ...
      probe6(0) => net_slot_1_axis_tdest(0),
      probe7(0) => net_slot_1_axis_tid(0),
      probe8(2 downto 0) => net_slot_1_axis_tkeep(2 downto 0),
      probe9(2 downto 0) => net_slot_1_axis_tstrb(2 downto 0)
    );
end STRUCTURE;
