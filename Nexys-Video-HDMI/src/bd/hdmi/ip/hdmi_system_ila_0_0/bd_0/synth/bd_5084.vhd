...
architecture STRUCTURE of bd_5084 is
  ...
  port (
    ...
    m_slot_1_axis_tstrb : out STD_LOGIC_VECTOR ( 2 downto 0 );
    m_slot_1_axis_tkeep : out STD_LOGIC_VECTOR ( 2 downto 0 );
    m_slot_1_axis_tlast : out STD_LOGIC;
    m_slot_1_axis_tid : out STD_LOGIC_VECTOR ( 0 to 0 );
    m_slot_1_axis_tdest : out STD_LOGIC_VECTOR ( 0 to 0 );
  ...
  signal Conn1_TDEST : STD_LOGIC_VECTOR ( 0 to 0 );
  signal Conn1_TID : STD_LOGIC_VECTOR ( 0 to 0 );
  signal Conn1_TKEEP : STD_LOGIC_VECTOR ( 2 downto 0 );
  signal Conn1_TLAST : STD_LOGIC;
  signal Conn1_TREADY : STD_LOGIC;
  signal Conn1_TSTRB : STD_LOGIC_VECTOR ( 2 downto 0 );
  ...
  signal net_slot_1_axis_tdest : STD_LOGIC_VECTOR ( 0 to 0 );
  signal net_slot_1_axis_tid : STD_LOGIC_VECTOR ( 0 to 0 );
  ...
  signal net_slot_1_axis_tstrb : STD_LOGIC_VECTOR ( 2 downto 0 );
  ...
  attribute X_INTERFACE_PARAMETER of clk : signal is "XIL_INTERFACENAME CLK.CLK, ASSOCIATED_BUSIF SLOT_0_AXIS:SLOT_1_AXIS:SLOT_2_AXIS, ASSOCIATED_RESET resetn, CLK_DOMAIN hdmi_mig_7series_0_0_ui_clk, FREQ_HZ 160000000, PHASE 0";
  ...
  attribute X_INTERFACE_PARAMETER of SLOT_0_AXIS_tdata : signal is "XIL_INTERFACENAME SLOT_0_AXIS, CLK_DOMAIN hdmi_mig_7series_0_0_ui_clk, FREQ_HZ 160000000, HAS_TKEEP 0, HAS_TLAST 1, HAS_TREADY 1, HAS_TSTRB 0, LAYERED_METADATA undef, PHASE 0, TDATA_NUM_BYTES 3, TDEST_WIDTH 0, TID_WIDTH 0, TUSER_WIDTH 1";
  ...
  attribute X_INTERFACE_PARAMETER of SLOT_1_AXIS_tdata : signal is "XIL_INTERFACENAME SLOT_1_AXIS, CLK_DOMAIN hdmi_mig_7series_0_0_ui_clk, FREQ_HZ 160000000, HAS_TKEEP 1, HAS_TLAST 1, HAS_TREADY 1, HAS_TSTRB 1, LAYERED_METADATA xilinx.com:interface:datatypes:1.0 {CLK {datatype {name {attribs {resolve_type immediate dependency {} format string minimum {} maximum {}} value {}} bitwidth {attribs {resolve_type immediate dependency {} format long minimum {} maximum {}} value 1} bitoffset {attribs {resolve_type immediate dependency {} format long minimum {} maximum {}} value 0}}}}, PHASE 0, TDATA_NUM_BYTES 3, TDEST_WIDTH 1, TID_WIDTH 1, TUSER_WIDTH 1";
...
begin
  ...
  Conn1_TDEST(0) <= SLOT_1_AXIS_tdest(0);
  Conn1_TID(0) <= SLOT_1_AXIS_tid(0);
  Conn1_TKEEP(2 downto 0) <= SLOT_1_AXIS_tkeep(2 downto 0);
  Conn1_TLAST <= SLOT_1_AXIS_tlast;
  Conn1_TREADY <= SLOT_1_AXIS_tready;
  Conn1_TSTRB(2 downto 0) <= SLOT_1_AXIS_tstrb(2 downto 0);
...
g_inst: component bd_5084_g_inst_0
     port map (
      ...
      m_slot_1_axis_tdest(0) => net_slot_1_axis_tdest(0),
      m_slot_1_axis_tid(0) => net_slot_1_axis_tid(0),
      m_slot_1_axis_tkeep(2 downto 0) => net_slot_1_axis_tkeep(2 downto 0),
      m_slot_1_axis_tlast => net_slot_1_axis_tlast,
      m_slot_1_axis_tready => net_slot_1_axis_tready,
      m_slot_1_axis_tstrb(2 downto 0) => net_slot_1_axis_tstrb(2 downto 0),
      ...
      slot_1_axis_tdest(0) => Conn1_TDEST(0),
      slot_1_axis_tid(0) => Conn1_TID(0),
      slot_1_axis_tkeep(2 downto 0) => Conn1_TKEEP(2 downto 0),
      slot_1_axis_tlast => Conn1_TLAST,
      slot_1_axis_tready => Conn1_TREADY,
      slot_1_axis_tstrb(2 downto 0) => Conn1_TSTRB(2 downto 0),
...
ila_lib: component bd_5084_ila_lib_0
     port map (
      ...
      probe0(0) => probe0_1(0),
      probe1(0) => probe1_1(0),
      probe10(0) => net_slot_1_axis_tid(0),
      probe11(2 downto 0) => net_slot_1_axis_tkeep(2 downto 0),
      probe12(2 downto 0) => net_slot_1_axis_tstrb(2 downto 0),
      probe13(0) => net_slot_1_axis_tuser(0),
      ...
      probe18(0) => net_slot_2_axis_tuser(0),
      probe19(0) => net_slot_2_axis_tvalid,
      probe2(0) => probe2_1(0),
      probe20(0) => net_slot_2_axis_tready,
      probe21(0) => net_slot_2_axis_tlast,
      probe3(23 downto 0) => net_slot_0_axis_tdata(23 downto 0),
      probe4(0) => net_slot_0_axis_tuser(0),
      probe5(0) => net_slot_0_axis_tvalid,
      probe6(0) => net_slot_0_axis_tready,
      probe7(0) => net_slot_0_axis_tlast,
      probe8(23 downto 0) => net_slot_1_axis_tdata(23 downto 0),
      probe9(0) => net_slot_1_axis_tdest(0)
    );
end STRUCTURE;
