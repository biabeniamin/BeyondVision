...
entity bd_9025 is
  ...
  attribute CORE_GENERATION_INFO of bd_9025 : entity is "bd_9025,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=bd_9025,x_ipVersion=1.00.a,x_ipLanguage=VHDL,numBlks=1,numReposBlks=1,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=SBD,synth_mode=Global}";
  attribute HW_HANDOFF : string;
  attribute HW_HANDOFF of bd_9025 : entity is "hdmi_system_ila_2_0.hwdef";
end bd_9025;

architecture STRUCTURE of bd_9025 is
  component bd_9025_ila_lib_0 is
  port (
    clk : in STD_LOGIC;
  ...
  end component bd_9025_ila_lib_0;
  ...
  attribute X_INTERFACE_PARAMETER of clk : signal is "XIL_INTERFACENAME CLK.CLK, CLK_DOMAIN hdmi_dvi2rgb_0_0_PixelClk, FREQ_HZ 100000000, PHASE 0.000";
...
begin
  ...
  clk_1 <= clk;
ila_lib: component bd_9025_ila_lib_0
     port map (
      clk => clk_1,
