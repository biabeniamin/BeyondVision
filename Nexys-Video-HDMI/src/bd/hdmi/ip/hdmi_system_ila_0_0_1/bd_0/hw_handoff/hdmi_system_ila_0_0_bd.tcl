...
connect_bd_intf_net -intf_net Conn [get_bd_intf_ports SLOT_1_AXIS] [get_bd_intf_pins g_inst/slot_0_axis]
  ...
  connect_bd_net -net SLOT_0_ACC_HANDSHAKE_done_1 [get_bd_ports SLOT_0_ACC_HANDSHAKE_done] [get_bd_pins ila_lib/probe1]
  connect_bd_net -net SLOT_0_ACC_HANDSHAKE_idle_1 [get_bd_ports SLOT_0_ACC_HANDSHAKE_idle] [get_bd_pins ila_lib/probe3]
  connect_bd_net -net SLOT_0_ACC_HANDSHAKE_ready_1 [get_bd_ports SLOT_0_ACC_HANDSHAKE_ready] [get_bd_pins ila_lib/probe2]
  connect_bd_net -net SLOT_0_ACC_HANDSHAKE_start_1 [get_bd_ports SLOT_0_ACC_HANDSHAKE_start] [get_bd_pins ila_lib/probe0]
  connect_bd_net -net clk_1 [get_bd_ports clk] [get_bd_pins g_inst/aclk] [get_bd_pins ila_lib/clk]
  connect_bd_net -net net_slot_1_axis_tdata [get_bd_pins g_inst/m_slot_0_axis_tdata] [get_bd_pins ila_lib/probe4]
  connect_bd_net -net net_slot_1_axis_tlast [get_bd_pins g_inst/m_slot_0_axis_tlast] [get_bd_pins ila_lib/probe8]
  connect_bd_net -net net_slot_1_axis_tready [get_bd_pins g_inst/m_slot_0_axis_tready] [get_bd_pins ila_lib/probe7]
  connect_bd_net -net net_slot_1_axis_tuser [get_bd_pins g_inst/m_slot_0_axis_tuser] [get_bd_pins ila_lib/probe5]
  connect_bd_net -net net_slot_1_axis_tvalid [get_bd_pins g_inst/m_slot_0_axis_tvalid] [get_bd_pins ila_lib/probe6]
