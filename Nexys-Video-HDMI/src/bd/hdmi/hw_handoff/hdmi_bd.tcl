...
connect_bd_intf_net -intf_net ap_ctrl_0_1 [get_bd_intf_pins image_filter_0/ap_ctrl] [get_bd_intf_pins system_ila_0/SLOT_0_ACC_HANDSHAKE]
  ...
  connect_bd_net -net axi_gpio_0_gpio2_io_o [get_bd_pins axi_gpio_0/gpio2_io_o] [get_bd_pins image_filter_0/ap_start]
  ...
  connect_bd_net -net mig_7series_0_ui_addn_clk_0 [get_bd_pins axi_vdma_0/s_axis_s2mm_aclk] [get_bd_pins axis_subset_converter_1/aclk] [get_bd_pins image_filter_0/ap_clk] [get_bd_pins mig_7series_0/ui_addn_clk_0] [get_bd_pins system_ila_0/clk] [get_bd_pins v_vid_in_axi4s_0/aclk]
