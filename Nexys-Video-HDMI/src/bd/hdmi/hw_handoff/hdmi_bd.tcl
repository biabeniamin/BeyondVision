...
proc create_root_design { parentCell } {
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net PassThrough_0_OUTPUT_STREAM [get_bd_intf_pins PassThrough_0/OUTPUT_STREAM] [get_bd_intf_pins axi_vdma_0/S_AXIS_S2MM]
  ...
  # Create port connections
  connect_bd_net -net Net [get_bd_pins PassThrough_0/ap_rst_n] [get_bd_pins axi_gpio_0/gpio_io_o] [get_bd_pins axis_subset_converter_1/aresetn] [get_bd_pins axis_switch_0/aresetn] [get_bd_pins v_vid_in_axi4s_0/aresetn]
  ...
  connect_bd_net -net axi_gpio_0_gpio2_io_o [get_bd_pins PassThrough_0/ap_start] [get_bd_pins axi_gpio_0/gpio2_io_o]
  ...
  connect_bd_net -net mig_7series_0_ui_addn_clk_0 [get_bd_pins PassThrough_0/ap_clk] [get_bd_pins axi_vdma_0/s_axis_s2mm_aclk] [get_bd_pins axis_subset_converter_1/aclk] [get_bd_pins axis_switch_0/aclk] [get_bd_pins mig_7series_0/ui_addn_clk_0] [get_bd_pins rst_hdmi_160M/slowest_sync_clk] [get_bd_pins v_vid_in_axi4s_0/aclk]
