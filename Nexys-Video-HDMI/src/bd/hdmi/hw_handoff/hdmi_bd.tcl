...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set enable [ create_bd_port -dir I -from 0 -to 0 -type data enable ]
  set_property -dict [ list \
...
connect_bd_intf_net -intf_net [get_bd_intf_nets Sobel_filter_0_OUTPUT_STREAM] [get_bd_intf_pins Sobel_filter_0/OUTPUT_STREAM] [get_bd_intf_pins system_ila_0/SLOT_0_AXIS]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_intf_nets Sobel_filter_0_OUTPUT_STREAM]
  ...
  connect_bd_intf_net -intf_net axis_subset_converter_1_M_AXIS [get_bd_intf_pins Sobel_filter_0/INPUT_STREAM] [get_bd_intf_pins axis_subset_converter_1/M_AXIS]
connect_bd_intf_net -intf_net [get_bd_intf_nets axis_subset_converter_1_M_AXIS] [get_bd_intf_pins Sobel_filter_0/INPUT_STREAM] [get_bd_intf_pins system_ila_0/SLOT_1_AXIS]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_intf_nets axis_subset_converter_1_M_AXIS]
  ...
  # Create port connections
  connect_bd_net -net Net [get_bd_pins Sobel_filter_0/ap_rst_n] [get_bd_pins axi_gpio_0/gpio_io_o] [get_bd_pins axis_subset_converter_1/aresetn] [get_bd_pins v_vid_in_axi4s_0/aresetn]
  ...
  connect_bd_net -net axi_gpio_0_gpio2_io_o [get_bd_pins Sobel_filter_0/ap_start] [get_bd_pins axi_gpio_0/gpio2_io_o]
  ...
  connect_bd_net -net mig_7series_0_ui_addn_clk_0 [get_bd_pins Sobel_filter_0/ap_clk] [get_bd_pins axi_vdma_0/s_axis_s2mm_aclk] [get_bd_pins axis_subset_converter_1/aclk] [get_bd_pins mig_7series_0/ui_addn_clk_0] [get_bd_pins rst_hdmi_160M/slowest_sync_clk] [get_bd_pins system_ila_0/clk] [get_bd_pins v_vid_in_axi4s_0/aclk]
  ...
  connect_bd_net -net mig_7series_0_ui_clk [get_bd_pins axi_dynclk_0/REF_CLK_I] [get_bd_pins axi_dynclk_0/s00_axi_aclk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_gpio_1/s_axi_aclk] [get_bd_pins axi_gpio_2/s_axi_aclk] [get_bd_pins axi_gpio_video/s_axi_aclk] [get_bd_pins axi_mem_intercon/ACLK] [get_bd_pins axi_mem_intercon/M00_ACLK] [get_bd_pins axi_mem_intercon/S00_ACLK] [get_bd_pins axi_mem_intercon/S01_ACLK] [get_bd_pins axi_mem_intercon/S02_ACLK] [get_bd_pins axi_mem_intercon/S03_ACLK] [get_bd_pins axi_timer_0/s_axi_aclk] [get_bd_pins axi_uartlite_0/s_axi_aclk] [get_bd_pins axi_vdma_0/m_axi_mm2s_aclk] [get_bd_pins axi_vdma_0/m_axi_s2mm_aclk] [get_bd_pins axi_vdma_0/s_axi_lite_aclk] [get_bd_pins microblaze_0/Clk] [get_bd_pins microblaze_0_axi_intc/processor_clk] [get_bd_pins microblaze_0_axi_intc/s_axi_aclk] [get_bd_pins microblaze_0_axi_periph/ACLK] [get_bd_pins microblaze_0_axi_periph/M00_ACLK] [get_bd_pins microblaze_0_axi_periph/M01_ACLK] [get_bd_pins microblaze_0_axi_periph/M02_ACLK] [get_bd_pins microblaze_0_axi_periph/M03_ACLK] [get_bd_pins microblaze_0_axi_periph/M04_ACLK] [get_bd_pins microblaze_0_axi_periph/M05_ACLK] [get_bd_pins microblaze_0_axi_periph/M06_ACLK] [get_bd_pins microblaze_0_axi_periph/M07_ACLK] [get_bd_pins microblaze_0_axi_periph/M08_ACLK] [get_bd_pins microblaze_0_axi_periph/M09_ACLK] [get_bd_pins microblaze_0_axi_periph/M10_ACLK] [get_bd_pins microblaze_0_axi_periph/S00_ACLK] [get_bd_pins microblaze_0_local_memory/LMB_Clk] [get_bd_pins mig_7series_0/ui_clk] [get_bd_pins rst_mig_7series_0_100M/slowest_sync_clk] [get_bd_pins system_ila_1/clk] [get_bd_pins v_tc_0/s_axi_aclk] [get_bd_pins v_tc_1/s_axi_aclk]
  ...
  connect_bd_net -net rst_hdmi_160M_peripheral_aresetn [get_bd_pins rst_hdmi_160M/peripheral_aresetn] [get_bd_pins system_ila_0/resetn]
  ...
  connect_bd_net -net xlconstant_1_dout [get_bd_ports enable] [get_bd_pins Sobel_filter_0/enable_V] [get_bd_pins system_ila_1/probe0]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_nets xlconstant_1_dout]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x40030000 [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs axi_gpio_2/S_AXI/Reg] SEG_axi_gpio_2_Reg
