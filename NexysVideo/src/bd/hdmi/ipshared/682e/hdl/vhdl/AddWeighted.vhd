...
begin
        ...
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if ((ap_continue = ap_const_logic_1)) then 
                    ap_done_reg <= ap_const_logic_0;
                elsif (((grp_arithm_pro_fu_138_ap_done = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
    ...
    ap_NS_fsm_assign_proc : process (real_start, ap_done_reg, ap_CS_fsm, ap_CS_fsm_state1, grp_arithm_pro_fu_138_ap_done, ap_CS_fsm_state2)
    begin
        case ap_CS_fsm is
    ...
    ap_done_assign_proc : process(ap_done_reg, grp_arithm_pro_fu_138_ap_done, ap_CS_fsm_state2)
    begin
        if (((grp_arithm_pro_fu_138_ap_done = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
    ...
    internal_ap_ready_assign_proc : process(grp_arithm_pro_fu_138_ap_done, ap_CS_fsm_state2)
    begin
        if (((grp_arithm_pro_fu_138_ap_done = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
