...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.C_SLOT_0_AXIS_TDATA_WIDTH {1024} \
   ...
   CONFIG.C_SLOT_2_AXIS_TDEST_WIDTH {6} \
...
connect_bd_intf_net -intf_net Conn2 [get_bd_intf_ports SLOT_2_AXIS] [get_bd_intf_pins g_inst/slot_2_axis]
  ...
  connect_bd_net -net net_slot_1_axis_tuser [get_bd_pins g_inst/m_slot_1_axis_tuser] [get_bd_pins ila_lib/probe6]
  ...
  connect_bd_net -net net_slot_2_axis_tdest [get_bd_pins g_inst/m_slot_2_axis_tdest] [get_bd_pins ila_lib/probe11]
  connect_bd_net -net net_slot_2_axis_tid [get_bd_pins g_inst/m_slot_2_axis_tid] [get_bd_pins ila_lib/probe12]
  ...
  connect_bd_net -net net_slot_2_axis_tstrb [get_bd_pins g_inst/m_slot_2_axis_tstrb] [get_bd_pins ila_lib/probe14]
