...
architecture STRUCTURE of bd_d5b8 is
  ...
  port (
    ...
    m_slot_2_axis_tid : out STD_LOGIC_VECTOR ( 4 downto 0 );
    m_slot_2_axis_tdest : out STD_LOGIC_VECTOR ( 5 downto 0 );
  ...
  signal Conn2_TDEST : STD_LOGIC_VECTOR ( 5 downto 0 );
  signal Conn2_TID : STD_LOGIC_VECTOR ( 4 downto 0 );
  ...
  signal net_slot_2_axis_tdest : STD_LOGIC_VECTOR ( 5 downto 0 );
  signal net_slot_2_axis_tid : STD_LOGIC_VECTOR ( 4 downto 0 );
  ...
  attribute X_INTERFACE_PARAMETER of clk : signal is "XIL_INTERFACENAME CLK.CLK, ASSOCIATED_BUSIF SLOT_0_AXIS:SLOT_1_AXIS:SLOT_2_AXIS, ASSOCIATED_RESET resetn, CLK_DOMAIN system_processing_system7_0_0_FCLK_CLK0, FREQ_HZ 100000000, PHASE 0.000";
  ...
  attribute X_INTERFACE_PARAMETER of SLOT_2_AXIS_tdata : signal is "XIL_INTERFACENAME SLOT_2_AXIS, CLK_DOMAIN system_processing_system7_0_0_FCLK_CLK0, FREQ_HZ 100000000, HAS_TKEEP 1, HAS_TLAST 1, HAS_TREADY 1, HAS_TSTRB 1, LAYERED_METADATA xilinx.com:interface:datatypes:1.0 {CLK {datatype {name {attribs {resolve_type immediate dependency {} format string minimum {} maximum {}} value {}} bitwidth {attribs {resolve_type immediate dependency {} format long minimum {} maximum {}} value 1} bitoffset {attribs {resolve_type immediate dependency {} format long minimum {} maximum {}} value 0}}} TDATA {datatype {name {attribs {resolve_type immediate dependency {} format string minimum {} maximum {}} value {}} bitwidth {attribs {resolve_type immediate dependency {} format long minimum {} maximum {}} value 32} bitoffset {attribs {resolve_type immediate dependency {} format long minimum {} maximum {}} value 0} integer {signed {attribs {resolve_type immediate dependency {} format bool minimum {} maximum {}} value false}}}} TDATA_WIDTH 32 TUSER {datatype {name {attribs {resolve_type immediate dependency {} format string minimum {} maximum {}} value {}} bitwidth {attribs {resolve_type immediate dependency {} format long minimum {} maximum {}} value 2} bitoffset {attribs {resolve_type immediate dependency {} format long minimum {} maximum {}} value 0} integer {signed {attribs {resolve_type immediate dependency {} format bool minimum {} maximum {}} value false}}}} TUSER_WIDTH 2}, PHASE 0.000, TDATA_NUM_BYTES 4, TDEST_WIDTH 6, TID_WIDTH 5, TUSER_WIDTH 2";
...
begin
  ...
  Conn2_TDEST(5 downto 0) <= SLOT_2_AXIS_tdest(5 downto 0);
  Conn2_TID(4 downto 0) <= SLOT_2_AXIS_tid(4 downto 0);
...
g_inst: component bd_d5b8_g_inst_0
     port map (
      ...
      m_slot_2_axis_tdest(5 downto 0) => net_slot_2_axis_tdest(5 downto 0),
      m_slot_2_axis_tid(4 downto 0) => net_slot_2_axis_tid(4 downto 0),
      ...
      slot_2_axis_tdest(5 downto 0) => Conn2_TDEST(5 downto 0),
      slot_2_axis_tid(4 downto 0) => Conn2_TID(4 downto 0),
...
ila_lib: component bd_d5b8_ila_lib_0
     port map (
      ...
      probe15(1 downto 0) => net_slot_2_axis_tuser(1 downto 0),
